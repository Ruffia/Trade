...
// Attributes
public:
    virtual void SetText(LPCSTR /* szText */)              = 0 ;
    ...
    virtual LPCSTR    GetTipText()    const                { return GetText(); } // may override TitleTip return
