...
public:
    ...
    CSize GetTextExtent(int nRow, int nCol, LPCSTR str);
...
public:
    ...
    BOOL   SetItemText(int nRow, int nCol, LPCSTR str);
    ...
    BOOL   SetItemTextFmt(int nRow, int nCol, LPCSTR szFmt, ...);
...
///////////////////////////////////////////////////////////////////////////////////
public:
    int  InsertColumn(LPCSTR strHeading, UINT nFormat = DT_CENTER|DT_VCENTER|DT_SINGLELINE,
                      int nColumn = -1);
    int  InsertRow(LPCSTR strHeading, int nRow = -1);
...
#ifndef _WIN32_WCE
    BOOL Save(LPCSTR filename, TCHAR chSeparator = _T(','));
    BOOL Load(LPCSTR filename, TCHAR chSeparator = _T(','));
#endif
...
protected:
	...
	void ValidateAndModifyCellContents(int nRow, int nCol, LPCSTR strText);
...
protected:
	...
	virtual BOOL  ValidateEdit(int nRow, int nCol, LPCSTR str);
