#include "stdafx.h"
#include "DlgMarketTemperatureChart_RiseRatioTradeVolume.h"
...
IMPLEMENT_FACTORY(CDialogPlaceHolder,CDlgMarketTemperature_RiseRatioTradeVolume, string,"CDlgMarketTemperature_RiseRatioTradeVolume")

IMPLEMENT_DYNAMIC(CDlgMarketTemperature_RiseRatioTradeVolume, CDlgMarketTemperature_Chart)
CDlgMarketTemperature_RiseRatioTradeVolume::CDlgMarketTemperature_RiseRatioTradeVolume(CWnd* pParent /*=NULL*/)
	: CDlgMarketTemperature_Chart(pParent)
{
	CDialogIDMgr::Instance().Register("CDlgMarketTemperature_RiseRatioTradeVolume",CDlgMarketTemperature_RiseRatioTradeVolume::IDD);
}


void CDlgMarketTemperature_RiseRatioTradeVolume::_CreateChart() 
{
