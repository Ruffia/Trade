...
IMPLEMENT_FACTORY(CCustomTabCtrlDlg,CCustomTabCtrlDlgBusiness,string,"CCustomTabCtrlDlgBusiness")
CCustomTabCtrlDlgBusiness::CCustomTabCtrlDlgBusiness(CWnd* pParent /*=NULL*/)
...
CCustomTabCtrlDlgBusiness::~CCustomTabCtrlDlgBusiness()
{

}


BOOL CCustomTabCtrlDlgBusiness::OnInitDialog()
{
	return TRUE;
}


void CCustomTabCtrlDlgBusiness::_InitLayOut()
{

}


void CCustomTabCtrlDlgBusiness::_DesignLayout(UINT nType, int cx, int cy)
{

}


void CCustomTabCtrlDlgBusiness::_CreateUI( CUIData &data, xml_node node )
{

}


void CCustomTabCtrlDlgBusiness::_LoadData2UI()
{
...
bool CCustomTabCtrlDlgBusiness::_CheckExistsTradeDayRecord()
{
	vector<CFieldDesc*> vPrimaryKey;
	CDBDataManager::Instance().GetPrimaryKey(m_pDataProvider->m_sBusiness,vPrimaryKey);
...
//void CCustomTabCtrlDlgBusiness::UpdateDB2UI(CDataSet& ds,int index)
//{
//	//此处有且仅有一条记录
...
//void CCustomTabCtrlDlgBusiness::UpdateUI2DB()
//{
//	bool bExists = _CheckExistsTradeDayRecord();
//	if(!bExists) return;
//
...
//
//
//string CCustomTabCtrlDlgBusiness::_CreateUpdateSQL()
//{
//	map<string,CFieldDesc*>& mapTableName2FieldDesc = CDBDataManager::Instance().GetTableMeta(m_pDataProvider->m_sBusiness);
//
//	string sSQL = "update ";
