...
public:
	...
	//     size       - Initial size value of the item.
	//     pBindSize  - If not NULL, then the value of the item
	...
	CXTPPropertyGridItemSize(
		UINT nID, CSize size = 0,
		CSize* pBindSize =
			NULL); //<COMBINE
				   // CXTPPropertyGridItemSize::CXTPPropertyGridItemSize@LPCTSTR@CSize@CSize*>
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the size value for the item.
	// Parameters:
	//     size - size value to be set.
	//-----------------------------------------------------------------------
	virtual void SetSize(CSize size);

	//-----------------------------------------------------------------------
	// Summary:
	//     Gets the size value of the item.
	// Returns:
	//     The size value of the item.
	//-----------------------------------------------------------------------
	virtual CSize GetSize() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Binds the item to a specified CSize object.
	// Parameters:
	//     pBindSize - Pointer to a CSize object.
	// Remarks:
	//     Variables can be bound to an item in two ways, the first is
	//     to pass in a variable at the time of creation, the second allows
	//     variables to be bound to an item after creation with the
...
public:
	...
	//     strCaption - Caption of the item.
	//     nID        - Identifier of the item.
	//     ptPoint    - Initial point value of item.
	...
	CXTPPropertyGridItemPoint(
		UINT nID, CPoint pt = 0,
		CPoint* pBindPoint =
			NULL); //<COMBINE
				   // CXTPPropertyGridItemPoint::CXTPPropertyGridItemPoint@LPCTSTR@CPoint@CPoint*>
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the point value for the item.
	// Parameters:
	//     pt - Point value to be set.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Binds the item to a specified CPoint object.
	// Parameters:
	//     pBindPoint - Pointer to a CPoint object.
	// Remarks:
	//     Variables can be bound to an item in two ways, the first is
	//     to pass in a variable at the time of creation, the second allows
	//     variables to be bound to an item after creation with the
