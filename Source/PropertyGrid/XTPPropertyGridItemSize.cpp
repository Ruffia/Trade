...
void CXTPPropertyGridItemSize::OnAddChildItem()
{
	...
	m_pItemWidth = (CXTPPropertyGridItemSizeWidth*)AddChildItem(
		new CXTPPropertyGridItemSizeWidth(strWidth));
	m_pItemHeight = (CXTPPropertyGridItemSizeHeight*)AddChildItem(
		new CXTPPropertyGridItemSizeHeight(strHeight));
...
CXTPPropertyGridItemPoint::CXTPPropertyGridItemPoint(LPCTSTR strCaption, CPoint pt,
													 CPoint* pBindPoint)
	: CXTPPropertyGridItem(strCaption)
{
	m_pItemX  = NULL;
