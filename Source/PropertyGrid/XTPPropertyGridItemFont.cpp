...
BEGIN_DISPATCH_MAP(CXTPPropertyGridItemFont, CXTPPropertyGridItem)
	...
	DISP_PROPERTY_EX_ID(CXTPPropertyGridItemFont, "FontFaceName", 51, OleGetFaceName,
						OleSetFaceName, VT_BSTR)
	...
	DISP_PROPERTY_EX_ID(CXTPPropertyGridItemFont, "FontItalic", 54, OleGetItalic, OleSetItalic,
						VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPPropertyGridItemFont, "FontUnderline", 55, OleGetUnderline,
						OleSetUnderline, VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPPropertyGridItemFont, "FontStrikeOut", 56, OleGetStrikeOut,
						OleSetStrikeOut, VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPPropertyGridItemFont, "FontWeight", 57, OleGetWeight, OleSetWeight,
						VT_I4)
END_DISPATCH_MAP()
...
void CXTPPropertyGridItemFont::OleSetValue(const VARIANT* varValue)
{
	...
	{
		HGDIOBJ hFont = reinterpret_cast<HGDIOBJ>((LONG_PTR)varValue->lVal);
