// XTPPropertyGridVisualStudio2022Theme.cpp : implementation of the
// CXTPPropertyGridVisualStudio2022Theme class.
//
...
//////////////////////////////////////////////////////////////////////////
// CXTPPropertyGridVisualStudio2022Theme

CXTPPropertyGridVisualStudio2022Theme::CXTPPropertyGridVisualStudio2022Theme(CXTPPropertyGrid* pGrid)
...
void CXTPPropertyGridVisualStudio2022Theme::RefreshMetrics()
{
	CXTPPropertyGridPaintManager::RefreshMetrics();

	// Default colors found in VISUALSTUDIO2022BLUE_INI.
...
void CXTPPropertyGridVisualStudio2022Theme::DrawExpandButton(CDC& dc, CXTPPropertyGridItem* pItem,
															 CRect rcCaption)
{
...
XTPScrollBarTheme CXTPPropertyGridVisualStudio2022Theme::GetScrollBarTheme() const
{
	return xtpScrollBarThemeVisualStudio2022;
}
