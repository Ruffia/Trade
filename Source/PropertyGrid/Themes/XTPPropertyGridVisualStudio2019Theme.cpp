// XTPPropertyGridVisualStudio2019Theme.cpp : implementation of the
// CXTPPropertyGridVisualStudio2019Theme class.
//
...
//////////////////////////////////////////////////////////////////////////
// CXTPPropertyGridVisualStudio2019Theme

CXTPPropertyGridVisualStudio2019Theme::CXTPPropertyGridVisualStudio2019Theme(CXTPPropertyGrid* pGrid)
...
void CXTPPropertyGridVisualStudio2019Theme::RefreshMetrics()
{
	CXTPPropertyGridPaintManager::RefreshMetrics();

	// Default colors found in VISUALSTUDIO2019BLUE_INI.
	...
	{
		SetControlsTheme(xtpControlThemeVisualStudio2019);
	}
#endif
}

void CXTPPropertyGridVisualStudio2019Theme::DrawExpandButton(CDC& dc, CXTPPropertyGridItem* pItem,
															 CRect rcCaption)
{
...
XTPScrollBarTheme CXTPPropertyGridVisualStudio2019Theme::GetScrollBarTheme() const
{
	return xtpScrollBarThemeVisualStudio2019;
}
