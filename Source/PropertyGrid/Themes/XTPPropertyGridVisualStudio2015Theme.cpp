// XTPPropertyGridVisualStudio2015Theme.cpp : implementation of the
// CXTPPropertyGridVisualStudio2015Theme class.
//
...
void CXTPPropertyGridVisualStudio2015Theme::DrawExpandButton(CDC& dc, CXTPPropertyGridItem* pItem,
															 CRect rcCaption)
{
...
XTPScrollBarTheme CXTPPropertyGridVisualStudio2015Theme::GetScrollBarTheme() const
{
	return xtpScrollBarThemeVisualStudio2015;
}
