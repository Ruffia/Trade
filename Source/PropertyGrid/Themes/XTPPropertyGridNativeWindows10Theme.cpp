// XTPPropertyGridNativeWindows10Theme.cpp : implementation of the
// CXTPPropertyGridNativeWindows10Theme class.
//
...
//////////////////////////////////////////////////////////////////////////
// CXTPPropertyGridNativeWindows10Theme

CXTPPropertyGridNativeWindows10Theme::CXTPPropertyGridNativeWindows10Theme(CXTPPropertyGrid* pGrid)
...
void CXTPPropertyGridNativeWindows10Theme::RefreshMetrics()
{
	...
	{
		SetControlsTheme(xtpControlThemeNativeWindows10);
	}
#endif
}

void CXTPPropertyGridNativeWindows10Theme::DrawExpandButton(CDC& dc, CXTPPropertyGridItem* pItem,
															CRect rcCaption)
{
...
XTPScrollBarTheme CXTPPropertyGridNativeWindows10Theme::GetScrollBarTheme() const
{
	return xtpScrollBarThemeNativeWindows10;
}
