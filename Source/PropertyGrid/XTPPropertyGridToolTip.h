...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Activates/destroys the tooltip control.
	// Parameters:
	//     bActive    - TRUE to activate the tooltip control, FALSE to destroy.
	//     pItem      - Pointer to the item whose tooltip must be shown.
	//     bValuePart - TRUE to show the tooltip of the value part.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pParentWnd - Pointer to a CXTPPropertyGridView object.
	//-----------------------------------------------------------------------
...
protected:
	...
	CXTPFont m_xtpFont; // Font used to display the tooltip.
...
//{{AFX_CODEJOCK_PRIVATE
AFX_INLINE BOOL CXTPPropertyGridToolTip::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName,
