// XTPFrameThemeVisualStudio2019.h
//
...
#if !defined(__XTPFRAMETHEMEVISUALSTUDIO2019_H__)
#	define __XTPFRAMETHEMEVISUALSTUDIO2019_H__
//}}AFX_CODEJOCK_PRIVATE
...
class _XTP_EXT_CLASS CXTPFrameThemeVisualStudio2019
	: public CXTPFrameThemeOffice2013
	, private IXTPApplicationEvents
{
public:
	CXTPFrameThemeVisualStudio2019(CXTPPaintManager* pPaintManager);

	virtual ~CXTPFrameThemeVisualStudio2019();
...
public:
	...
	//-----------------------------------------------------------------------
	// <combine
	// CXTPFrameThemeVisualStudio2019::DrawFrameCaptionButton@CDC*@CRect@int@BOOL@BOOL@BOOL>
	//-----------------------------------------------------------------------
	virtual void DrawFrameCaptionButton(CDC* pDC, CRect rc, int nId, BOOL bSelected, BOOL bPressed,
	...
	virtual COLORREF
		GetStateColor() const; // <combine CXTPFrameThemeVisualStudio2019::SetStateColor@COLORREF>
...
#endif // !defined(__XTPFRAMETHEMEVISUALSTUDIO2019_H__)
