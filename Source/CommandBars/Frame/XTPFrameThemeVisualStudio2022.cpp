// XTPFrameThemeVisualStudio2022.cpp
//
...
CXTPFrameThemeVisualStudio2022::CXTPFrameThemeVisualStudio2022(CXTPPaintManager* pPaintManager)
...
CXTPFrameThemeVisualStudio2022::~CXTPFrameThemeVisualStudio2022()
{
	XTPGetApplication()->Unsubscribe(this);
}

void CXTPFrameThemeVisualStudio2022::RefreshMetrics()
{
...
CRect CXTPFrameThemeVisualStudio2022::CalcFrameBorder(
...
CXTPFrameShadow* CXTPFrameThemeVisualStudio2022::CreateShadow(CWnd* pFrame)
{
...
void CXTPFrameThemeVisualStudio2022::OnShadowedFrameActiveStateChanged(BOOL bActive, CWnd* pFrame,
...
void CXTPFrameThemeVisualStudio2022::SetStateColor(COLORREF clrState)
{
...
COLORREF CXTPFrameThemeVisualStudio2022::GetStateColor() const
{
	return m_clrFrameBorderActive.IsDefaultValue() ? COLORREF_NULL
												   : m_clrFrameBorderActive.operator COLORREF();
}

void CXTPFrameThemeVisualStudio2022::DrawFrameCaptionButton(CDC* pDC, CRect rc, int nId,
...
void CXTPFrameThemeVisualStudio2022::OnAmbientPropertyChanged(
...
void CXTPFrameThemeVisualStudio2022::UpdateStateColor()
{
