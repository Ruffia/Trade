// XTPFrameThemeVisualStudio2019.cpp
//
...
CXTPFrameThemeVisualStudio2019::CXTPFrameThemeVisualStudio2019(CXTPPaintManager* pPaintManager)
...
CXTPFrameThemeVisualStudio2019::~CXTPFrameThemeVisualStudio2019()
{
	XTPGetApplication()->Unsubscribe(this);
}

void CXTPFrameThemeVisualStudio2019::RefreshMetrics()
{
...
CRect CXTPFrameThemeVisualStudio2019::CalcFrameBorder(
...
CXTPFrameShadow* CXTPFrameThemeVisualStudio2019::CreateShadow(CWnd* pFrame)
{
...
void CXTPFrameThemeVisualStudio2019::OnShadowedFrameActiveStateChanged(BOOL bActive, CWnd* pFrame,
...
void CXTPFrameThemeVisualStudio2019::SetStateColor(COLORREF clrState)
{
...
COLORREF CXTPFrameThemeVisualStudio2019::GetStateColor() const
{
	return m_clrFrameBorderActive.IsDefaultValue() ? COLORREF_NULL
												   : m_clrFrameBorderActive.operator COLORREF();
}

void CXTPFrameThemeVisualStudio2019::DrawFrameCaptionButton(CDC* pDC, CRect rc, int nId,
...
void CXTPFrameThemeVisualStudio2019::OnAmbientPropertyChanged(
...
void CXTPFrameThemeVisualStudio2019::UpdateStateColor()
{
