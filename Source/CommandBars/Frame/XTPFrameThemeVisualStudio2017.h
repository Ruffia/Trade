// XTPFrameThemeVisualStudio2017.h
//
...
#if !defined(__XTPFRAMETHEMEVISUALSTUDIO2017_H__)
#	define __XTPFRAMETHEMEVISUALSTUDIO2017_H__
//}}AFX_CODEJOCK_PRIVATE
...
class _XTP_EXT_CLASS CXTPFrameThemeVisualStudio2017
	: public CXTPFrameThemeOffice2013
	, private IXTPApplicationEvents
{
public:
	CXTPFrameThemeVisualStudio2017(CXTPPaintManager* pPaintManager);

	virtual ~CXTPFrameThemeVisualStudio2017();
...
public:
	...
	//-----------------------------------------------------------------------
	// <combine
	// CXTPFrameThemeVisualStudio2017::DrawFrameCaptionButton@CDC*@CRect@int@BOOL@BOOL@BOOL>
	//-----------------------------------------------------------------------
	virtual void DrawFrameCaptionButton(CDC* pDC, CRect rc, int nId, BOOL bSelected, BOOL bPressed,
	...
	virtual COLORREF
		GetStateColor() const; // <combine CXTPFrameThemeVisualStudio2017::SetStateColor@COLORREF>
...
#endif // !defined(__XTPFRAMETHEMEVISUALSTUDIO2017_H__)
