...
//===========================================================================
class _XTP_EXT_CLASS CXTPFramePaintManager : public CObject
{
	DECLARE_DYNAMIC(CXTPFramePaintManager);

public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPFramePaintManager object.
	// Parameters:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to create the window region.
	// Parameters:
	//      pFrameHook - CXTPCommandBarsFrameHook hook object.
	//      sz - Window size.
	// Returns:
	//      Region of the window to be set.
	//-----------------------------------------------------------------------
	virtual HRGN CalcFrameRegion(CXTPCommandBarsFrameHook* pFrameHook, CSize sz) const = 0;

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw the frame if Ribbon was found.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the frame caption's height.
	// Returns:
	//     The frame Caption's height.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw the frame caption text.
	// Parameters:
	//     pDC - Pointer to device context.
	...
	// See Also:
	//     CreateShadow, XTPFrameShadowManager
	//-----------------------------------------------------------------------
