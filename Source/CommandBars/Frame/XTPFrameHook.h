...
//===========================================================================
// Summary:
//     CXTPCommandBarsFrameHook is a CXTPHookManagerHookAble derived class.
//     It is a helper for Office 2007 window skinning.
//===========================================================================
...
public:
	...
	void EnableFrameTheme(
		CWnd* pSite,
		CXTPPaintManager*
			pPaintManager); // <combine CXTPCommandBarsFrameHook::EnableFrameTheme@CXTPCommandBars*>
	void EnableFrameTheme(
		CWnd* pSite,
		CXTPCommandBars*
			pCommandBars); // <combine CXTPCommandBarsFrameHook::EnableFrameTheme@CXTPCommandBars*>
	...
	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(EnableFrameTheme)
	...
	_XTP_DEPRECATED_IN_FAVOR(DisableFrameTheme)
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Updates the invalidated portions of the DWM client area.
	//-----------------------------------------------------------------------
...
protected:
	...
	BOOL m_bBeingDestructed;		 // TRUE if class instance is being destructed
