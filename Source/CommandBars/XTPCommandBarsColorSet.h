...
{
public:
	CXTPPaintManagerColor m_clrComboBoxBorder;	 // Combobox background color
	CXTPPaintManagerColor m_clrComboBoxBackground; // Combobox background color
...
{
public:
	virtual ~CXTPCommandBarsColorSet()
	{
	}
