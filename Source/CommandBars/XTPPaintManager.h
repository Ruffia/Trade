...
// See Also:
//     CXTPPaintManager::DrawSpecialControl
//
...
enum XTPSpecialControl
{
	...
	xtpButtonExpandMenu,	// Control is expand button of pop-up bar.
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Call this method to enable/disable use of custom font.
	// Parameters:
	//      bEnable - TRUE if custom font is to be used.
	// See Also: SetCustomFont, SetStandardFont
	//-----------------------------------------------------------------------
	void EnableCustomFont(BOOL bEnable = TRUE);

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(EnableCustomFont)
	void SetCustomFont(BOOL bCustomFont)
	{
		EnableCustomFont(bCustomFont);
	}
	//}}AFX_CODEJOCK_PRIVATE
...
struct IXTPPaintManagerEvents
{
	...
	//-----------------------------------------------------------------------
	virtual ~IXTPPaintManagerEvents()
	{
	}
...
public:
	...
	//     its reference counter. If a paint manager object has not yet been
...
public:
	...
	// Parameters:
	//     pControl - Pointer to a CXTPControl object to get the back color from.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get the control text color to draw.
	// Parameters:
	//     pButton - Pointer to a CXTPControl object to draw.
	// Returns:
	//     The control text color to draw.
	//-----------------------------------------------------------------------
	...
	//     pDC      - Pointer to a valid device context.
	//     pBar     - Pointer to a CXTPCommandBar object.
	//     pLeftControl - Pointer to a left CXTPControl object.
	//     pRightControl - Pointer to a left CXTPControl object.
	//     bDraw    - TRUE to draw, FALSE to retrieve the size of the separator.
	// Returns:
	//     Size of the separator.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to determine the offset of a pop-up'ed bar.
	// Parameters:
	//     rc        - Control's bounding rectangle.
	//     pControl  - Pointer to a CXTPControl object.
	//     bVertical - TRUE if control is docked vertically.
	//-----------------------------------------------------------------------
	virtual void AdjustExcludeRect(CRect& rc, CXTPControl* pControl, BOOL bVertical) = 0;

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to fill a dock bar.
	// Parameters:
	//     pDC  - Pointer to a valid device context.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to fill a workspace.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw a pop-up bar's resize gripper.
	// Parameters:
	//     pDC       - Pointer to a valid device context.
	//     rcGripper - Bounding rectangle of the gripper.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to draw a dialog bar's gripper.
	// Parameters:
	//     pDC   - Pointer to a valid device context.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the bounding region of a pop-up bar.
	// Parameters:
	//     pCommandBar - Pointer to the pop-up bar whose bounding region must be set.
	//-----------------------------------------------------------------------
	virtual void SetCommandBarRegion(CXTPCommandBar* pCommandBar);

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw a check box mark area.
	// Parameters:
	//     pDC - Pointer to a valid device context.
	//     rc - Bounding rectangle.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw a radio button mark area.
	// Parameters:
	//     pDC - Pointer to a valid device context.
	//     rc - Bounding rectangle.
	//     bDraw - TRUE to draw, FALSE to find size.
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Creates a new CXTPPaintManager object.
	// Parameters:
	//     paintTheme - Theme to be created.
	// Returns:
	//     Pointer to a new CXTPPaintManager object.
	// Example:
...
public:
	...
	// Parameters:
	//     pControl - Pointer to a CXTPCommandBar object.
	// Returns:
	...
	// Parameters:
	//     pCommandBar - Pointer to a CXTPCommandBar object to determine
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set command bar's font.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to retrieve the caption of a floating mini frame.
	// Returns:
	//     A pointer to a CFont object.
	//-----------------------------------------------------------------------
	...
	void Rectangle(CDC* pDC, LPCRECT rc, COLORREF clrPen,
				   COLORREF clrBrush); // <combine
									   // CXTPPaintManager::Rectangle@CDC*@LPCRECT@int@const int>
	...
	//     pDC				- Pointer to a valid device context.
	//     rc				- Specifies the rectangle in logical units.
	//	   frameThickness	- Thickness of the rectangle frame.
	//     nPen				- Specifies the color used to paint the rectangle.
	//     nBrush			- Specifies the color used to fill the rectangle.
	//     clrPen			- Specifies the color used to paint the rectangle.
	//     clrBrush			- Specifies the color used to fill the rectangle.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to draw a combobox expand symbol.
	// Parameters:
	//     pDC - Pointer to a valid device context.
	//     rc - Specifies the rectangle in logical units.
	//     clr - Color to fill.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves a specific icon's options.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to animate the pop-up bar.
	// Parameters:
	//     pDestDC       - Pointer to the device context you must draw to.
	...
	//     pDestDC     - Pointer to the device context you must draw to.
	//     pSrcDC      - Device context that contains the bitmap you must take.
	//     bExpandDown - TRUE to animate expanding top-to-bottom,
	//                   FALSE to animate expanding bottom-to-top.
	//-----------------------------------------------------------------------
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Determines if a specified font exists in the system.
	// Parameters:
	//     lpszFaceName - Font to test.
	// Returns:
	//     TRUE if font exists, otherwise FALSE.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to prepare a caption for Right-To-Left draw.
	// Parameters:
	...
	//     theme in use.
	// Returns:
	//     A XTPCurrentSystemTheme enumeration that represents the current
	//     Windows XP theme in use; can be one of the following values:
	...
	// See Also:
	//     SetLunaTheme, RefreshLunaColors
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     systemTheme - Theme to use. Can be any of the values
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Calculates the gripper of a pop-up bar.
	// Parameters:
	//     pBar - Pop-up bar.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves paint manager used to draw galleries.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves paint manager used to draw scrollbars.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves paint manager used to draw slider panes.
	// Returns:
	//     Pointer to a CXTPSliderPaintManager object.
	//-----------------------------------------------------------------------
	virtual CXTPSliderPaintManager* GetSliderPaintManager() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves paint manager used to draw progress bars.
	// Returns:
	//     Pointer to a CXTPProgressPaintManager object.
	//-----------------------------------------------------------------------
	virtual CXTPProgressPaintManager* GetProgressPaintManager() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves paint manager used to draw frames.
	// Returns:
	//     Pointer to a CXTPFramePaintManager object.
	//-----------------------------------------------------------------------
	virtual CXTPFramePaintManager* GetFramePaintManager();

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves paint manager used to draw the status bar.
	// Returns:
	//     Pointer to a CXTPStatusBarPaintManager object.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves paint manager used to draw message bars.
	// Returns:
	//     Pointer to a CXTPMessageBarPaintManager object.
	//-----------------------------------------------------------------------
	virtual CXTPMessageBarPaintManager* GetMessageBarPaintManager();

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves shadow manager used to draw shadows.
	// Returns:
	//     Pointer to a CXTPShadowManager object.
	//-----------------------------------------------------------------------
	CXTPShadowManager* GetShadowManager() const;

	//{{AFX_CODEJOCK_PRIVATE
public:
	_XTP_DEPRECATED_IN_FAVOR2(GetInstanceAddRef, ReleaseInstance)
	...
	_XTP_DEPRECATED_IN_FAVOR(DrawControlText)
	...
	static BOOL IsDpiBitmapScalingEnabled(CXTPControl* pControl);
	static BOOL IsDpiBitmapScalingEnabled(CXTPCommandBar* pCommandBar);
	static BOOL IsDpiBitmapScalingEnabled(CXTPCommandBars* pCommandBars);

	static CSize AdjustDpiIconSize(CXTPImageManagerIcon* pIcon, CSize szIcon, CXTPControl* pControl,
								   CSize szAvailable);
	static CSize AdjustDpiIconSize(CXTPImageManagerIcon* pIcon, CSize szIcon,
								   CXTPCommandBar* pCommandBar, CSize szAvailable,
								   CSize szMargin = CSize(0, 0));
	static CSize AdjustDpiIconSize(CXTPImageManagerIcon* pIcon, CSize szIcon,
								   CXTPCommandBars* pCommandBars, CSize szAvailable,
								   CSize szMargin = CSize(0, 0));
	static CSize AdjustDpiIconSize(CXTPImageManagerIcon* pIcon, CSize szIcon, CSize szAvailable,
								   BOOL bScaleDpi, CSize szMargin = CSize(0, 0));
...
protected:
	...
	CSize GetIconSize(CXTPControl* pControl) const;

	static CSize GetStretchIconSize(CXTPImageManagerIcon* pIcon, CSize szIcon);
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Call this method to get the pointer to the global paint manager.
	// Returns:
	//      If the global paint manager is set, then the pointer to the global
	//      paint manager will be returned. If no global paint manager
	//      is set, then a NULL value will be returned.
	// See also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Call this method to set the pointer to the global paint manager.
	// Parameters:
...
public:
	...
	BOOL m_bOffsetPopupLabelText; // TRUE if labels in pop-ups drawn with offset.
	...
	int m_nSplitButtonPopupWidth;	 // Split button drop down width in pop-ups.
...
public:
	...
	struct _XTP_EXT_CLASS CLogFont : public LOGFONT
	{
		//-----------------------------------------------------------------------
		// Summary:
		//     Constructs a CLogFont object.
		//-----------------------------------------------------------------------
		CLogFont();
	};

	_XTP_DEPRECATED_IN_FAVOR(CXTPNonClientMetrics)
...
// Returns:
//     A pointer to the only instance of CXTPPaintManager object.
// Example:
//     <code>XTPPaintManager()->GetIconsInfo()->bIconsWithShadow = FALSE;</code>
//---------------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     The CXTPReBarPaintManager template class is used to enable a
//     ReBar theme for Command Bars.
// See Also:
...
template<class TBase>
AFX_INLINE CXTPReBarPaintManager<TBase>::CXTPReBarPaintManager()
{
	TBase::RefreshMetrics();
}

template<class TBase>
AFX_INLINE void CXTPReBarPaintManager<TBase>::RefreshMetrics()
{
	TBase::RefreshMetrics();
...
//{{AFX_CODEJOCK_PRIVATE
_XTP_EXT_CLASS BOOL AFX_CDECL XTPReBarPaintManager_FillCommandBarEntry(CDC* pDC,
																	   CXTPCommandBar* pBar,
																	   CXTPWinThemeWrapper& theme);
//}}AFX_CODEJOCK_PRIVATE

template<class TBase>
AFX_INLINE void CXTPReBarPaintManager<TBase>::FillCommandBarEntry(CDC* pDC, CXTPCommandBar* pBar)
{
	if (XTPReBarPaintManager_FillCommandBarEntry(pDC, pBar, m_themeRebar))
		return;
