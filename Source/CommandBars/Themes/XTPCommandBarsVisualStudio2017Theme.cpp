// XTPCommandBarsVisualStudio2017Theme.cpp : implementation of the
// CXTPCommandBarsVisualStudio2017Theme class.
//
...
#include "Common/ScrollBar/Themes/XTPScrollBarThemeVisualStudio2017.h"
...
#	include "Ribbon/Themes/XTPRibbonThemeVisualStudio2017.h"
#endif
...
#include "CommandBars/Slider/XTPSliderThemeVisualStudio2017.h"
...
#include "CommandBars/MessageBar/XTPMessageBarThemeVisualStudio2017.h"
...
//////////////////////////////////////////////////////////////////////
// CXTPCommandBarsVisualStudio2017Theme

IMPLEMENT_DYNAMIC(CXTPCommandBarsVisualStudio2017Theme, CXTPCommandBarsOffice2013Theme)

CXTPCommandBarsVisualStudio2017Theme::CXTPCommandBarsVisualStudio2017Theme()
{
	// Frame paint manager
	SAFE_DELETE(m_pFramePaintManager);
	m_pFramePaintManager = new CXTPFrameThemeVisualStudio2017(this);

	// Progress paint manager
	SAFE_DELETE(m_pProgressPaintManager);
	m_pProgressPaintManager = new CXTPProgressThemeVisualStudio2017(this);

	// Slider paint manager
	SAFE_DELETE(m_pSliderPaintManager);
	m_pSliderPaintManager = new CXTPSliderThemeVisualStudio2017(this);

	// Message bar paint manager
	SAFE_DELETE(m_pMessageBarPaintManager);
	m_pMessageBarPaintManager = new CXTPMessageBarThemeVisualStudio2017(this);

	// Status bar paint manager
	SAFE_DELETE(m_pStatusBarPaintManager);
	m_pStatusBarPaintManager = new CXTPStatusBarThemeVisualStudio2017(this);

	// Ribbon paint manager
	SAFE_DELETE(m_pRibbonPaintManager);
	m_pRibbonPaintManager = new CXTPRibbonThemeVisualStudio2017(this);

	// Gallery paint manager
	SAFE_DELETE(m_pGalleryPaintManager);
	m_pGalleryPaintManager = new CXTPControlGalleryVisualStudio2017Theme(this);

	// Scrollbar paint manager
	SAFE_DELETE(m_pScrollBarPaintManager);
	m_pScrollBarPaintManager = new CXTPScrollBarThemeVisualStudio2017();
...
void CXTPCommandBarsVisualStudio2017Theme::SetStateColor(COLORREF clrState /*=COLORREF_NULL*/)
{
	CXTPFrameThemeVisualStudio2017* pFramePaintManager =
		static_cast<CXTPFrameThemeVisualStudio2017*>(m_pFramePaintManager);
	pFramePaintManager->SetStateColor(clrState);

	CXTPStatusBarThemeVisualStudio2017* pStatusBarPaintManager =
		static_cast<CXTPStatusBarThemeVisualStudio2017*>(m_pStatusBarPaintManager);
	pStatusBarPaintManager->SetStateColor(clrState);
}

COLORREF CXTPCommandBarsVisualStudio2017Theme::GetStateColor() const
{
	const CXTPFrameThemeVisualStudio2017* pFramePaintManager =
		static_cast<const CXTPFrameThemeVisualStudio2017*>(m_pFramePaintManager);
	COLORREF clr1 = pFramePaintManager->GetStateColor();

	const CXTPStatusBarThemeVisualStudio2017* pStatusBarPaintManager =
		static_cast<const CXTPStatusBarThemeVisualStudio2017*>(m_pStatusBarPaintManager);
	COLORREF clr2 = pStatusBarPaintManager->GetStateColor();

	return clr1 == clr2 ? clr1 : COLORREF_NULL;
}

void CXTPCommandBarsVisualStudio2017Theme::DrawSplitButtonFrame(CDC* pDC, CXTPControl* pButton,
																CRect rcButton)
{
...
void CXTPCommandBarsVisualStudio2017Theme::DrawCheckRect(CDC* pDC, CRect rc, COLORREF clrFore,
														 COLORREF clrBack)
{
	ASSERT_VALID(pDC);
...
void CXTPCommandBarsVisualStudio2017Theme::DrawGalleryItemBack(CDC* pDC, CRect rcItem,
...
COLORREF CXTPCommandBarsVisualStudio2017Theme::GetControlTextColor(CXTPControl* pButton)
{
	ASSERT_VALID(pButton);
...
void CXTPCommandBarsVisualStudio2017Theme::DrawRectangle(CDC* pDC, CRect rc, BOOL bSelected,
...
BOOL CXTPCommandBarsVisualStudio2017Theme::DrawRectangle(CDC* pDC, CXTPControl* pButton)
{
	return CXTPCommandBarsOffice2013Theme::DrawRectangle(pDC, pButton);
}

BOOL AFX_CDECL XTPSetVS2017StateColor(CXTPCommandBars* pCommandBars,
									  COLORREF clrState /*=COLORREF_NULL*/)
{
	if (!pCommandBars)
		return FALSE;

	CXTPCommandBarsVisualStudio2017Theme* pPaintManager =
		DYNAMIC_DOWNCAST(CXTPCommandBarsVisualStudio2017Theme, pCommandBars->GetPaintManager());
...
CSize CXTPCommandBarsVisualStudio2017Theme::DrawCommandBarGripper(CDC* pDC, CXTPCommandBar* pBar,
																  BOOL bDraw)
{
	CSize szGripper(0, 0);
...
CSize CXTPCommandBarsVisualStudio2017Theme::DrawControlComboBox(CDC* pDC,
