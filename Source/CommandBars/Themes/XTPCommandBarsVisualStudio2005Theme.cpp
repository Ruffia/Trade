...
void CXTPVisualStudio2005Theme::RefreshMetrics()
{
	...
	m_clrToolbarExpand.SetStandardValue(XTPColorManager()->LightColor(GetXtremeColor(COLOR_WINDOW),
	...
	switch (XTPColorManager()->GetCurrentSystemTheme())
	{
		...
		case xtpSystemThemeSilver:
		{
			...
			static const INT nElements[]	  = { XPCOLOR_HIGHLIGHT,
											  ...
											  XPCOLOR_PUSHED_TEXT };
			static const COLORREF clrValues[] = { RGB(255, 238, 194),
												  RGB(75, 75, 111),
												  RGB(75, 75, 111),
												  RGB(75, 75, 111),
												  RGB(254, 128, 62),
