...
//===========================================================================
// Summary:
//     The CXTPCommandBarsOffice2013Theme class is used to enable an
//     Office 2013 style theme for Command Bars.
// See Also:
...
public:
	...
	// Returns:
	//     Returns the base theme of the manager.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     TRUE if the rectangle was drawn, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//     pRightControl - Pointer to a right CXTPControl object.
	...
	// Parameters:
	//     pControl - Pointer to the CXTPControl object to get the back color from.
	// Returns:
...
protected:
	...
	virtual COLORREF GetControlTextColor(
		CXTPControl*
			pButton); // <combine
					  // CXTPCommandBarsOffice2013Theme::GetRectangleTextColor@BOOL@BOOL@BOOL@BOOL@BOOL@XTPBarType@XTPBarPosition>
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to fill the border of the control's face.
	// Parameters:
	//     pDC         - Pointer to a valid device context.
	//     rc          - Rectangle to draw.
	//     bSelected   - TRUE if the control is selected.
	...
	//     pDC    - Pointer to a valid device context.
	//     bDraw  - TRUE to draw; FALSE to retrieve the size of the control.
	//     pComboBox - Pointer to the CXTPControlComboBox object to draw.
	// Returns:
	//     Size of the control.
	//-----------------------------------------------------------------------
	...
	//     pt          - Position of the expand symbol.
	//     bSelected   - TRUE if the control is selected.
	//     bPopuped    - TRUE if the control is pop-up'ed.
	//     bEnabled    - TRUE if the control is enabled.
	...
	BOOL m_bIntersect;							  // TRUE to draw pop-up bar intersect rectangle.
