...
//===========================================================================
// Summary:
//     The CXTPCommandBarsOfficeXPTheme class is used to enable an
//     Office XP style theme for Command Bars.
// See Also:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw a resize gripper of a pop-up bar.
	// Parameters:
	//     pDC       - Pointer to a valid device context
	//     rcGripper - Bounding rectangle of the gripper.
	//     nFlags    - Position of the resize gripper.
	//-----------------------------------------------------------------------
...
protected:
	...
	virtual void DrawRectangle(
		...
		int nID); // <combine
				  // CXTPCommandBarsOfficeXPTheme::DrawRectangle@CDC*@CRect@BOOL@BOOL@BOOL@BOOL
	...
	// Returns:
	//     TRUE if the rectangle was drawn, otherwise returns FALSE.
	//-----------------------------------------------------------------------
	...
	//     pDC    - Pointer to a valid device context.
	//     bDraw  - TRUE to draw; FALSE to retrieve the size of the control.
	//     pComboBox - Pointer to a CXTPControlComboBox object to draw.
	// Returns:
	//     Size of the control.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Draws intersect rectangle of a pop-up bar and its control.
	// Parameters:
	//     pDC       - Pointer to a valid device context.
	//     pPopupBar - Pop-up bar pointer.
