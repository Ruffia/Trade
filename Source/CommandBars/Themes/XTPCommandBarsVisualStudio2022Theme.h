// XTPCommandBarsVisualStudio2022Theme.h : interface for the CXTPCommandBarsVisualStudio2022Theme
// class.
//
...
#if !defined(__XTPCOMMANDBARSVISUALSTUDIO2022THEME_H__)
#	define __XTPCOMMANDBARSVISUALSTUDIO2022THEME_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//     The CXTPCommandBarsVisualStudio2022Theme class is used to enable a
//     Visual Studio 2022 style theme for Command Bars.
// See Also:
//     CXTPPaintManager::SetTheme
//===========================================================================
class _XTP_EXT_CLASS CXTPCommandBarsVisualStudio2022Theme : public CXTPCommandBarsOffice2013Theme
{
	DECLARE_DYNAMIC(CXTPCommandBarsVisualStudio2022Theme)
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPCommandBarsVisualStudio2022Theme object.
	//-----------------------------------------------------------------------
	CXTPCommandBarsVisualStudio2022Theme();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPCommandBarsVisualStudio2022Theme object,
	//     handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPCommandBarsVisualStudio2022Theme();
	...
	virtual COLORREF GetStateColor()
		const; // <combine CXTPCommandBarsVisualStudio2022Theme::SetStateColor@COLORREF>
...
protected:
	...
	virtual void DrawRectangle(
		...
		int nID); // <combine
				  // CXTPCommandBarsVisualStudio2022Theme::DrawRectangle@CDC*@CRect@BOOL@BOOL@BOOL@BOOL@BOOL@XTPBarType@XTPBarPosition>
...
//---------------------------------------------------------------------------
// Summary:
//     Call XTPSetVS2022StateColor to set the border and status bar colors for this
//     theme to indicate state changes. This is similar to when Visual Studio 2022
...
//---------------------------------------------------------------------------
_XTP_EXT_CLASS BOOL AFX_CDECL XTPSetVS2022StateColor(CXTPCommandBars* pCommandBars,
													 COLORREF clrState = COLORREF_NULL);

#	include "Common/Base/Diagnostic/XTPEnableNoisyWarnings.h"
#endif // !defined(__XTPCOMMANDBARSVISUALSTUDIO2022THEME_H__)
