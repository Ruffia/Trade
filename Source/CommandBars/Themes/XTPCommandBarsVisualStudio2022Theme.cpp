// XTPCommandBarsVisualStudio2022Theme.cpp : implementation of the
// CXTPCommandBarsVisualStudio2022Theme class.
//
...
#include "Common/ScrollBar/Themes/XTPScrollBarThemeVisualStudio2022.h"
...
#include "CommandBars/Gallery/XTPControlGalleryVisualStudio2022Theme.h"
...
#include "CommandBars/Progress/XTPProgressThemeVisualStudio2022.h"

// Slider
#include "CommandBars/Slider/XTPSliderPaintManager.h"
#include "CommandBars/Slider/XTPSliderThemeOffice2013.h"
#include "CommandBars/Slider/XTPSliderThemeVisualStudio2022.h"
...
//////////////////////////////////////////////////////////////////////
// CXTPCommandBarsVisualStudio2022Theme

IMPLEMENT_DYNAMIC(CXTPCommandBarsVisualStudio2022Theme, CXTPCommandBarsOffice2013Theme)

CXTPCommandBarsVisualStudio2022Theme::CXTPCommandBarsVisualStudio2022Theme()
{
	// Frame paint manager
	SAFE_DELETE(m_pFramePaintManager);
	m_pFramePaintManager = new CXTPFrameThemeVisualStudio2022(this);

	// Progress paint manager
	SAFE_DELETE(m_pProgressPaintManager);
	m_pProgressPaintManager = new CXTPProgressThemeVisualStudio2022(this);

	// Slider paint manager
	SAFE_DELETE(m_pSliderPaintManager);
	m_pSliderPaintManager = new CXTPSliderThemeVisualStudio2022(this);

	// Message bar paint manager
	SAFE_DELETE(m_pMessageBarPaintManager);
	m_pMessageBarPaintManager = new CXTPMessageBarThemeVisualStudio2022(this);

	// Status bar paint manager
	SAFE_DELETE(m_pStatusBarPaintManager);
	m_pStatusBarPaintManager = new CXTPStatusBarThemeVisualStudio2022(this);

	// Ribbon paint manager
	SAFE_DELETE(m_pRibbonPaintManager);
	m_pRibbonPaintManager = new CXTPRibbonThemeVisualStudio2022(this);

	// Gallery paint manager
	SAFE_DELETE(m_pGalleryPaintManager);
	m_pGalleryPaintManager = new CXTPControlGalleryVisualStudio2022Theme(this);

	// Scrollbar paint manager
	SAFE_DELETE(m_pScrollBarPaintManager);
	m_pScrollBarPaintManager = new CXTPScrollBarThemeVisualStudio2022();
...
void CXTPCommandBarsVisualStudio2022Theme::SetStateColor(COLORREF clrState /*=COLORREF_NULL*/)
{
	CXTPFrameThemeVisualStudio2022* pFramePaintManager =
		static_cast<CXTPFrameThemeVisualStudio2022*>(m_pFramePaintManager);
	pFramePaintManager->SetStateColor(clrState);

	CXTPStatusBarThemeVisualStudio2022* pStatusBarPaintManager =
		static_cast<CXTPStatusBarThemeVisualStudio2022*>(m_pStatusBarPaintManager);
	pStatusBarPaintManager->SetStateColor(clrState);
}

COLORREF CXTPCommandBarsVisualStudio2022Theme::GetStateColor() const
{
	const CXTPFrameThemeVisualStudio2022* pFramePaintManager =
		static_cast<const CXTPFrameThemeVisualStudio2022*>(m_pFramePaintManager);
	COLORREF clr1 = pFramePaintManager->GetStateColor();

	const CXTPStatusBarThemeVisualStudio2022* pStatusBarPaintManager =
		static_cast<const CXTPStatusBarThemeVisualStudio2022*>(m_pStatusBarPaintManager);
	COLORREF clr2 = pStatusBarPaintManager->GetStateColor();

	return clr1 == clr2 ? clr1 : COLORREF_NULL;
}

void CXTPCommandBarsVisualStudio2022Theme::DrawSplitButtonFrame(CDC* pDC, CXTPControl* pButton,
																CRect rcButton)
{
...
void CXTPCommandBarsVisualStudio2022Theme::DrawCheckRect(CDC* pDC, CRect rc, COLORREF clrFore,
														 COLORREF clrBack)
{
	ASSERT_VALID(pDC);
...
void CXTPCommandBarsVisualStudio2022Theme::DrawGalleryItemBack(CDC* pDC, CRect rcItem,
...
COLORREF CXTPCommandBarsVisualStudio2022Theme::GetControlTextColor(CXTPControl* pButton)
{
	ASSERT_VALID(pButton);
...
void CXTPCommandBarsVisualStudio2022Theme::DrawRectangle(CDC* pDC, CRect rc, BOOL bSelected,
...
BOOL CXTPCommandBarsVisualStudio2022Theme::DrawRectangle(CDC* pDC, CXTPControl* pButton)
{
	return CXTPCommandBarsOffice2013Theme::DrawRectangle(pDC, pButton);
}

BOOL AFX_CDECL XTPSetVS2022StateColor(CXTPCommandBars* pCommandBars,
									  COLORREF clrState /*=COLORREF_NULL*/)
{
	if (!pCommandBars)
		return FALSE;

	CXTPCommandBarsVisualStudio2022Theme* pPaintManager =
		DYNAMIC_DOWNCAST(CXTPCommandBarsVisualStudio2022Theme, pCommandBars->GetPaintManager());
...
CSize CXTPCommandBarsVisualStudio2022Theme::DrawCommandBarGripper(CDC* pDC, CXTPCommandBar* pBar,
																  BOOL bDraw)
{
	CSize szGripper(0, 0);
...
CSize CXTPCommandBarsVisualStudio2022Theme::DrawControlComboBox(CDC* pDC,
