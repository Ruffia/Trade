...
//===========================================================================
// Summary:
//     The CXTPVisualStudio2008Theme class is used to enable a
//     Visual Studio 2008 style theme for Command Bars.
// See Also:
...
public:
	...
	// Parameters:
	//     pBar - Pointer to the CXTPCommandBar object whose borders must be retrieved.
	// Returns:
	...
	virtual void DrawRectangle(
		...
		int nID); // <combine
				  // CXTPVisualStudio2008Theme::DrawRectangle@CDC*@CRect@BOOL@BOOL@BOOL@BOOL
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Draws pixel in specific position with specify Alpha.
	// Parameters:
	//     pDC - Pointer to a valid device context.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Draws a border around a specified rectangle.
	// Parameters:
	//     pDC       - Pointer to a valid device context.
	//     rc        - Rectangle with the border to be drawn.
	//     clrBorder - Color of the border to be drawn.
	//-----------------------------------------------------------------------
...
public:
	...
	{
		return xtpThemeVisualStudio2008;
	}

public:
	CXTPPaintManagerColorGradient m_clrMenuSelection; // Gradient used to draw the current menu
													  // selection.
	CXTPPaintManagerColor m_clrMenuSelectionBorder; // Color used to draw the border of the current
													// menu selection.
	CXTPPaintManagerColor m_clrMenuSelectionText; // Color used to draw the text of the current menu
												  // selection.
};
