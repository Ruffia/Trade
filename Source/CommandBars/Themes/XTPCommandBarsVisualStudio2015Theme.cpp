// XTPCommandBarsVisualStudio2015Theme.cpp : implementation of the
// CXTPCommandBarsVisualStudio2015Theme class.
//
...
{
	CXTPFrameThemeVisualStudio2015* pFramePaintManager =
		static_cast<CXTPFrameThemeVisualStudio2015*>(m_pFramePaintManager);
	pFramePaintManager->SetStateColor(clrState);

	CXTPStatusBarThemeVisualStudio2015* pStatusBarPaintManager =
		static_cast<CXTPStatusBarThemeVisualStudio2015*>(m_pStatusBarPaintManager);
	pStatusBarPaintManager->SetStateColor(clrState);
}

COLORREF CXTPCommandBarsVisualStudio2015Theme::GetStateColor() const
{
	const CXTPFrameThemeVisualStudio2015* pFramePaintManager =
		static_cast<const CXTPFrameThemeVisualStudio2015*>(m_pFramePaintManager);
	COLORREF clr1 = pFramePaintManager->GetStateColor();

	const CXTPStatusBarThemeVisualStudio2015* pStatusBarPaintManager =
		static_cast<const CXTPStatusBarThemeVisualStudio2015*>(m_pStatusBarPaintManager);
	COLORREF clr2 = pStatusBarPaintManager->GetStateColor();

	return clr1 == clr2 ? clr1 : COLORREF_NULL;
}

void CXTPCommandBarsVisualStudio2015Theme::DrawSplitButtonFrame(CDC* pDC, CXTPControl* pButton,
																CRect rcButton)
{
...
void CXTPCommandBarsVisualStudio2015Theme::DrawCheckRect(CDC* pDC, CRect rc, COLORREF clrFore,
														 COLORREF clrBack)
{
	ASSERT_VALID(pDC);
...
void CXTPCommandBarsVisualStudio2015Theme::DrawGalleryItemBack(CDC* pDC, CRect rcItem,
...
void CXTPCommandBarsVisualStudio2015Theme::DrawRectangle(CDC* pDC, CRect rc, BOOL bSelected,
...
BOOL AFX_CDECL XTPSetVSStateColor(CXTPCommandBars* pCommandBars,
...
CSize CXTPCommandBarsVisualStudio2015Theme::DrawCommandBarGripper(CDC* pDC, CXTPCommandBar* pBar,
																  BOOL bDraw)
{
	CSize szGripper(0, 0);
...
CSize CXTPCommandBarsVisualStudio2015Theme::DrawControlComboBox(CDC* pDC,
