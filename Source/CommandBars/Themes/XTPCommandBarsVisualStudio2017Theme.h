// XTPCommandBarsVisualStudio2017Theme.h : interface for the CXTPCommandBarsVisualStudio2017Theme
// class.
//
...
#if !defined(__XTPCOMMANDBARSVISUALSTUDIO2017THEME_H__)
#	define __XTPCOMMANDBARSVISUALSTUDIO2017THEME_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//     The CXTPCommandBarsVisualStudio2017Theme class is used to enable a
//     Visual Studio 2017 style theme for Command Bars.
// See Also:
//     CXTPPaintManager::SetTheme
//===========================================================================
class _XTP_EXT_CLASS CXTPCommandBarsVisualStudio2017Theme : public CXTPCommandBarsOffice2013Theme
{
	DECLARE_DYNAMIC(CXTPCommandBarsVisualStudio2017Theme)
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPCommandBarsVisualStudio2017Theme object.
	//-----------------------------------------------------------------------
	CXTPCommandBarsVisualStudio2017Theme();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPCommandBarsVisualStudio2017Theme object,
	//     handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPCommandBarsVisualStudio2017Theme();
	...
	virtual COLORREF GetStateColor()
		const; // <combine CXTPCommandBarsVisualStudio2017Theme::SetStateColor@COLORREF>
...
protected:
	...
	virtual void DrawRectangle(
		...
		int nID); // <combine
				  // CXTPCommandBarsVisualStudio2017Theme::DrawRectangle@CDC*@CRect@BOOL@BOOL@BOOL@BOOL@BOOL@XTPBarType@XTPBarPosition>
...
//---------------------------------------------------------------------------
// Summary:
//     Call XTPSetVS2017StateColor to set the border and status bar colors for this
//     theme to indicate state changes. This is similar to when Visual Studio 2017
...
//---------------------------------------------------------------------------
_XTP_EXT_CLASS BOOL AFX_CDECL XTPSetVS2017StateColor(CXTPCommandBars* pCommandBars,
													 COLORREF clrState = COLORREF_NULL);

#	include "Common/Base/Diagnostic/XTPEnableNoisyWarnings.h"
#endif // !defined(__XTPCOMMANDBARSVISUALSTUDIO2017THEME_H__)
