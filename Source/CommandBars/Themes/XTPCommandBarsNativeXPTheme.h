...
//===========================================================================
// Summary:
//     The CXTPCommandBarsNativeXPTheme class is used to enable a
//     Native Windows XP style theme for Command Bars.
// See Also:
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw the frame of edit control.
	// Parameters:
	//     pDC - Points to a valid device context.
	...
	{
		return xtpThemeNativeWinXP;
	}

	//-----------------------------------------------------------------------
	// Summary:
	//     Determines if WinXP theme is enabled.
	// Returns:
	//     TRUE if WinXP theme is enabled, FALSE otherwise.
	//-----------------------------------------------------------------------
