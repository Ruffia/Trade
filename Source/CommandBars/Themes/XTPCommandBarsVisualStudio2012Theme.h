...
//===========================================================================
// Summary:
//     The CXTPCommandBarsVisualStudio2012Theme class is used to enable a
//     Visual Studio 2012 theme for Command Bars.
// See Also:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPCommandBarsVisualStudio2012Theme object,
