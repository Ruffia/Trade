...
//     Gallery Resource style theme for Command Bars.
// See Also:
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPControlGalleryResourceTheme object.
	// Parameters:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw the scrollbar of the inplace gallery.
	// Parameters:
	//     pDC - Pointer to device context.
	//     pGallery - CXTPControlGallery object to draw.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw the label control.
	// Parameters:
	//     pDC - Pointer to device context.
	//     pLabel - Label item.
