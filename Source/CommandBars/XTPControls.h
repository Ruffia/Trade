...
//===========================================================================
// Summary:
//     CXTPControls is a CXTPCmdTarget derived class.
//     It represents a collection of controls.
//===========================================================================
...
public:
	...
	// Returns:
	//     Pointer to the CXTPControl object if successful, otherwise NULL.
	//-----------------------------------------------------------------------
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to add a copy of a control.
	// Parameters:
	//     pClone - Pointer to the CXTPControl object to copy.
	//     nBefore - Index of the control to be inserted.
	//     bRecursive - TRUE to copy recursively.
	// Returns:
	//     A pointer to the added CXTPControl object.
	//-----------------------------------------------------------------------
	...
	// Summary:
	//     This method is called internally to reposition controls and
	//     determine their size for a pop-up bar.
	// Parameters:
	//     pDC      - Pointer to a valid device context.
	//     nLength  - Length of the parent bar.
	//     nWidth   - Width of the parent bar.
	//     rcBorder - Borders of pop-up bar.
	// Returns:
	//     Total size of the controls.
	// See Also:
	//     CalcDynamicSize
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Finds a specified control by its ID.
	// Parameters:
	//     nIndex - Control's identifier
	...
	// Parameters:
	//     pCommandBars - Command bars object to attach.
	// Remarks:
	//     You can call this member if you create a plain toolbar and
	//     want to set CommandBars for it.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Moves the control to a specified position.
	// Parameters:
	//     pControl - Pointer to a CXTPControl object.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Creates the original controls set.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the original controls set.
	// Returns:
	//     A pointer to a CXTPControls object.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     TRUE if the internal control state was changed since the last drawing,
	//     otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to check if the control has been changed and must be saved.
	// Parameters:
	//     pControl - Control to be checked if it has been changed and must be saved.
	// Returns:
	//     TRUE if the control must be saved, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Determines if all controls in the collection are original
	//     (i.e. not added or modified by the user).
	// Returns:
	//     TRUE if all controls in the collection were added at the time of
	//     creation or from the last time CreateOriginalControls was called.
	//-----------------------------------------------------------------------
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called when a control is about to be removed from the collection.
	// Parameters:
	//     pControl - Control to be removed from the collection.
	// Returns:
	//     TRUE to cancel removing the control.
	//-----------------------------------------------------------------------
