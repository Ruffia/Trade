...
//===========================================================================
// Summary:
//     CXTPPreviewView is a CPreviewView derived class that represents a
//     print preview window with a themed toolBar.
//===========================================================================
...
public:
	...
	// Parameters:
	//     nNewState - Zoom state to use. Possible values (XTP_ZOOM_WHOLEPAGE,
	//                 XTP_ZOOM_PAGEWIDTH) or you can specify an integer that
	//                 represents a percentage to zoom the page.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get a pointer to the toolbar of the preview window.
	// Returns:
