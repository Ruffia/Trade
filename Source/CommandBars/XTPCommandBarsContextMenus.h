...
//     which represents a collection of context menus.
//===========================================================================
...
public:
	...
	// Parameters:
	//     pCommandBars - Pointer to the CXTPCommandBars parent object.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to add a new context menu to the collection.
	// Parameters:
	//     nIDBar - Menu resource identifier.
	//     pCommandBar - Command bar to be added.
	//     lpszTitle - Caption of context menu.
	//     pSubMenu - Context menu to convert.
	//     nSubMenu - Index of submenu to add.
	// Returns:
	//     Pointer to the newly added context menu.
	//-----------------------------------------------------------------------
