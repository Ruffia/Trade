...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function displays a pop-up context menu.
	// Parameters:
	//     pControl - Pointer to a CXTPControl control.
	//     point - CPoint object specifies x- and y- coordinates.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method determines whether the specified character is intended for an edit.
	//     If it is, this method processes the message.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the window text of edit.
	// Parameters:
	//     lpszString - String to set text.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     TRUE if the Input Method Editor(IME) is being used, otherwise FALSE.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Determines if edit command is enabled.
	// Parameters:
	//     nID - Edit command.
	// Returns:
	//     TRUE if edit command is enabled, otherwise FALSE.
	//-----------------------------------------------------------------------
...
protected:
	BOOL m_bImeMode;			// TRUE if IME editor is currently enabled.
...
public:
	...
	//     edit control.
	// Returns:
	//     A pointer to the newly created CXTPControlEditCtrl object.
	//-----------------------------------------------------------------------
...
public:
	...
	//     * <b>SHACF_URLALL</b>: Include the URL's in the user's History and Recently Used lists.
	//                            Equivalent to SHACF_URLHISTORY | SHACF_URLMRU.
	...
	// Parameters:
	//     nTextLimit - Maximum text length user can enter.
	// See Also:
	//     GetTextLimit
	//-----------------------------------------------------------------------
...
protected:
	...
	//     * <b>LM_COMMIT</b>: Resets LM_MRUWIDTH to current the width of the
