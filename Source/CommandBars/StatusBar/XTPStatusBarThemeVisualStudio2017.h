// XTPStatusBarThemeVisualStudio2017.h
//
...
#if !defined(__XTPXTPSTATUSBARTHEMEVISUALSTUDIO2017_H__)
#	define __XTPXTPSTATUSBARTHEMEVISUALSTUDIO2017_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//    The CXTPStatusBarThemeVisualStudio2017 class is used to enable the
//    Visual Studio 2017 style theme for the status bar.
//===========================================================================
class _XTP_EXT_CLASS CXTPStatusBarThemeVisualStudio2017
...
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPStatusBarThemeVisualStudio2017 object.
	// Parameters:
	//     pPaintManager - Pointer to the parent CXTPPaintManager object.
	//-------------------------------------------------------------------------
	CXTPStatusBarThemeVisualStudio2017(CXTPPaintManager* pPaintManager);

	//-----------------------------------------------------------------------
	// Summary:
	//      Handles object destruction.
	//-----------------------------------------------------------------------
	~CXTPStatusBarThemeVisualStudio2017();
	...
	virtual COLORREF GetStateColor()
		const; // <combine CXTPStatusBarThemeVisualStudio2017::SetStateColor@COLORREF>
...
#endif // !defined(__XTPXTPSTATUSBARTHEMEVISUALSTUDIO2017_H__)
