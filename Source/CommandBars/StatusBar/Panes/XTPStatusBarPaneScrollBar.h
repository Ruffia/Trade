...
//===========================================================================
// Summary:
//     CXTPStatusBarScrollBarPane is a CXTPStatusBarPane derived class.
//     CXTPStatusBarScrollBarPane works with CXTStatusBar and allows
//     you to create a themed ScrollBar in your status bar area.
//===========================================================================
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the position of the scrollbar.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the rangle of the scroll bar.
	// Parameters:
	//     nMin - Lower limit of the scrollbar control's range.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Gets the current position of the scroll bar, whose return value
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set a tooltip for the scroll part of scrollbar.
	// Parameters:
	//     nPart    - Part of the scrollbar to set the tooltip. Can be XTP_HTSCROLLUP,
	//                XTP_HTSCROLLDOWN, XTP_HTSCROLLUPPAGE, XTP_HTSCROLLDOWNPAGE,
	//                XTP_HTSCROLLTHUMB.
	//     lpszTooltip - Text of the tooltip to be set.
	//-----------------------------------------------------------------------
