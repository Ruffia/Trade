// XTPStatusBarThemeVisualStudio2019.h
//
...
#if !defined(__XTPXTPSTATUSBARTHEMEVISUALSTUDIO2019_H__)
#	define __XTPXTPSTATUSBARTHEMEVISUALSTUDIO2019_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//    The CXTPStatusBarThemeVisualStudio2019 class is used to enable the
//    Visual Studio 2019 style theme for the status bar.
//===========================================================================
class _XTP_EXT_CLASS CXTPStatusBarThemeVisualStudio2019
...
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPStatusBarThemeVisualStudio2019 object.
	// Parameters:
	//     pPaintManager - Pointer to the parent CXTPPaintManager object.
	//-------------------------------------------------------------------------
	CXTPStatusBarThemeVisualStudio2019(CXTPPaintManager* pPaintManager);

	//-----------------------------------------------------------------------
	// Summary:
	//      Handles object destruction.
	//-----------------------------------------------------------------------
	~CXTPStatusBarThemeVisualStudio2019();
	...
	virtual COLORREF GetStateColor()
		const; // <combine CXTPStatusBarThemeVisualStudio2019::SetStateColor@COLORREF>
...
#endif // !defined(__XTPXTPSTATUSBARTHEMEVISUALSTUDIO2019_H__)
