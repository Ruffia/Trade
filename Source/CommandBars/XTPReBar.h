...
//===========================================================================
// Summary:
//     The CXTPReBar object extends the standard MFC CReBar class to provide
//     extended functionality such as saving and restoring band layouts.
//===========================================================================
...
public:
	...
	// Returns:
	//     If found on a band in the rebar, then the ID of the band that contains the
	//     toolbar will be returned. If not found, then a value of -1 will be returned.
	//-----------------------------------------------------------------------
	int FindBand(CXTPToolBar* pToolBar);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to retrieve a pointer to the toolbar contained
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves state information from the registry.
	// Parameters:
	//     lpszProfileName - Pointer to a NULL-teminated string that specifies
	//                       the name of a key in the Windows registry where the
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Saves state information to the registry.
	// Parameters:
	//     lpszProfileName - Pointer to a NULL-teminated string that specifies
	//                       the name of a key in the Windows registry where the
	//                       state information should be stored.
	//-----------------------------------------------------------------------
