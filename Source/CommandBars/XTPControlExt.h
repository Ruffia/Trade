...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Adds the number and an ampersand "&" before the caption of an item that
	//     appears in the Windows List.
	// Parameters:
	//     lpszTitle - Text string to display in Windows List. This text will be appended
	//                 after the number.
...
//===========================================================================
// Summary:
//     CXTPControlWorkspaceActions is a CXTPControlButton derived class.
//     It used internally to add workspace actions to a window menu.
//===========================================================================
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Adds an action command to parent controls.
	// Parameters:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Represents a single toolbar item.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pPopupBar     - Pointer to a CXTPCommandBar object.
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get a pointer to the recent file list collection.
	// Returns:
	//     Pointer to the recent file list collection.
	//-----------------------------------------------------------------------
	virtual CRecentFileList* GetRecentFileList();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get ID_FILE_MRU_FILE1.
	// Returns:
	//     ID_FILE_MRU_FILE1.
	//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
// Summary:
//     XTP_SLN_SELCHANGE is sent to the parent command bar when the
