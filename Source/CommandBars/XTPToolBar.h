...
public:
	...
	// Parameters:
	//     bVisible - A BOOL value. TRUE to set the toolbar to visible,
	...
	// Parameters:
	//     barPosition - New position of the toolbar.
	// Returns:
...
public:
	...
	// Parameters:
	//     pInfo - Pointer to a CToolBarInfo object.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     bPreview - TRUE to show toolbars in preview mode,
	...
	//     command bar.
	// Parameters:
	//     bCloseable - TRUE to allow the command bar to be closed by the user.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     bTemporary - TRUE to set the control to temporary.
	// Remarks:
	//     Temporary toolbars will not be saved to the system registry when
	//     the application is closed (If SaveCommandBars is used), and they
	//     will not be restored when the application is opened
	...
	// Parameters:
	//     bShowExpandButton - TRUE to show the expand button of the toolbar,
	...
	//     pTarget - A pointer to the target command handler.
	// Returns:
...
protected:
	...
	//     Creates a toolbar.
	// Parameters:
	//     pParentWnd - Pointer to a CWnd object.
