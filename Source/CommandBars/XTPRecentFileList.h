...
//===========================================================================
// Summary:
//     CXTPRecentFileList is a CRecentFileList derived class.
//     This is used as a pinnable MRU for the ribbon.
//===========================================================================
class _XTP_EXT_CLASS CXTPRecentFileList
...
public:
	...
	// Parameters:
	//     nStart - Index of the item to start pinned.
	//     lpszSection - Section.
	//     lpszEntryFormat - Format.
	//     nSize - Initial list size.
	//     nMaxDispLen - Maximum list size.
	//-----------------------------------------------------------------------
	CXTPRecentFileList(UINT nStart, LPCTSTR lpszSection, LPCTSTR lpszEntryFormat, int nSize,
...
public:
	...
	// Parameters:
	//     lpszPathName - Path of the filename, including file name, to include in
	//                    the MRU. Only the filename will be drawn in the MRU. The
	//                    entire path will be displayed in a tooltip on mouseover.
