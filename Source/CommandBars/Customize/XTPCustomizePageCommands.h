...
//-----------------------------------------------------------------------
// Summary:
//     This structure stores categories for CXTPCustomizeCommandsPage and CXTPCustomizeKeyboardPage
//     option pages
...
//----------------------------------------------------------------------
typedef CArray<XTP_COMMANDBARS_CATEGORYINFO*, XTP_COMMANDBARS_CATEGORYINFO*>
	CXTPCommandBarsCategoryArray;

//-----------------------------------------------------------------------
// Summary:
//     List of the commands
//-----------------------------------------------------------------------
class _XTP_EXT_CLASS CXTPCustomizeCommandsListBox
	:
#	ifdef _XTP_INCLUDE_CONTROLS
	public CXTPListBox
{
	typedef CXTPListBox BaseType;
#	else
	public CListBox
{
	typedef CListBox BaseType;
#	endif
public:
	//-----------------------------------------------------------------------
	// Summary:
...
public:
	...
	//     TRUE if successful; otherwise returns FALSE.
	//-----------------------------------------------------------------------
	BOOL InsertBuiltInMenus(UINT nIDResourceMenu, UINT nIDResourceCategory = XTP_IDS_BUILTINMENUS,
							int nIndex = -1);
...
#	ifdef _XTP_INCLUDE_CONTROLS
	COLORREF m_clrText;
	CXTPListBox m_lstCategories; // List box of categories
#	else
