...
public:
	...
	//     in the "Change Button Image" pop-up of the context menu that is
	...
	//          pop-up menu if you do not remove them.  If you do not remove the
...
protected:
	...
	CXTPImageManager* m_pCustomIcons; // Icons displayed in the "Change Button Image" pop-up of the
									  // context menu that is displayed when a user right-clicks on
									  // a control.
