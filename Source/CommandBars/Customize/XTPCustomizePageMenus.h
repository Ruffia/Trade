...
public:
	...
	enum
	{
		IDD = XTP_IDD_PAGE_MENUS
	};
	CStatic m_wndIcon;
#	ifdef _XTP_INCLUDE_CONTROLS
	COLORREF m_clrText;
	CXTPComboBox m_cmbContextMenus;
	CXTPComboBox m_cmbAppMenus;
	CXTPButton m_btnResetApp;
	CXTPButton m_btnResetContent;
#	else
	CComboBox m_cmbContextMenus;
	CComboBox m_cmbAppMenus;
	CButton m_btnResetApp;
	CButton m_btnResetContent;
#	endif
