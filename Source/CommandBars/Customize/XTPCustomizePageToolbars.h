...
#	ifdef _XTP_INCLUDE_CONTROLS
	COLORREF m_clrText;
	CXTPButton m_btnReset;		  // Reset button
	CXTPButton m_btnRename;		  // Rename button
	CXTPButton m_btnDelete;		  // Delete button
	CXTPButton m_btnNew;		  // New button
	CXTPCheckListBox m_checkList; // Toolbars list box
#	else
