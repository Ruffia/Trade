...
// </code>
// See Also:
//     CXTPControlCustom::SetVerticalPositionOption
//
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to create a new CXTPControlCustom object with
	//     pWndChild as a child window.
	// Parameters:
...
public:
	...
	// Parameters:
	//     pWnd - Pointer to a child CWnd object.
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     XTPControlCustomVerticalOptions
	//-----------------------------------------------------------------------
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called when the action property is changed.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Either eads this object from or writes this object to an archive.
	// Parameters:
