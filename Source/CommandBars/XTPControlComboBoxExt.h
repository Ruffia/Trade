...
//-----------------------------------------------------------------------
// Summary:
//     The XTP_FN_SETFORMAT notification sent by CXTPControlFontComboBox to set the
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to add all fonts to the list.
	// Parameters:
...
public:
	...
	// Parameters:
	//     dwStyleListBox - Flags to be used in list box. Currently not supported,
	//                      must be default.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the current font of the picker.
	// Parameters:
