...
//===========================================================================
// Summary:
//     CXTPControlAction is a CXTPCmdTarget derived class.
//     It represents the single action of controls.
//===========================================================================
...
public:
	...
	// See Also:
	//     SetPrompt, SetDescription, SetTooltip
	//-----------------------------------------------------------------------
	void SetCaption(LPCTSTR lpszCaption);
	void SetCaption(UINT nIDCaption); // <combine CXTPControlAction::SetCaption@LPCTSTR>
	...
	// See Also:
	//     SetCaption, SetPrompt, SetTooltip
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     lpszPrompt - String from the resource file that contains the
	...
	//           member is called.
	// See Also:
	//     SetCaption, SetDescription, SetTooltip
	//----------------------------------------------------------------------
	...
	// Parameters:
	//     bEnabled - TRUE to enable the action, FALSE to disable the action.
	// See Also:
	//     GetEnabled, SetChecked
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the checked state of an action.
	// Parameters:
	//     bChecked - TRUE to set the action to checked.
	// See Also:
	//     GetChecked, SetEnabled
	//-----------------------------------------------------------------------
	void SetChecked(BOOL bChecked);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the checked state of an action.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the visibility of an action.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the visibility of an action.
	// Parameters:
	//     bVisible - TRUE to set the action to visible.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     dwTag - The new 32-bit value to associate with the action.
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetCaption, SetDescription, SetPrompt
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the grayed-out text displayed in the edit and combo
	//     controls which provides a helpful description of what the control is used for.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the grayed-out text displayed in the edit and combo
	//     controls which provides a helpful description of what the control is used for.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     "String" version of the ID given to a command in the CommandBars Designer
	//     (For use with CommandBars designed in the CommandBars Designer Studio).
	// Parameters:
	//     lpszKey - "String" version of the ID to be given to a command
	//               in the CommandBars Designer.
	// Remarks:
	//     The key is the "string" version of the ID given to a command
	...
	//     Use GetKey to retrieve this key.
	//
	...
	//             Note:  The Actions Pane is a way to save and "Re-use" commands.
	//                    Always add controls to this library first so they can be
	//                    re-used in other xcb or xml files.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Gets the "string" version of the ID given to a command in the CommandBars Designer
	//     (For use with CommandBars designed in the CommandBars Designer Studio).
	// Remarks:
	//     The key is the "string" version of the ID given to a command
	//     in the CommandBars Designer. "String" version refers to the
	...
	//
	// Returns:
	//     The "string" version of the ID given to a command in the
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get a pointer to the owner CommandBars.
	// Returns:
	//     The pointer to the CXTPCommandBars object.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get a control associated with an action.
	// Parameters:
	//     nIndex - Index of the control to retrieve.
	// Returns:
	//     Pointer to a CXTPControl object.
	//-----------------------------------------------------------------------
	CXTPControl* GetControl(int nIndex) const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the number of controls associated with an action.
	// Returns:
	//     Total number of controls associated with an action.
	//-----------------------------------------------------------------------
	int GetCount() const;
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called when a new control is attached to an action.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to remove a control from the actions list.
	// Parameters:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     This method is called before an action is removed.
	//-------------------------------------------------------------------------
	void OnRemoved();

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called when the property of an action is changed.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called when the property of an action is about to be changed.
	// Parameters:
	//     nProperty - Property identifier.
	// See Also:
	//     OnChanged
...
protected:
	...
	BOOL m_bVisible;				 // TRUE if the action is visible.
...
//===========================================================================
// Summary:
//     CXTPControlActions is a CXTPCmdTarget derived class.
//     It represents a collection of actions.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Removes the action of a control by using the ID of the control.
	// Parameters:
	//     nId - Identifier of the control that has the action to be removed.
	//-----------------------------------------------------------------------
	void Remove(int nId);
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Inserts an existing CXTPControlAction into the collection of actions.
	// Parameters:
	//     pAction - Reference to the action to add to the collection of actions.
	//-----------------------------------------------------------------------
	void Insert(CXTPControlAction* pAction);

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets or updates the control ID associated with an action.
	// Parameters:
	//     pAction - Reference to an action to be assigned a new ID.
...
//===========================================================================
// Summary:
//     CXTPControl is a CXTPCmdTarget derived class.
//     It represents the parent class for the command bar's controls.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the text displayed for the shortcut in a pop-up menu.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the control's text displayed for the shortcut in
	//     a pop-up menu.
	// Returns:
	//     The keyboard tip of the control.
	//-----------------------------------------------------------------------
	...
	// Remarks:
	//     This method sets the CString value associated with the control.
	//     Use SetTag to set the numeric parameter.
	// See Also:
	//     SetTag, GetParameter
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to enable/disable the control.
	//     If the control does not have an xtpFlagManualUpdate flag, you must call
	//     the Enable member of CCmdUI in the ON_UPDATE_COMMAND_UI handler.
	// Parameters:
	//     bEnabled - TRUE to enable the control, FALSE to disable the control.
	// See Also:
	//     GetEnabled, SetChecked
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to check if the control is enabled.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the checked state of the control.
	//     If the control does not have an xtpFlagManualUpdate flag, you must call
	//     the SetCheck member of CCmdUI in the ON_UPDATE_COMMAND_UI handler.
	// Parameters:
	//     bChecked - TRUE to set the control to checked.
	// See Also:
	//     GetChecked, SetEnabled
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the checked state of the control.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to check if the control is selected.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set whether a control should be a part of the
	//     Quick Access panel.
	// Parameters:
	//     bFocused - TRUE to set the control to be a part of the Quick Access panel.
	//-----------------------------------------------------------------------
	void SetOnQuickAccess(BOOL bOnQuicAccess = FALSE);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to check if a control is a part of the Quick Access panel.
	// Returns:
	//     TRUE if the control is a part of the Quick Access panel; otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     bFocused - TRUE to set the control to focused.
	//-----------------------------------------------------------------------
	virtual void SetFocused(BOOL bFocused);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to check the focused state of the control.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the pressed state of the control.
	// Parameters:
	//     bPressed - TRUE to set the control to pressed.
	//-----------------------------------------------------------------------
	void SetPressed(BOOL bPressed);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to check the pressed state of the control.
	// Returns:
	...
	// See Also:
	//     XTPControlHideFlags, GetHideFlags
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     TRUE if the caption of the control is visible.
	//-----------------------------------------------------------------------
	virtual BOOL IsCaptionVisible() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the visibility of the control.
	// Parameters:
	//     bVisible - TRUE to set the control to visible,
	//                FALSE to set the control to hidden.
	//-----------------------------------------------------------------------
	void SetVisible(BOOL bVisible);
	...
	//         * <b>xtpControlButton</b>: Indicates the control is a simple button
	//                                    (CXTPControlButton).
	//         * <b>xtpControlPopup</b>: Indicates the control is a simple pop-up button
	//                                   (CXTPControlPopup).
	//         * <b>xtpControlButtonPopup</b>: Indicates the control is a pop-up button with icon
	//                                         (CXTPControlPopup).
	//         * <b>xtpControlSplitButtonPopup</b>: Indicates the control is a split button
	//                                              pop-up (CXTPControlPopup).
	//         * <b>xtpControlComboBox</b>: Indicates the control is a combobox
	//         (CXTPControlComboBox).
	//         * <b>xtpControlEdit</b>: Indicates the control is an edit control (CXTPControlEdit).
	//         * <b>xtpControlLabel</b>: Indicates the control is a label (CXTPControlLabel).
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     dwTag - The new 32-bit value to associate with the control.
	//-----------------------------------------------------------------------
	void SetTag(DWORD_PTR dwTag);
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable the closing of
	//     sub-menus when a control is clicked in the menu.
	// Parameters:
	//     bCloseOnClick - TRUE if the sub-menu will close when a control
	//                     is clicked. FALSE if the sub-menu will remain open
	//                     after a control is clicked.
	// See Also:
	//     GetCloseSubMenuOnClick
	//----------------------------------------------------------------------
	void SetCloseSubMenuOnClick(BOOL bCloseOnClick);

	//----------------------------------------------------------------------
	// Summary:
	//     Call this member function to check if sub-menus will close
	//     as soon as a control is clicked.
	// Returns:
	//     TRUE if the sub-menu will close when a control is clicked. FALSE
	//     if the sub-menu will remain open after a control is clicked.
	// See Also:
	//     SetCloseSubMenuOnClick
	//----------------------------------------------------------------------
	BOOL GetCloseSubMenuOnClick() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the delay (in milliseconds) between WM_COMMAND
	//     messages while a button is pressed by the user.
	// Parameters:
	//     nExecuteOnPressInterval - The delay (in milliseconds) between each message.
	// See Also:
	//     GetExecuteOnPressInterval
	//-----------------------------------------------------------------------
	void SetExecuteOnPressInterval(int nExecuteOnPressInterval);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get the delay (in milliseconds) between WM_COMMAND
	//     messages while a button is pressed by the user.
	// Returns:
	//     The delay (in milliseconds) between each message.
	// See Also:
	//     SetExecuteOnPressInterval
	//-----------------------------------------------------------------------
	int GetExecuteOnPressInterval() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Returns the ribbon group that the control belongs to.
	// Returns:
	//     If the control belongs to a ribbon group, then the CXTPRibbonGroup
	//     that the control belongs to is returned. If the control does not
	//     belong to a ribbon group, then NULL is returned.
	// See Also:
	//     CXTPRibbonBar::RebuildControls
	//-----------------------------------------------------------------------
...
public:
	...
	//     and should not be set by the developer.
	//     There is only one situation where you should set these flags
	//     manually. xtpHideCustomize is the only flag that should
	//     ever be manually set. You would do this when you want the
	//     control to initially be hidden but still exist in the customize
	//     pop-up of a toolbar. This will cause the control to appear in
	//     the Add and Remove Buttons pop-up without a check mark indicating
	...
	// Parameters:
	//     dwFlag - XTPControlHideFlags type of flag to set/remove.
	...
	//     and should not be set by the developer.
	// Returns:
	//     TRUE if flags were changed, otherwise FALSE.
	// See Also:
	//     XTPControlHideFlags, SetHideFlags
	//----------------------------------------------------------------------
	...
	// Returns:
	//     Flags of the control's visibility.
	// Remarks:
	//     HideFlags will tell how a control was hidden if it is hidden
	//     or why it is not visible. Most of these flags are read only
	//     and should not be set by the developer.
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this method to check if the control is wrapped.
	// Returns:
	//     TRUE if the control is wrapped; otherwise FALSE.
	// See Also:
	//     SetWrap
	//----------------------------------------------------------------------
	BOOL GetWrap() const;
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the control to wrapped.
	// Parameters:
	//     bWrap - TRUE to set the control to wrapped.
	// See Also:
	//     GetWrap
	//----------------------------------------------------------------------
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this member to check if the control is expanded.
	// Returns:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this member to determine if the mouse pointer is over the control.
	// Returns:
	//     TRUE if the mouse cursor is over the control; otherwise FALSE.
	//----------------------------------------------------------------------
	...
	//     and the document template is not excluded.
	// Parameters:
	//     nIDResource - Document template identifier.
	// See Also:
	//     ExcludeDocTemplate
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this method to check if a control is a default menu item.
	// Returns:
	//     TRUE if the control is a default menu item, otherwise FALSE.
	// Remarks:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this method to set a control to be a default menu item.
	// Parameters:
	//     bDefault - TRUE to set the control to be a default menu item.
	// Remarks:
	//     A default menu item will appear in bold text.
	// See Also:
	//     IsItemDefault
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this method to determine if a control is temporary.
	...
	// -------------------------------------------------------------------
	// Summary:
	//     Call this member to retrieve CXTPControl from a CCmdUI structure.
	// Parameters:
	//     pCmdUI :  Address of the CCmdUI structure.
	// Returns:
	//     CXTPControl from the CCmdUI structure.
	// -------------------------------------------------------------------
	...
	// Parameters:
	//     hIcon - HICON object containing the icon to set to this control.
	// See Also:
	//     Reset
	//-----------------------------------------------------------------------
	...
	//----------------------------------------------------------------------
	// Summary:
	//     This method is called when the user activates the control using its underline.
	//----------------------------------------------------------------------
	...
	//----------------------------------------------------------------------
	// Summary:
	//     This method is called to send message code to the parent site window.
	// Parameters:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this method to manually assign an action for control.
	// Parameters:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this method to retrieve an action associated with control.
	// Returns:
	//     Action associated with control.
	// See Also:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     This method is called when the paint manager theme is changed.
	//-------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to determine if control has a Vista DWM transparent area.
	// Returns:
	//     TRUE if control has a Vista DWM transparent area, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the size of an icon for an individual control.
	// Parameters:
	//     szIcon - Desired size of the icon.
	// See Also:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     This method is called to determine if control can be repositioned in
	//     customize mode.
	// See Also:
	//     xtpFlagNoMovable
	//----------------------------------------------------------------------
...
protected:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     This method is called to set the control's expanded state.
	// Parameters:
	//     bExpanded - TRUE to set the control to expanded.
	//----------------------------------------------------------------------
	...
	//----------------------------------------------------------------------
	// Summary:
	//     This method is called when the user rotates the mouse wheel.
	// Parameters:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     This helper method is called when the user clicks the toolbar's button.
	// Parameters:
	...
	//----------------------------------------------------------------------
	// Summary:
	//     Call this method to determine if command bars is in customize mode.
	// Returns:
	//     TRUE if command bars is in Customize mode; otherwise FALSE.
	//----------------------------------------------------------------------
	...
	//     point - Specifies the x- and y- coordinates of the cursor.
	// See Also:
	//     IsCustomizeMode, CustomizeStartResize
	//----------------------------------------------------------------------
	virtual void CustomizeStartDrag(CPoint point);

	//----------------------------------------------------------------------
	// Summary:
	//     This method is called when user starts to resize control in customize mode.
	// Parameters:
	//     point - Specifies the x- and y- coordinates of the cursor.
	// Returns:
	//     TRUE if control processes this event, otherwise FALSE.
	// See Also:
	//     IsCustomizeMode, CustomizeStartDrag, GetCustomizeMinWidth
	//----------------------------------------------------------------------
	virtual BOOL CustomizeStartResize(CPoint point);

	//----------------------------------------------------------------------
	// Summary:
	//     This member is called when the user moves the mouse over the control.
	// Parameters:
	...
	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(DoCustomDragOver)
	virtual BOOL IsCustomizeDragOverAvail(CXTPCommandBar* pCommandBar, CPoint point,
										  DROPEFFECT& dropEffect)
	{
		return DoCustomDragOver(pCommandBar, point, dropEffect);
	}
	//}}AFX_CODEJOCK_PRIVATE
	...
	// Returns:
	//     TRUE if the user can resize the control, otherwise FALSE.
	//----------------------------------------------------------------------
	virtual BOOL IsCustomizeResizeAllow() const;

	//----------------------------------------------------------------------
	// Summary:
	//     Retrieves the available minimum width of control.
	// Remarks:
	//     This method is called in CustomizeStartResize to retrieve the width
	//     of available rectangles of a resized control.
	// Returns:
	//     Returns zero by default.
	// See Also:
	//     CXTPControlComboBox::GetCustomizeMinWidth, CXTPControlEdit::GetCustomizeMinWidth
	//----------------------------------------------------------------------
	...
	// Remarks:
	//     This method is called in CustomizeStartResize to retrieve the height
	//     of available rectangles of a resized control.
	// Returns:
	//     Returns zero by default.
	// See Also:
	//     CXTPControlComboBox::GetCustomizeMinHeight, CXTPControlEdit::GetCustomizeMinHeight
	//----------------------------------------------------------------------
	...
	// Returns:
	//     If the tooltip control was found, the window control ID will be returned.
	//     If the tooltip control was not found, a value of -1 will be returned.
	//-----------------------------------------------------------------------
...
protected:
	...
	// See Also:
	//     GenerateCommandBarList
	//-----------------------------------------------------------------------
	virtual void RestoreCommandBarList(CXTPCommandBarList* pCommandBarList);

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called from SaveCommandBars to save all child command bars.
	// Parameters:
	//     nID - Current Identifier counter.
	//     pCommandBarList - List of saved command bars.
	//     pParam - Serialize parameters.
	// See Also:
	//     RestoreCommandBarList
	//-----------------------------------------------------------------------
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to determine if the layout has changed
	//     (RTL to LTR or LTR to RLT).
	// Returns:
	//     TRUE if the layout has changed, otherwise FALSE.
	//-----------------------------------------------------------------------
...
protected:
	...
	BOOL m_bDefaultItem;   // TRUE if the item is default pop-up item.
...
AFX_INLINE CString CXTPControl::GetCaption() const
{
	return !m_strCustomCaption.IsEmpty()
			   ...
			   : !m_strCaption.IsEmpty() ? m_strCaption
										 : m_pAction ? m_pAction->GetCaption() : CString();
}
...
{
	return !m_strCategory.IsEmpty() ? m_strCategory
									: m_pAction ? m_pAction->GetCategory() : CString();
}
...
AFX_INLINE CString CXTPControl::GetKeyboardTip() const
{
	return !m_strKeyboardTip.IsEmpty() ? m_strKeyboardTip
									   : m_pAction ? m_pAction->GetKeyboardTip() : CString();
}
