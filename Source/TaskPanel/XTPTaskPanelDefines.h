...
//-----------------------------------------------------------------------
// Summary:
//     This structure is passed as a parameter when
//     an XTP_TPN_GROUPEXPANDING event occurs.
//-----------------------------------------------------------------------
struct XTP_TPNGROUPEXPANDING
{
	CXTPTaskPanelGroup* pGroup; // Group that is about to be expanded.
	BOOL bExpanding;			// TRUE if the group must be expanded.
};

//-----------------------------------------------------------------------
// Summary:
//     This structure is passed as a parameter when
//     an XTP_TPN_ENDLABELEDIT event occurs.
//-----------------------------------------------------------------------
struct XTP_TPNENDLABELEDIT
{
	CXTPTaskPanelItem* pItem; // Item whose caption is about to be changed.
...
// </code>
// See Also:
//     CXTPTaskPanelItem::SetType, CXTPTaskPanelItem::GetType
//
// <KEYWORDS xtpTaskItemTypeGroup, xtpTaskItemTypeLink, xtpTaskItemTypeText, xtpTaskItemTypeControl>
//-----------------------------------------------------------------------
enum XTPTaskPanelItemType
{
	xtpTaskItemTypeGroup,  // Item is a group.
	xtpTaskItemTypeLink,   // Item is a link.
	xtpTaskItemTypeText,   // Item is a text.
	xtpTaskItemTypeControl // Item is a control.
};
...
enum XTPTaskPanelItemLayout
{
	...
	xtpTaskItemLayoutImagesWithTextBelow // Both images and text are shown, text is shown below
										 // images.
};
...
{
	xtpTaskPanelBehaviourExplorer, // Task Panel will behave like Windows Explorer.
	xtpTaskPanelBehaviourList,	 // Task Panel will behave like Windows List Box.
	xtpTaskPanelBehaviourToolbox   // Task Panel will behave like VS. NET Toolbox.
};
...
enum XTPTaskPanelPaintTheme
{
	...
	xtpTaskPanelThemeShortcutBarOffice2003, // Shortcut Bar Office 2003 theme.
	xtpTaskPanelThemeResource,				// Shortcut Bar Office 2007/2010 theme.
	...
	xtpTaskPanelThemeVisualStudio2017,						   // VS 2017 style Toolbox theme.
	xtpTaskPanelThemeVisualStudio2019,						   // VS 2019 style Toolbox theme.
	xtpTaskPanelThemeVisualStudio2022,						   // VS 2022 style Toolbox theme.
	xtpTaskPanelThemeCustom,								   // User defined Custom theme is used.
	xtpTaskPanelThemeNativeWindows10						   // Win 10 theme.
};
...
// See Also:
//     CXTPTaskPanel::SetAnimation, CXTPTaskPanel::GetAnimation
//
...
// Parameters:
//     nAction - wParam value that specifies a Task Panel value
//               that indicates the user's request.
//     pItem   - lParam value that points to an CXTPTaskPanelItem object
...
//     * <b>XTP_TPN_CLICK</b>: Indicates that the user clicked an item.
//     * <b>XTP_TPN_RCLICK</b>: Indicates that the user pressed
//                              the right mouse button on an item.
//     * <b>XTP_TPN_STARTDRAG</b>: Indicates that the user started dragging an item.
//     * <b>XTP_TPN_ENDLABELEDIT</b>: Indicates that the user applied an item rename.
//     * <b>XTP_TPN_ITEMDROP</b>: Indicates that the user dropped an item to the Task Panel
//     * <b>XTP_TPN_GROUPEXPANDING</b>: Indicates that a group is about to be expanded.
//                                      lParam contains an XTP_TPNGROUPEXPANDING pointer.
//                                      You can return XTP_ACTION_CANCEL to ignore expanding.
//     * <b>XTP_TPN_GROUPEXPANDED</b>: Indicates that the user expanded a group.
//     * <b>XTP_TPN_DBLCLICK</b>: Indicates that the user double-clicked an item.
//     * <b>XTP_TPN_FOCUSEDITEMCHANGED</b>: Indicates that the focused item of
