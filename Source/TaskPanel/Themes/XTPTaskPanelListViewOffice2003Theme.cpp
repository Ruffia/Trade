// XTPTaskPanelListViewOffice2003Theme.cpp : implementation of the
...
void CXTPTaskPanelListViewOffice2003Theme::RefreshMetrics()
{
	...
	m_groupNormal.clrHead.SetStandardValue(XTPColorManager()->grcDockBar.clrDark,
										   XTPColorManager()->grcDockBar.clrLight);
	m_groupSpecial = m_groupNormal;
}

CRect CXTPTaskPanelListViewOffice2003Theme::DrawGroupCaptionBackground(CDC* pDC,
