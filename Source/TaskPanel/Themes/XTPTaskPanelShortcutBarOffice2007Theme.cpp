...
void CXTPTaskPanelShortcutBarOffice2007Theme::RefreshMetrics()
{
	...
	if (m_bPlainStyle)
	{
		m_clrBackground.SetStandardValue(
			pImages->GetImageColor(_T("ShortcutBar"), _T("FlatBackground")));
...
CRect CXTPTaskPanelShortcutBarOffice2007Theme::DrawGroupCaptionBackground(
...
void CXTPTaskPanelShortcutBarOffice2007Theme::FillGroupClientFace(CDC* pDC,
...
void CXTPTaskPanelShortcutBarOffice2007Theme::DrawGroupClientFace(CDC* pDC,
																  CXTPTaskPanelGroup* pGroup,
																  CRect rc)
{
...
void CXTPTaskPanelShortcutBarOffice2007Theme::DrawGroupItemFrame(CDC* pDC,
																 ...
																 CRect rc)
{
	...
	CXTPResourceImage* pImage = pImages->LoadFile(
		rc.Height() > XTP_DPI_Y(22) ? _T("TOOLBARBUTTONS50") : _T("TOOLBARBUTTONS22"));
	if (!pImage)
	{
