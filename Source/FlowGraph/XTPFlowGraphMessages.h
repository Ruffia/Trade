...
struct XTP_NM_FLOWGRAPH_ENDLABELEDIT
{
	...
	CXTPFlowGraphElement* pItem; // Item whose caption will be changed.
	CString strNewString;		 // New caption for the item.
};

//-------------------------------------------------------------------------
// Summary:
//     This notification is sent when editing is ended for a label.
//     The information about the edited item is sent in an
...
//-------------------------------------------------------------------------
// Summary:
//     This notification is sent when a connection is added or removed. An
//     XTP_NM_FLOWGRAPH_CONNECTIONCHANGED structure is sent containing
//     information about the connection that changed.
//-------------------------------------------------------------------------
const UINT XTP_FGN_CONNECTIONCHANGED = (NM_FIRST - 63);

//-------------------------------------------------------------------------
// Summary:
//     This notification is sent when the selection is changed. This
...
//-------------------------------------------------------------------------
// Summary:
//     This notification is sent when the page zoom level is changed.
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
// Summary:
//     This notification is sent when the location of a node is changed.
...
//-------------------------------------------------------------------------
// Summary:
//     This notification is sent when the offset of the page is changed.
//     This can occur when the mouse wheel is scrolled, when the screen
//     is dragged, during page animation transitions, during zooming, and
//     during page arrangement.
//-------------------------------------------------------------------------
...
//-------------------------------------------------------------------------
// Summary:
//     This notification is sent when a connection is changing. An
//     XTP_NM_FLOWGRAPH_CONNECTIONCHANGING structure is sent containing
//     information about the connection that is changing. This notification
//     is sent during a call to CXTPFlowGraphControl::StartDragConnectionPoint.
//-------------------------------------------------------------------------
