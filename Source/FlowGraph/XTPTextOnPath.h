...
public:
	...
	bool operator=(const CCArray& rhs)
	{
		CCArray::Copy(rhs);
		return true;
	}
...
protected:
	void GetLinePoints(Gdiplus::PointF p1, Gdiplus::PointF p2, int stepWitdth,
					   CCArray<Gdiplus::PointF>& ret);
	...
	void DrawSingleRotatedLetter(const CString& letter, Gdiplus::REAL angle,
								 Gdiplus::PointF pointCenter);
