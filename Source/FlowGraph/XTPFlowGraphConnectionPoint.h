...
public:
	...
	// Returns:
	//     The caption of the connection point.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the color for the connection point.
	// Parameters:
	//     clr -  Color for the connection point.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     The color of the connection point.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Gets whether the flow graph connection will have any connection
	//     points (input/output).
	// Remarks:
	//     An option from FlowGraphConnectionPointType that specifies the
	//     included connection points, if any.
	// Returns:
	//     FlowGraphConnectionPointType is used to specify whether a
	//     flow graph connection will have any connection points. Connection
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Specifies whether the flow graph connection will have any connection
	//     points (input/output).
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the bounding rectangle for this element.
	// Parameters:
	//     rect - Bounding rectangle to be set.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     nId - New ID used to identify this connection point.
	//-----------------------------------------------------------------------
	void SetID(int nId);
	//-----------------------------------------------------------------------
	// Summary:
	...
	// Returns:
	//     TRUE if the connection's points are locked,
	//     FALSE if they can accept connections.
	//-----------------------------------------------------------------------
	BOOL IsLocked() const;
	//-----------------------------------------------------------------------
	// Summary:
	//     Specifies whether the connection's points should be locked.
	// Parameters:
	//     bLocked - TRUE if the connection's points should be locked,
	//               FALSE if they should accept connections.
	// Remarks:
	//     If TRUE, then the connection's points cannot accept a connection line
	//     and any connection lines that were added cannot be removed.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     nMaxConnections - The maximum number of connections (connection lines)
	//                       that the connection point can accept.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Gets the number of connection lines connected to this connection point.
	// Returns:
	//     The number of connection lines connected to this connection point.
	//-----------------------------------------------------------------------
	int GetConnectionsCount() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Gets the number of input connection lines connected to this connection point.
	// Returns:
	//     The number of input connection lines connected to this connection point.
	//-----------------------------------------------------------------------
	int GetInputConnectionsCount() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the input connection associated with a point by its index.
	// Parameters:
	//     nIndex - Index of the point whose input connection must be retrieved.
	// Returns:
	//     A pointer to the input connection associated with the point.
	//-----------------------------------------------------------------------
	CXTPFlowGraphConnection* GetInputConnectionAt(int nIndex) const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Gets the number of output connection lines connected to this connection point.
	// Returns:
	//     The number of output connection lines connected to this connection point.
	//-----------------------------------------------------------------------
	int GetOutputConnectionsCount() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the output connection associated with a point by its index.
	// Parameters:
	//     nIndex - Index of the point whose output connection must be retrieved.
	// Returns:
	//     A pointer to the output connection associated with the point.
	//-----------------------------------------------------------------------
	...
	//     point's caption.
	// Parameters:
	//     nImageIndex - The ID of the image to display to the left of the
	//                   connection point's caption.
	// Remarks:
	//     Use the image index to specify the index of the previously loaded
	//     image to display next to the connection point's caption.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get the markup element that renders the caption
	//     of the control.
	// Returns:
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Gets a reference to the Node that this connection point belongs to.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Gets a reference to the page that this connection point belongs to.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Gets the image to display to the left of the connection point's caption.
	// Returns:
	//     The image to display to the left of the connection point's caption.
	//-----------------------------------------------------------------------
	CXTPFlowGraphImage* GetImage() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called when the flow graph's layout is changed.
	// Remarks:
...
public:
	...
	// Remarks:
	//     This member function is used to store/load connection point
...
public:
	...
	//     pt - Point to test.
	// Returns:
	//     TRUE if the specified point is located within the connection area,
	//     otherwise FALSE.
	//-----------------------------------------------------------------------
...
protected:
	...
	CString m_strName; // Unique name of the connection point.

	CString m_strTooltip;					 // Tooltip text for the item.
	COLORREF m_clrPoint;					 // Color of the connection point.
	XTPFlowGraphConnectionPointType m_nType; // Type of connection point; specifies whether the
											 // FlowGraphConnection will have any connection points
											 // (input/output).
	...
	BOOL m_bLocked; // Specifies if the connection point is locked. TRUE if the connection point is
					// locked, FALSE if it can accept connections.
	...
	int m_nMaxConnections; // The maximum number of connections (connection lines) that the
						   // connection point can accept.
...
AFX_INLINE CXTPFlowGraphConnection*
	CXTPFlowGraphConnectionPoint::GetInputConnectionAt(int nIndex) const
{
...
AFX_INLINE CXTPFlowGraphConnection*
	CXTPFlowGraphConnectionPoint::GetOutputConnectionAt(int nIndex) const
{
