...
public:
	...
	//------------------------------------------------------------------------
	// Summary:
	//     This method is called to refresh the visual metrics of the flow graph.
	//------------------------------------------------------------------------
	...
	// Parameters:
	//     pDC -          Pointer to a valid device context.
	//     pConnection -  Pointer to a CXTPFlowGraphConnection object to draw.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Retrieves the bounding rectangle for the specified Node.
	// Parameters:
	//     pNode - Reference to the Node whose bounding rectangle must be
	//             retrieved.
	// Returns:
	...
	// Parameters:
	//     pDC -         Pointer to a valid device context.
	//     pNodeGroup -  Pointer to a CXTPFlowGraphNodeGroup object to draw.
	//------------------------------------------------------------------------
	...
	//     point  -  Point in the flow graph to test.
	// Returns:
	//     TRUE if the point is located within the connection area,
	//     otherwise FALSE.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Retrieves the bounding rectangle for the caption of the specified Node.
	// Parameters:
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Cleans up allocated resources used by the paint manager that have
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Creates and retrieves a darker color of a specified color.
	// Parameters:
	...
	// Returns:
	//     A darker color of the specified color.
	//------------------------------------------------------------------------
...
public:
	...
	COLORREF m_clrSelection;  // Specifies the color used for selected Node's connection points'
							  // rectangles.
	COLORREF m_clrSelectionInactive; // Specifies the color used for selected Node's rectangle
									 // (inactive).
	COLORREF m_clrTextColor;		 // Specifies the color used for text.
	COLORREF m_clrTextColorSelected; // Specifies the color used for text when a Node is selected.
	...
	BOOL m_bShowNodeGroupsAlways; // Specifies whether to always show Node groups, even if a
								  // non-grouped Node is selected (or if no Nodes are selected).
	BOOL m_bAlwaysDrawConnectionPoints; // Specifies whether to draw connection points always or
										// draw only on active Nodes.
	BOOL m_bRecalcConnectionLayoutWhenNeeded; // Recalculates the end points of a connection when
											  // its selected state changes.
