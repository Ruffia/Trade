...
public:
	//------------------------------------------------------------------------
	// Summary:
	//     Sets the input connection point that this connection line is
	//     connected to.
	// Parameters:
	//     pPoint -  Reference to the connection point to connect to.
	//------------------------------------------------------------------------
	virtual void SetInputPoint(CXTPFlowGraphConnectionPoint* pPoint);
	//------------------------------------------------------------------------
	// Summary:
	//     Gets the input connection point that this connection line is
	//     connected to.
	// Returns:
	//     Reference to the input connection point that this connection line
	//     is connected to.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Sets the output connection point that this connection line is
	//     connected to.
	// Parameters:
	//     pPoint - Reference to the connection point to connect to.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Gets the output connection point that this connection line is
	//     connected to.
	// Returns:
	//     Reference to the output connection point that this connection line
	//     is connected to.
	//------------------------------------------------------------------------
	...
	// Remarks:
	//     This sets the point where the little circle glyph is drawn along the
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Gets the middle point of the connection (this is also what
	//     happens when a connection is dragged by the mouse).
	// Remarks:
	//     This is the point where the little circle glyph is drawn along the
	//     spline/line (connection). When a connection is clicked and
	//     dragged with the mouse, a small circle "point" is drawn to indicate
	//     where the line was clicked and how much it has been dragged.
	// Returns:
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Sets the caption for the connection.
	// Parameters:
	//     lpszCaption - Caption for the connection.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Gets the tooltip of this connection.
	// Remarks:
	//     This is the text that is displayed when the mouse is hovered over
	//     the connection.
	// Returns:
	//     The tooltip of this connection.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Sets the color for the connection line.
	// Parameters:
	//     clr - Color for the connection line.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Sets the style for the connector.
	// Parameters:
	//     nStyle - Style for the connector. This will be a value from the
	//              XTPFlowGraphConnectorType enumeration.
	// Remarks:
	//     Use a value from the XTPFlowGraphConnectorType enumeration to set
	//     the style for the connector.
	//------------------------------------------------------------------------
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Sets the width for the connector line.
	// Parameters:
	//     nWidth - Width for the connector line.
	//------------------------------------------------------------------------
	void SetWidth(int nWidth);
	//------------------------------------------------------------------------
	// Summary:
	//     Gets the width of the connector line.
	// Returns:
	...
	//------------------------------------------------------------------------
	// Summary:
	//     Enables/disables dashed style for the connector line.
	// Parameters:
	//     bDashed - TRUE to enable dashed style, FALSE to disable.
	//------------------------------------------------------------------------
	void SetDashed(BOOL bDashed);
	//------------------------------------------------------------------------
	// Summary:
	//     Determines if dashed style is enabled/disabled for the connector line.
	// Returns:
	//     TRUE if dashed style is enabled for the connector line,
...
public:
	...
	//     pt -  Point to test.
	// Returns:
	//     TRUE if the point is located within the connection, otherwise FALSE.
	//------------------------------------------------------------------------
...
public:
	//------------------------------------------------------------------------
	// Summary:
	//     Gets the input Node that this connection line is connected to.
	// Returns:
	//     Reference to the input Node that this connection line is connected to.
	//------------------------------------------------------------------------
	CXTPFlowGraphNode* GetInputNode() const;
	//------------------------------------------------------------------------
	// Summary:
	//     Gets the output Node that this connection line is connected to.
	// Returns:
	//     Reference to the output Node that this connection line is connected to.
	//------------------------------------------------------------------------
...
public:
	...
	// Remarks:
	//     This member function is used to store/load connection data to/from
	//     storage.
	//------------------------------------------------------------------------
...
protected:
	...
	CXTPFlowGraphConnectionPoint* m_pInputPoint;  // The input ConnectionPoint that this connection
												  // line is connected to.
	CXTPFlowGraphConnectionPoint* m_pOutputPoint; // The output ConnectionPoint that this connection
												  // line is connected to.
