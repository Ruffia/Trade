...
public:
	...
	//     lpszResourceType - The type of the resource.
	//-------------------------------------------------------------------------
	...
	// Parameters:
	//     lpszFileName - Filename and path to the file with the image to load.
	//-------------------------------------------------------------------------
	void LoadFromFile(LPCTSTR lpszFileName);
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this method to assign a bitmap handle to the CXTPFlowGraphImage
	//     class.
	// Parameters:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this method to assign an icon handle to the CXTPFlowGraphImage
	//     class.
	// Parameters:
	...
	// Returns:
	//     A reference to a Gdiplus::Image for this flow graph image.
	//-------------------------------------------------------------------------
	...
	// Returns:
	//     A reference to a CXTPImageManagerIcon for this flow graph image.
	//-------------------------------------------------------------------------
...
public:
	...
	// Returns:
	//     A reference to the FlowGraphImage that was just added.
	//-------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Retrieves the total number of images added to the flow graph.
	// Returns:
	//     The total number of images added to the flow graph.
	//-------------------------------------------------------------------------
	int GetCount() const;
	//-------------------------------------------------------------------------
	// Summary:
	//     Retrieves the specified image from the collection of all images added
	//     to the flow graph.
	// Parameters:
	//     nIndex - Index of the desired image to retrieve.
	// Returns:
	//     A reference to the specified image.
	//-------------------------------------------------------------------------
	...
	// Parameters:
	//     pPage - Reference to the page to remove images from.
	//-------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Retrieves the image manager associated with the flow graph.
	// Returns:
	//     A pointer to the image manager object that stores the images in
	//     the flow graph.
	//-------------------------------------------------------------------------
...
protected:
	CArray<CXTPFlowGraphImage*, CXTPFlowGraphImage*> m_arrImages; // List of images for the flow
																  // graph.
	CXTPImageManager* m_pImageManager; // Pointer to the image manager associated with the flow
									   // graph.
