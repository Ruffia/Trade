...
//===========================================================================
// Summary:
//     CXTPTabColorSetVisualStudio2015 implements a Visual Studio 2015 tab color set.
//===========================================================================
class _XTP_EXT_CLASS CXTPTabColorSetVisualStudio2015 : public CXTPTabPaintManagerColorSet
{
public:
	...
	virtual COLORREF GetItemBorderColor(CXTPTabManagerItem* pItem);
	virtual CRect GetItemBorderRect(CXTPTabManagerItem* pItem);
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Fills a specified tab naGroupOuterMarginvigation button.
	// Parameters:
	//     pDC     - Pointer to a valid device context.
...
protected:
	...
	struct NAVIGATE_BUTTON
	{
		NAVIGATE_BUTTON_COLOR Normal;
		NAVIGATE_BUTTON_COLOR Highlighted;
		NAVIGATE_BUTTON_COLOR Pressed;
	};
	...
	CXTPPaintManagerColor m_clrActiveClientBack;
	CXTPPaintManagerColor m_clrInactiveClientBack;

	NAVIGATE_BUTTON m_NavigationButton;
	TAB_BUTTON m_ActiveTabButton;
	TAB_BUTTON m_InactiveTabButton;

	void FillNavigateButton(CDC* pDC, CXTPTabManagerNavigateButton* pButton, CRect& rc,
							NAVIGATE_BUTTON_COLOR clr);
};
