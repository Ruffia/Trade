...
void CXTPTabColorSetOffice2003::FillNavigateButton(CDC* pDC, CXTPTabManagerNavigateButton* pButton,
												   CRect& rc)
{
	...
	pDC->SetTextColor(GetXtremeColor(XTPToUIntChecked(nColor)));

	pButton->DrawEntry(pDC, rc, m_clrActiveFilesGlyph, pButton->IsEnabled());
}

COLORREF CXTPTabColorSetOffice2003::FillPropertyButton(CDC* pDC, CRect rcItem,
