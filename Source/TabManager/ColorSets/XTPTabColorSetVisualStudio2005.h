...
//===========================================================================
// Summary:
//     CColorSetVisualStudio2005 implements a Visual Studio 2005 tab color set.
// Remarks:
...
public:
	...
	//
	//     If m_bGradientButton is TRUE, then
	//     CXTPTabColorSetOffice2003::FillPropertyButton is used to fill the
	//     tab button with a gradient fill.
	//     See CXTPTabColorSetOffice2003::FillPropertyButton for details.
	//
	//     If m_bGradientButton is FALSE, then
	//     CXTPTabPaintManagerColorSet::FillPropertyButton is used.
	// See Also:
	//     m_bGradientButton
	//-----------------------------------------------------------------------
