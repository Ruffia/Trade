// XTPRibbonBackstageButtonThemeVisualStudio2019.cpp : implementation file
//
...
CXTPRibbonBackstageButtonThemeVisualStudio2019::CXTPRibbonBackstageButtonThemeVisualStudio2019()
{
	m_bOffsetHiliteText = FALSE;
}

void CXTPRibbonBackstageButtonThemeVisualStudio2019::DrawButtonBackground(CDC* pDC,
																		  CXTPButton* pButton)
{
	...
	CXTPButtonThemeVisualStudio2019::DrawButtonBackground(pDC, pButton);
}
