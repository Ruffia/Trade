// XTPRibbonBackstageButtonThemeVisualStudio2015.h: interface for the
// CXTPRibbonBackstageButtonThemeVisualStudio2015 class.
//
...
class _XTP_EXT_CLASS CXTPRibbonBackstageButtonThemeVisualStudio2015
	: public CXTPButtonThemeVisualStudio2015
{
public:
