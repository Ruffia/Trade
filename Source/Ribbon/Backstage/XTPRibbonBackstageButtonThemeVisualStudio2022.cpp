// XTPRibbonBackstageButtonThemeVisualStudio2022.cpp : implementation file
//
...
CXTPRibbonBackstageButtonThemeVisualStudio2022::CXTPRibbonBackstageButtonThemeVisualStudio2022()
{
	m_bOffsetHiliteText = FALSE;
}

void CXTPRibbonBackstageButtonThemeVisualStudio2022::DrawButtonBackground(CDC* pDC,
																		  CXTPButton* pButton)
{
	...
	CXTPButtonThemeVisualStudio2022::DrawButtonBackground(pDC, pButton);
}
