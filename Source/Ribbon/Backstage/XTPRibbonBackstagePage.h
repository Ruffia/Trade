...
public:
	...
	void SetRightToLeft(BOOL bRTL = TRUE);
...
AFX_INLINE BOOL CXTPRibbonBackstagePage::IsRightToLeft() const
{
	return m_bRightToLeft;
}

AFX_INLINE void CXTPRibbonBackstagePage::SetRightToLeft(BOOL bRTL /*= TRUE*/)
{
	m_bRightToLeft = bRTL;
}
