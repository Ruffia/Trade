// XTPRibbonBackstageButtonThemeVisualStudio2017.cpp : implementation file
//
...
CXTPRibbonBackstageButtonThemeVisualStudio2017::CXTPRibbonBackstageButtonThemeVisualStudio2017()
{
	m_bOffsetHiliteText = FALSE;
}

void CXTPRibbonBackstageButtonThemeVisualStudio2017::DrawButtonBackground(CDC* pDC,
																		  CXTPButton* pButton)
{
	...
	CXTPButtonThemeVisualStudio2017::DrawButtonBackground(pDC, pButton);
}
