...
//{{AFX_CODEJOCK_PRIVATE
//===========================================================================
#	define XTP_EDIT_LEX_CLASS_OBJ_MEMBER_NAME(_Name, _str)                                        \
		inline LPCTSTR _Name()                                                                     \
		{                                                                                          \
			return _str;                                                                           \
		}

//===========================================================================
#	define XTP_EDIT_LEX_CLASS_OBJ_MEMBER(id, _member)                                             \
	public:                                                                                        \
...
#	define XTP_EDIT_DEFINE_LEX_CLASS_OBJ_N1(objClass, subN1)                                      \
		XTP_EDIT_DEFINE_LEX_CLASS_OBJ(objClass, XTP_EDIT_DEFINE_LEX_CLASS_OBJ_BASE_N1(subN1))

#	define XTP_EDIT_DEFINE_LEX_CLASS_OBJ_N2(objClass, subN1, subN2)                               \
		XTP_EDIT_DEFINE_LEX_CLASS_OBJ(objClass, XTP_EDIT_DEFINE_LEX_CLASS_OBJ_BASE_N2(subN1, subN2))
...
XTP_EDIT_DEFINE_LEX_CLASS_OBJ_N3(CXTPSyntaxEditLexObj_End, FnName_end_class, FnName_end_tag,
								 FnName_end_separators)
XTP_EDIT_LEX_CLASS_OBJ_MEMBER(0, m_class)
XTP_EDIT_LEX_CLASS_OBJ_MEMBER(1, m_tag)
...
XTP_EDIT_DEFINE_LEX_CLASS_OBJ_N3(CXTPSyntaxEditLexObj_Token, FnName_tokeFnName_tag,
								 FnName_tokeFnName_start_separators,
								 FnName_tokeFnName_end_separators)
...
class CXTPSyntaxEditLexObj_ActiveTags
	: public CXTPSyntaxEditLexVariantPtrArrayExAutomatT<FnName_active_tags>
{
