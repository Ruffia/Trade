...
int CXTPSyntaxEditUndoRedoManager::DoUndo(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
...
int CXTPSyntaxEditUndoRedoManager::DoRedo(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
										  CXTPSyntaxEditCtrl* pEditCtrl)
{
	int nRet = 0;
	// get next item
...
void CXTPSyntaxEditUndoRedoManager::RemoveTail()
{
	...
	for (POSITION posTail = m_CommandList.GetTailPosition(); posTail != m_posFirstUndo;
...
void CXTPSyntaxEditUndoRedoManager::AddCommand(CXTPSyntaxEditCommand* pCommand)
{
	...
	else
	{
		CXTPSyntaxEditCommand* pCmd = m_CommandList.GetTailPosition()
										  ? (CXTPSyntaxEditCommand*)m_CommandList.GetTail()
										  : NULL;
...
{
	for (POSITION posTail = m_CommandList.GetTailPosition(); posTail != NULL;
		 posTail		  = m_CommandList.GetTailPosition())
	{
		CXTPSyntaxEditCommand* pCmd = (CXTPSyntaxEditCommand*)m_CommandList.GetTail();
		m_CommandList.RemoveTail();
...
void CXTPSyntaxEditUndoRedoManager::ChainLastCommand()
{
	...
	CXTPSyntaxEditCommand* pCmd = posPrev ? (CXTPSyntaxEditCommand*)m_CommandList.GetPrev(posPrev)
										  : NULL;
	if (!pCmd || !posPrev)
		return;
...
void CXTPSyntaxEditUndoRedoManager::SetLastCommandText(LPCTSTR szText)
{
	...
	CXTPSyntaxEditCommand* pCmd = m_posFirstUndo
									  ? (CXTPSyntaxEditCommand*)m_CommandList.GetAt(m_posFirstUndo)
									  : NULL;
	if (!pCmd)
		return;
...
void AFX_CDECL CXTPSyntaxEditCommand::SetPositionInternally(CXTPSyntaxEditCtrl* pEditCtrl,
...
int CXTPSyntaxEditBatchCommand::Execute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
										CXTPSyntaxEditCtrl* pEditCtrl)
{
	int nRet = 0;
...
int CXTPSyntaxEditBatchCommand::UnExecute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
										  CXTPSyntaxEditCtrl* pEditCtrl)
{
	int nRet = 0;
	lcFrom   = XTP_EDIT_LINECOL::MAXPOS;
...
CXTPSyntaxEditBufferCommand::CXTPSyntaxEditBufferCommand(CXTPSyntaxEditBufferManager* pMgr,
														 LPCTSTR szText,
														 const XTP_EDIT_LINECOL& lcFrom,
...
CXTPSyntaxEditBufferCommand::CXTPSyntaxEditBufferKeepOverwriteSettings::
...
int CXTPSyntaxEditBufferCommand::DoDeleteText(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
											  CXTPSyntaxEditCtrl* pEditCtrl)
{
	if (!m_pBufferMgr)
		return 0;
...
int CXTPSyntaxEditBufferCommand::DoInsertText(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
											  CXTPSyntaxEditCtrl* pEditCtrl)
{
	if (!m_pBufferMgr)
		return 0;
...
int CXTPSyntaxEditBufferCommand::GetDataSize() const
{
	return XTPToIntChecked(m_strText.GetLength() * sizeof(TCHAR));
}
...
CXTPSyntaxEditDeleteStringCommand::CXTPSyntaxEditDeleteStringCommand(
	CXTPSyntaxEditBufferManager* pMgr, LPCTSTR szText, const XTP_EDIT_LINECOL& lcFrom,
	const XTP_EDIT_LINECOL& lcTo)
...
int CXTPSyntaxEditDeleteStringCommand::Execute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
											   CXTPSyntaxEditCtrl* pEditCtrl)
{
	return DoDeleteText(lcFrom, lcTo, pEditCtrl);
}

int CXTPSyntaxEditDeleteStringCommand::UnExecute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
												 CXTPSyntaxEditCtrl* pEditCtrl)
{
...
int CXTPSyntaxEditInsertStringCommand::Execute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
											   CXTPSyntaxEditCtrl* pEditCtrl)
{
	return DoInsertText(lcFrom, lcTo, pEditCtrl);
}

int CXTPSyntaxEditInsertStringCommand::UnExecute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
												 CXTPSyntaxEditCtrl* pEditCtrl)
{
	return DoDeleteText(lcFrom, lcTo, pEditCtrl);
}
...
CXTPSyntaxEditReplaceStringCommand::CXTPSyntaxEditReplaceStringCommand(
	CXTPSyntaxEditBufferManager* pMgr, LPCTSTR szText, LPCTSTR szReplacedText,
	const XTP_EDIT_LINECOL& lcFrom, const XTP_EDIT_LINECOL& lcTo)
	: CXTPSyntaxEditBufferCommand(pMgr, szText, lcFrom, lcTo)
	, m_strReplacedText(szReplacedText)
{
	XTPResourceManager()->LoadString(&m_strCommandText, XTP_IDS_EDIT_MULTIPLE);
	m_strCommandText += m_strText;
}
...
int CXTPSyntaxEditReplaceStringCommand::Execute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
												CXTPSyntaxEditCtrl* pEditCtrl)
{
	return DoReplaceText(m_strText, lcFrom, lcTo, pEditCtrl);
}

int CXTPSyntaxEditReplaceStringCommand::UnExecute(XTP_EDIT_LINECOL& lcFrom, XTP_EDIT_LINECOL& lcTo,
												  CXTPSyntaxEditCtrl* pEditCtrl)
{
	return DoReplaceText(m_strReplacedText, lcFrom, lcTo, pEditCtrl);
}

int CXTPSyntaxEditReplaceStringCommand::DoReplaceText(LPCTSTR szText, XTP_EDIT_LINECOL& lcFrom,
													  XTP_EDIT_LINECOL& lcTo,
													  CXTPSyntaxEditCtrl* pEditCtrl)
{
	if (!m_pBufferMgr)
		return 0;
	...
	if (m_lcFrom.nLine != m_lcTo.nLine)
		nEditAction |= XTP_EDIT_EDITACTION_INSERTROW | XTP_EDIT_EDITACTION_DELETEROW
					   | XTP_EDIT_EDITACTION_MODIFYROW;
	else if (m_lcFrom.nCol != m_lcTo.nCol)
		nEditAction |= XTP_EDIT_EDITACTION_MODIFYROW;
...
int CXTPSyntaxEditReplaceStringCommand::GetDataSize() const
{
	return XTPToIntChecked(m_strReplacedText.GetLength() * sizeof(TCHAR)
