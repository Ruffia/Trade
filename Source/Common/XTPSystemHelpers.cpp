...
bool CXTPSystemVersion::IsWin11OrGreater() const
{
	static bool bResult = false, bChecked = false;
	if (!bChecked && NULL != m_pfnRtlGetVersion)
	{
		...
		if (0 == m_pfnRtlGetVersion(&vi))
		{
			bResult  = vi.dwMajorVersion >= 10 && vi.dwBuildNumber >= 22000;
			bChecked = true;
		}
	}
...
//////////////////////////////////////////////////////////////////////////
// CXTPAccessible::SharedHandle

CXTPAccessible::SharedHandle::SharedHandle(CXTPAccessible* pAcc)
	: pAcc(pAcc)
	, cRefs(1)
{
	ASSERT(NULL != pAcc);
...
void CXTPAccessible::SharedHandle::AddRef()
{
	++cRefs;
}

void CXTPAccessible::SharedHandle::Release()
{
	if (0 == --cRefs)
		delete this;
}
...
CXTPAccessible::CXTPAccessible()
	...
	, m_pHandle(NULL)
{
	m_pHandle = new SharedHandle(this);
}
...
LRESULT CXTPAccessible::LresultFromProxyObject(WPARAM wParam)
{
	IAccessible* pAccProxy = CreateAccProxy();
	LRESULT lRes		   = LresultFromObject(IID_IAccessible, wParam, pAccProxy);
	pAccProxy->Release();
	return lRes;
}

IAccessible* CXTPAccessible::CreateAccProxy()
{
	return new CXTPAccessibleProxy(m_pHandle);
}
...
CXTPAccessibleProxy::CXTPAccessibleProxy(CXTPAccessible::SharedHandle* pAccHandle)
	: m_pAccHandle(pAccHandle)
	, m_cRefs(1)
{
	m_pAccHandle->AddRef();
}

CXTPAccessibleProxy::~CXTPAccessibleProxy()
{
	m_pAccHandle->Release();
}

BOOL CXTPAccessibleProxy::IsAlive() const
{
	return m_pAccHandle->pAcc != NULL;
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::QueryInterface(
	/* [in] */ REFIID riid,
...
ULONG STDMETHODCALLTYPE CXTPAccessibleProxy::AddRef(void)
{
	return ++m_cRefs;
}

ULONG STDMETHODCALLTYPE CXTPAccessibleProxy::Release(void)
{
	if (0 == --m_cRefs)
	{
		delete this;
...
HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::GetTypeInfoCount(
	/* [out] */ UINT* pctinfo)
{
	if (!IsAlive())
		return CO_E_OBJNOTCONNECTED;

	return m_pAccHandle->pAcc->m_xExternalAccessible.GetTypeInfoCount(pctinfo);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::GetTypeInfo(
	/* [in] */ UINT iTInfo,
	/* [in] */ LCID lcid,
	/* [out] */ ITypeInfo** ppTInfo)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.GetTypeInfo(iTInfo, lcid, ppTInfo);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::GetIDsOfNames(
	/* [in] */ REFIID riid,
	...
	/* [size_is][out] */ DISPID* rgDispId)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.GetIDsOfNames(riid, rgszNames, cNames, lcid,
																   rgDispId);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::Invoke(
	/* [annotation][in] */
	DISPID dispIdMember,
	/* [annotation][in] */
	REFIID riid,
	...
	UINT* puArgErr)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.Invoke(dispIdMember, riid, lcid, wFlags,
															pDispParams, pVarResult, pExcepInfo,
															puArgErr);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accParent(
	/* [retval][out] */ IDispatch** ppdispParent)
{
	if (!IsAlive())
		return CO_E_OBJNOTCONNECTED;

	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accParent(ppdispParent);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accChildCount(
	/* [retval][out] */ long* pcountChildren)
{
	if (!IsAlive())
		return CO_E_OBJNOTCONNECTED;

	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accChildCount(pcountChildren);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accChild(
	/* [in] */ VARIANT varChild,
	/* [retval][out] */ IDispatch** ppdispChild)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accChild(varChild, ppdispChild);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accName(
	...
	/* [retval][out] */ BSTR* pszName)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accName(varChild, pszName);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accValue(
	/* [optional][in] */ VARIANT varChild,
	/* [retval][out] */ BSTR* pszValue)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accValue(varChild, pszValue);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accDescription(
	/* [optional][in] */ VARIANT varChild,
	/* [retval][out] */ BSTR* pszDescription)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accDescription(varChild, pszDescription);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accRole(
	/* [optional][in] */ VARIANT varChild,
	/* [retval][out] */ VARIANT* pvarRole)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accRole(varChild, pvarRole);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accState(
	/* [optional][in] */ VARIANT varChild,
	/* [retval][out] */ VARIANT* pvarState)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accState(varChild, pvarState);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accHelp(
	/* [optional][in] */ VARIANT varChild,
	/* [retval][out] */ BSTR* pszHelp)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accHelp(varChild, pszHelp);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accHelpTopic(
	...
	/* [retval][out] */ long* pidTopic)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accHelpTopic(pszHelpFile, varChild,
																	  pidTopic);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accKeyboardShortcut(
	/* [optional][in] */ VARIANT varChild,
	/* [retval][out] */ BSTR* pszKeyboardShortcut)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accKeyboardShortcut(varChild,
																			 pszKeyboardShortcut);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accFocus(
	/* [retval][out] */ VARIANT* pvarChild)
{
	if (!IsAlive())
		return CO_E_OBJNOTCONNECTED;

	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accFocus(pvarChild);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accSelection(
	/* [retval][out] */ VARIANT* pvarChildren)
{
	if (!IsAlive())
		return CO_E_OBJNOTCONNECTED;

	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accSelection(pvarChildren);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::get_accDefaultAction(
	/* [optional][in] */ VARIANT varChild,
	/* [retval][out] */ BSTR* pszDefaultAction)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.get_accDefaultAction(varChild,
																		  pszDefaultAction);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::accSelect(
	/* [in] */ long flagsSelect,
	/* [optional][in] */ VARIANT varChild)
{
	if (!IsAlive())
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.accSelect(flagsSelect, varChild);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::accLocation(
	/* [out] */ long* pxLeft,
	/* [out] */ long* pyTop,
	/* [out] */ long* pcxWidth,
	/* [out] */ long* pcyHeight,
	/* [optional][in] */ VARIANT varChild)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.accLocation(pxLeft, pyTop, pcxWidth, pcyHeight,
																 varChild);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::accNavigate(
	/* [in] */ long navDir,
	...
	/* [retval][out] */ VARIANT* pvarEndUpAt)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.accNavigate(navDir, varStart, pvarEndUpAt);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::accHitTest(
	/* [in] */ long xLeft,
	/* [in] */ long yTop,
	/* [retval][out] */ VARIANT* pvarChild)
{
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.accHitTest(xLeft, yTop, pvarChild);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::accDoDefaultAction(
	/* [optional][in] */ VARIANT varChild)
{
	if (!IsAlive())
		return CO_E_OBJNOTCONNECTED;

	return m_pAccHandle->pAcc->m_xExternalAccessible.accDoDefaultAction(varChild);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::put_accName(
	/* [optional][in] */ VARIANT varChild,
	/* [in] */ BSTR szName)
{
	if (!IsAlive())
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.put_accName(varChild, szName);
}

HRESULT STDMETHODCALLTYPE CXTPAccessibleProxy::put_accValue(
	/* [optional][in] */ VARIANT varChild,
	/* [in] */ BSTR szValue)
{
	if (!IsAlive())
	...
	return m_pAccHandle->pAcc->m_xExternalAccessible.put_accValue(varChild, szValue);
}
