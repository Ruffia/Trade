...
// </code>
// See Also:
//     CXTPImageManager::SetIcon, CXTPImageManager::SetIcons
//
...
public:
	...
	{
		return XTP_SAFE_GET1(m_pResource, u.markup.pContext, NULL);
	}

	//-------------------------------------------------------------------------
	// Summary:
	//     Retrieves the data stream for the icon.
	// Returns:
	//     The data stream for the icon.
	//-------------------------------------------------------------------------
	IStream* GetDataStream() const
	{
		return XTP_SAFE_GET1(m_pResource, pSerializationDataStream, NULL);
	}
...
public:
	...
	// Parameters:
	//     nDpi - Custom DPI level or 0 for the current DPI value.
	// Returns:
	...
	//-------------------------------------------------------------------------
	// <combine
	// CXTPImageManagerIconHandle::CreateIconFromResource@LPCTSTR@CSize@BOOL@XTPIconSizeMatching>
	//-------------------------------------------------------------------------
...
public:
	...
	//     szRecommendedExtent - Recommended icon size that suits the icon best.
	//                           A zero value size component assumes no recommended value.
	//-----------------------------------------------------------------------
	...
	CXTPImageManagerIcon(UINT nID, CXTPImageManagerIconSet* pIconSet = NULL,
						 CSize szRecommendedExtent = CSize(0));
	...
	// Returns:
	//     TRUE if icons were scaled from another CXTPImageManagerIcon object.
	//-------------------------------------------------------------------------
	BOOL IsScaled() const;
	...
	// -----------------------------------------------------------------------
	// <combine CXTPImageManagerIcon::SetIcon@const CXTPImageManagerIconHandle&>
	// -----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	CSize GetExtent() const;
	static CSize AFX_CDECL GetExtent(HICON hIcon); // <combine
												   // CXTPImageManagerIcon::GetExtent@const>

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the recommended size of the icon. It is an optional size and may not be
	//     specified by default. Usually it's the size that the icon was added to its icon manager
	//     with. For raster icons its value almost always equals to GetExtent returned value. But
	//     for vector icons that have no extent it will be the size that it was added to the
	//     collection.
	// Returns:
	//     The recommended size of the icon.
	// See Also:
	//		GetExtent
	//-----------------------------------------------------------------------
	CSize GetRecommendedExtent() const;
	...
	void SerializeIcon(
		CXTPImageManagerVectorImageHandle& hIcon, CArchive& ar,
		long nSchema); // <combine
					   // CXTPImageManagerIcon::SerializeIcon@CXTPImageManagerIconHandle&@CArchive&@long>
	...
	void Draw(CDC* pDC, CPoint pt,
			  CSize szIcon); // <combine CXTPImageManagerIcon::Draw@CDC*@CPoint>
	void Draw(CDC* pDC, CPoint pt,
			  XTPImageState imageState); // <combine CXTPImageManagerIcon::Draw@CDC*@CPoint>
	...
	void Draw(CDC* pDC, CPoint pt, CXTPImageManagerIconHandle& hIcon, CSize szIcon = 0,
			  COLORREF clrBK = CLR_NONE, COLORREF clrFG = CLR_NONE,
			  UINT uiFlags = 0); // <combine CXTPImageManagerIcon::Draw@CDC*@CPoint>
	...
	BOOL SetVectorIcon(
		CXTPImageManagerVectorImageHandle hIcon,
		XTPImageState
			imageState); // <combine
						 // CXTPImageManagerIcon::SetVectorIcon@CXTPImageManagerVectorImageHandle>
	BOOL SetVectorDisabledIcon(
		CXTPImageManagerVectorImageHandle
			hIcon); // <combine
					// CXTPImageManagerIcon::SetVectorIcon@CXTPImageManagerVectorImageHandle>
	BOOL SetVectorHotIcon(
		CXTPImageManagerVectorImageHandle
			hIcon); // <combine
					// CXTPImageManagerIcon::SetVectorIcon@CXTPImageManagerVectorImageHandle>
	BOOL SetVectorCheckedIcon(
		CXTPImageManagerVectorImageHandle
			hIcon); // <combine
					// CXTPImageManagerIcon::SetVectorIcon@CXTPImageManagerVectorImageHandle>
	BOOL SetVectorPressedIcon(
		CXTPImageManagerVectorImageHandle
			hIcon); // <combine
					// CXTPImageManagerIcon::SetVectorIcon@CXTPImageManagerVectorImageHandle>
	...
	CXTPImageManagerVectorImageHandle GetVectorIcon(
		XTPImageState imageState) const; // <combine CXTPImageManagerIcon::GetVectorIcon@const>
	CXTPImageManagerVectorImageHandle
		GetVectorCheckedIcon() const; // <combine CXTPImageManagerIcon::GetVectorIcon@const>
	CXTPImageManagerVectorImageHandle
		GetVectorPressedIcon() const; // <combine CXTPImageManagerIcon::GetVectorIcon@const>
	CXTPImageManagerVectorImageHandle
		GetVectorHotIcon() const; // <combine CXTPImageManagerIcon::GetVectorIcon@const>
	CXTPImageManagerVectorImageHandle
		GetVectorDisabledIcon() const; // <combine CXTPImageManagerIcon::GetVectorIcon@const>
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Sets state dependent icon from various icon sources.
	// Parameters:
	//      pStream - Vector icon data source.
	//      hIcon - Pre-loaded vector image handle.
	...
	BOOL SetVectorDisabledIcon(
		IStream* pStream,
		UINT nWidth); // <combine CXTPImageManagerIconSet::SetVectorIcon@IStream*@UINT>
	BOOL SetVectorHotIcon(IStream* pStream,
						  UINT nWidth); // <combine
										// CXTPImageManagerIconSet::SetVectorIcon@IStream*@UINT>
	BOOL SetVectorCheckedIcon(IStream* pStream,
							  UINT nWidth); // <combine
											// CXTPImageManagerIconSet::SetVectorIcon@IStream*@UINT>
	BOOL SetVectorPressedIcon(IStream* pStream,
							  UINT nWidth); // <combine
											// CXTPImageManagerIconSet::SetVectorIcon@IStream*@UINT>
...
public:
	...
	BOOL SetIcons(UINT nIDResourceToolBar, UINT nIDResourceBitmap,
				  XTPImageState imageState =
					  xtpImageNormal); // <combine CXTPImageManager::SetIcons@UINT@XTPImageState>
	BOOL SetIcons(CBitmap& bmpIcons, UINT* pCommands, int nCount, CSize szIcon,
				  XTPImageState imageState = xtpImageNormal,
				  BOOL bAlpha = FALSE); // <combine CXTPImageManager::SetIcons@UINT@XTPImageState>
	...
	void AddIcons(
		CXTPImageManagerIconSet* pIconSet); // <combine
											// CXTPImageManager::AddIcons@CXTPImageManager*>
	...
	BOOL SetIcon(UINT nIDResourceIcon, UINT nIDCommand, CSize szIcon = 0,
				 XTPImageState imageState =
					 xtpImageNormal); // <combine CXTPImageManager::SetIcon@const
									  // CXTPImageManagerIconHandle&@UINT@CSize@XTPImageState>
	...
	BOOL SetVectorIcon(LPCTSTR lpResourceType, UINT nIDResource, UINT nIDCommand, UINT nWidth,
					   XTPImageState imageState = xtpImageNormal);
	BOOL SetVectorIcon(
		LPCTSTR lpResourceType, LPCTSTR lpResource, UINT nIDCommand, UINT nWidth,
		XTPImageState imageState =
			xtpImageNormal); // <combine
							 // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		HMODULE hModule, LPCTSTR lpResourceType, UINT nIDResource, UINT nIDCommand, UINT nWidth,
		XTPImageState imageState =
			xtpImageNormal); // <combine
							 // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		HMODULE hModule, LPCTSTR lpResourceType, LPCTSTR lpResource, UINT nIDCommand, UINT nWidth,
		XTPImageState imageState =
			xtpImageNormal); // <combine
							 // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		CXTPImageManagerVectorImageHandle hImage, UINT nIDCommand, UINT nWidth,
		XTPImageState imageState =
			xtpImageNormal); // <combine
							 // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		LPCTSTR lpResourceType, UINT nIDResourceNormal, UINT nIDResourceDisabled,
		UINT nIDResourceHot, UINT nIDResourceChecked, UINT nIDResourcePressed, UINT nIDCommand,
		UINT nWidth); // <combine
					  // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		LPCTSTR lpResourceType, LPCTSTR lpIDResourceNormal, LPCTSTR lpIDResourceDisabled,
		LPCTSTR lpIDResourceHot, LPCTSTR lpIDResourceChecked, LPCTSTR lpIDResourcePressed,
		UINT nIDCommand,
		UINT nWidth); // <combine
					  // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		HMODULE hModule, LPCTSTR lpResourceType, UINT nIDResourceNormal, UINT nIDResourceDisabled,
		UINT nIDResourceHot, UINT nIDResourceChecked, UINT nIDResourcePressed, UINT nIDCommand,
		UINT nWidth); // <combine
					  // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		HMODULE hModule, LPCTSTR lpResourceType, LPCTSTR lpIDResourceNormal,
		LPCTSTR lpIDResourceDisabled, LPCTSTR lpIDResourceHot, LPCTSTR lpIDResourceChecked,
		LPCTSTR lpIDResourcePressed, UINT nIDCommand,
		UINT nWidth); // <combine
					  // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		CXTPImageManagerVectorImageHandle hImageNormal,
		...
		UINT nWidth); // <combine
					  // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	BOOL SetVectorIcon(
		IStream* pStream, UINT nIDCommand, UINT nWidth,
		XTPImageState
			imageState); // <combine
						 // CXTPImageManager::SetVectorIcon@LPCTSTR@UINT@UINT@UINT@XTPImageState>
	...
	BOOL IsDrawReverted(CDC* pDC) const; // <combine CXTPImageManager::IsDrawReverted@const>
	...
	void DoPropExchange(
		UINT nCommand,
		CXTPPropExchange* pPX); // <combine CXTPImageManager::DoPropExchange@CXTPPropExchange*>
	...
	static COLORREF AFX_CDECL GetBitmapMaskColor(
		UINT nIDBitmap,
		CPoint pt = 0); // <combine CXTPImageManager::GetBitmapMaskColor@CBitmap&@CPoint>
	...
	static HBITMAP AFX_CDECL ResampleAlphaLayer(
		UINT nIDBitmap,
		COLORREF clrMask); // <combine CXTPImageManager::ResampleAlphaLayer@HBITMAP@COLORREF>
...
AFX_INLINE CSize CXTPImageManagerIcon::GetRecommendedExtent() const
{
	return m_szRecommendedExtent;
}
