...
{
	HRESULT _result = 0;
	_com_dispatch_method(this, DISPID_READYSTATECHANGE, DISPATCH_METHOD, VT_ERROR, (void*)&_result,
						 NULL);
	return _result;
}
...
inline HRESULT IXMLHttpRequest::open(_bstr_t bstrMethod, _bstr_t bstrUrl,
									 const _variant_t& varAsync, const _variant_t& bstrUser,
...
inline IXMLDOMNodePtr IXMLDOMNode::insertBefore(struct IXMLDOMNode* newChild,
...
inline IXMLDOMNodePtr IXMLDOMNode::replaceChild(struct IXMLDOMNode* newChild,
...
inline HRESULT IXMLDOMNode::transformNodeToObject(struct IXMLDOMNode* stylesheet,
...
inline IXMLDOMNodePtr IXMLDOMNamedNodeMap::removeQualifiedItem(_bstr_t baseName,
...
inline IXMLDOMProcessingInstructionPtr IXMLDOMDocument::createProcessingInstruction(_bstr_t target,
																					_bstr_t data)
{
...
inline IXMLDOMNodePtr IXMLDOMDocument::createNode(const _variant_t& type, _bstr_t name,
												  _bstr_t namespaceURI)
{
	struct IXMLDOMNode* _result = 0;
...
inline _bstr_t IXTLRuntime::formatDate(const _variant_t& varDate, _bstr_t bstrFormat,
									   const _variant_t& varDestLocale)
{
	BSTR _result = 0;
...
inline _bstr_t IXTLRuntime::formatTime(const _variant_t& varTime, _bstr_t bstrFormat,
									   const _variant_t& varDestLocale)
{
	BSTR _result = 0;
