...
//=========================================================================
// Summary:
//     CXTPDockingPaneTabPaintManager is a CXTPTabPaintManager derived
...
public:
	...
	//     the tabs.
	// Parameters:
	//     tabColor - An XTPTabColorStyle to apply to the tabs.
	// Returns:
	//     A pointer to the CXTPTabPaintManagerColorSet object applied.
	// See Also:
	//     XTPTabColorStyle, SetColorSet, GetColor, GetColorSet,
	...
	//     the tabs.
	// Parameters:
	//     tabAppearance - An XTPTabAppearanceStyle to apply to the tabs.
	// Returns:
	//     A pointer to the CXTPTabPaintManagerTheme object applied.
	// Remarks:
	//     Use SetAppearance to apply a "Built-In" theme. To apply a
	//     custom theme, use the SetAppearanceSet member.
	// See Also:
	//     XTPTabAppearanceStyle, SetAppearanceSet, GetAppearance,
...
//=========================================================================
// Summary:
//     CXTPDockingPanePanelPaintManager is a CXTPTabPaintManager derived
//     class that is used to store the color and appearance information
//     of the tabs in the tab manager.
//=========================================================================
...
enum XTPDockingPaneSplitterStyle
{
	...
	xtpPaneSplitterGripperOfficeXP   = 0x100, // Splitter has an Office XP gripper.
	xtpPaneSplitterGripperOffice2003 = 0x200  // Splitter has an Office 2003 gripper.
};
...
//===========================================================================
// Summary:
//     CXTPDockingPanePaintManager is a standalone class.
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get the pane's caption rectangle.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Override this member function to draw buttons for a tabbed caption.
	// Parameters:
	//     pDC         - Pointer to a valid device context.
	//     pButtons    - Pointer to a collection of buttons to draw.
	//     rcCaption   - Caption rectangle.
	//     clr         - Color of the buttons' text.
	//     nButtonSize - Size of the buttons.
	//     nButtonGap  - Distance between buttons.
	//     bVertical   - TRUE if the caption is drawn vertically.
	//-----------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Override this member function to draw a button for a tabbed caption.
	// Parameters:
	//     pDC       - Pointer to a valid device context.
	//     pButton   - Pointer to the button to draw.
	//     clrButton - Color of the button's text.
	//-------------------------------------------------------------------------
	...
	virtual void AdjustClientRect(
		CXTPDockingPaneTabbedContainer* pPane, CRect& rect,
		BOOL bApply); // <combine
					  // CXTPDockingPanePaintManager::AdjustClientRect@CXTPDockingPaneSidePanel*@CRect&>
	...
	virtual void
		AdjustCaptionRect(const CXTPDockingPaneTabbedContainer* pPane,
						  CRect& rc); // <combine
									  // CXTPDockingPanePaintManager::AdjustCaptionRect@const
									  // CXTPDockingPaneSidePanel*@CRect&>

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get a caption rectangle.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get a caption gripper for a tabbed container.
	// Parameters:
	//     pPane - Tabbed container to test.
	// Returns:
	//     Bounding rectangle of the gripper to set the size cursor.
	//-----------------------------------------------------------------------
...
public:
	...
	//     strTitle   - Text to draw in the caption.
	//     rc         - Client rectangle of the tabbed container.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the caption's font.
	// Parameters:
	//     pLogFont         - LOGFONT to be set for the caption.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the paint manager used to draw tabs of a
	//     tabbed container.
	// Parameters:
	//     pManager - New CXTPTabPaintManager pointer.
	// Returns:
	//     A pointer to the CXTPTabPaintManager that will be used.
	// See Also:
	//     GetTabPaintManager, SetPanelPaintManager
	//-----------------------------------------------------------------------
	CXTPTabPaintManager* SetTabPaintManager(CXTPTabPaintManager* pManager);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the paint manager used to draw tabs of an
	//     auto-hide panel.
	// Parameters:
	//     pManager - New CXTPTabPaintManager pointer.
	// Returns:
	//     A pointer to the CXTPTabPaintManager that will be used.
	// See Also:
	//     GetPanelPaintManager, SetTabPaintManager
	//-----------------------------------------------------------------------
	CXTPTabPaintManager* SetPanelPaintManager(CXTPTabPaintManager* pManager);

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the paint manager used to draw tabs of a tabbed container.
	// Returns:
	//     A pointer to the CXTPTabPaintManager used to draw tabs of a tabbed
	//     container.
	// See Also:
	//     SetTabPaintManager, GetPanelPaintManager
	//-----------------------------------------------------------------------
	CXTPTabPaintManager* GetTabPaintManager() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the paint manager used to draw tabs of an auto-hide panel.
	// Returns:
	//     A pointer to the CXTPTabPaintManager used to draw tabs of an
	//     auto-hide panel.
	// See Also:
	//     SetPanelPaintManager, GetTabPaintManager
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the colors for each element in an array to
	//     the colors in a specified color array.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the caption height of the tabbed container.
	// Returns:
	//     The caption height of the tabbed container.
	// See Also:
	//     GetTabsHeight
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get tabs height of the tabbed container.
	// Returns:
	//     The tabs height of the tabbed container.
	// See Also:
	//     GetCaptionHeight
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the splitter style.
	// Parameters:
	//     dwStyle - New style to be used for splitters.
	// Remarks:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get the splitter style.
	// Returns:
	//     The style used for splitters.
	// See Also:
	//     XTPDockingPaneSplitterStyle, SetSplitterStyle
	//-----------------------------------------------------------------------
	DWORD GetSplitterStyle() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the caption button style.
	// Parameters:
	//     nStyle - New style to be used for caption buttons.
	// Remarks:
	//     dwStyle parameter can be one or more of the following:
	...
	// See Also:
	//     XTPDockingPaneCaptionButtonStyle, GetCaptionButtonStyle
	//-----------------------------------------------------------------------
	void SetCaptionButtonStyle(XTPDockingPaneCaptionButtonStyle nStyle);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get the caption button style.
	// Returns:
	//     The style used for caption buttons.
	// See Also:
	//     XTPDockingPaneCaptionButtonStyle, SetCaptionButtonStyle
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//      pDC       - Pointer to the auto-hide pane's device context.
	...
	//     bDestroyOnCleanup    - If TRUE, then brushes will be destroyed on cleanup.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains the custom title brush.
	// Parameters:
	//     bActive   - Determines whether to obtain the active or inactive
	//                 title brush.
	//     bVertical - Determines whether to obtain the vertical or horizontal
	//                 title brush.
	// Returns:
	//     The custom title brush.
	//-----------------------------------------------------------------------
...
protected:
	...
	virtual void DrawCaptionButtonEntry(
		...
		COLORREF
			clrButton); // <combine
						// DrawCaptionButtonEntry@CDC*@CXTPDockingPaneCaptionButton*@COLORREF@CSize>
	...
	//     nAvailableWidth - Available width for drawing.
	// Remarks:
...
public:
	...
	CXTPPaintManagerColorGradient m_clrSplitterGradient; // Splitter gradient color.
...
protected:
	CXTPTabPaintManager* m_pTabPaintManager;   // Paint Manager used to draw tabs for a tabbed
											   // container.
	CXTPTabPaintManager* m_pPanelPaintManager; // Paint Manager used to draw tabs for an auto-hide
											   // panel.
	...
	BOOL m_bLunaTheme; // TRUE if luna colors are used.
