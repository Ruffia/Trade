...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the state color set
	//     for the caption button specified by pButton.
	// Parameters:
	//     pButton - Pointer to a CXTPDockingPaneCaptionButton object used
	//               to determine the correct color set to return.
	// Returns:
	//     A reference to a CXTPColorSetCaptionButton object representing
