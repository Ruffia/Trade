...
//===========================================================================
// Summary:
//     CXTPDockingPaneBaseContainer is a CXTPDockingPaneBase derived class.
//     It represents the parent class for all virtual containers.
//===========================================================================
...
public:
	...
	// Parameters:
	//     type  - Type of docking pane to search for within the container.
	...
	//     retrieval; it is NULL if the list is empty.
	// See Also:
	//     GetNext
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Gets the pane element identified by rPosition, then sets rPosition to
	//     the POSITION value of the next entry in the container. You can use GetNext
	//     in a forward iteration loop if you establish the initial position with
	//     a call to GetHeadPosition.
	// Parameters:
	//     pos - Specifies a reference to a POSITION value returned by a previous
	//           GetNext, GetHeadPosition, or other method call.
	// Returns:
	...
	// See Also:
	//     GetFirstPane, GetHeadPosition
	//-----------------------------------------------------------------------
	CXTPDockingPaneBase* GetLastPane() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to retrieve the collection of child panes.
	// Returns:
