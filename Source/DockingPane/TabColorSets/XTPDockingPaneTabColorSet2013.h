...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the color for the
	//     tab specified by pItem.
	// Parameters:
	//     pItem - Pointer to a valid CXTPTabManagerItem object.
	// Returns:
	//     An RGB color value representing the specified tab color.
	//-----------------------------------------------------------------------
	...
	// Remarks:
	//     This member must be overridden and takes care of filling
