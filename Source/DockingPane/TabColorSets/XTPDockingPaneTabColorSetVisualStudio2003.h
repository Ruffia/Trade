...
public:
	...
	// Parameters:
	//     bHighlightSelected - TRUE if the tab is selected.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member is used to paint the specified frame portion
	//     for a docking pane tab.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member is used to paint the specified header portion
	//     for a docking pane tab.
	// Parameters:
	//     pDC         - Pointer to a valid device context.
	//     rc          - Size of the area to draw.
	...
	// Remarks:
	//     This member is used to fill all tab buttons except when the
	//     XTPTabAppearanceStyle is xtpTabAppearanceStateButtons.
	//     xtpTabAppearanceStateButtons require the FillStateButton member.
	//
	//     Tab buttons will use CXTPTabPaintManagerColorSet::GradientFill to fill
	//     the buttons. The gradient will use the color of the tab item blended
	//     with RGB(255, 255, 255) to produce a "light color". The gradient will
