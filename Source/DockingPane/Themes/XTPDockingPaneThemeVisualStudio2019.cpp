// XTPDockingPaneThemeVisualStudio2019.cpp : implementation of the
// CXTPDockingPaneVisualStudio2019Theme class.
//
...
#include "DockingPane/ColorSets/XTPDockingPaneColorSet2019.h"
...
#include "DockingPane/TabThemes/XTPDockingPanePanelTheme2019.h"
...
#include "DockingPane/TabColorSets/XTPDockingPanePanelColorSet2019.h"
...
CXTPDockingPaneVisualStudio2019Theme::CXTPDockingPaneVisualStudio2019Theme()
{
	// Tab paint manager
	m_pTabPaintManager->SetAppearanceSet(new CXTPDockingPaneTabTheme2019());
	m_pTabPaintManager->SetColorSet(new CXTPDockingPaneTabColorSet2019());

	// Panel paint manager
	m_pPanelPaintManager->SetAppearanceSet(new CXTPDockingPanePanelTheme2019());
	m_pPanelPaintManager->SetColorSet(new CXTPDockingPanePanelColorSet2019());

	// Pane color sets
	SetPaneColorSets(new CXTPDockingPaneColorSet2019, new CXTPDockingPaneColorSet2019);
}
...
void CXTPDockingPaneVisualStudio2019Theme::RefreshMetrics()
{
...
void CXTPDockingPaneVisualStudio2019Theme::DrawSplitter(CDC* pDC,
...
void CXTPDockingPaneVisualStudio2019Theme::DrawTitleBar(CDC* pDC, CXTPDockingPaneBase* pPane,
...
void CXTPDockingPaneVisualStudio2019Theme::DrawAutoHidePanel(CDC* pDC, CRect rc,
