// XTPDockingPaneThemeVisualStudio2022.cpp : implementation of the
// CXTPDockingPaneVisualStudio2022Theme class.
//
...
#include "DockingPane/ColorSets/XTPDockingPaneColorSet2022.h"
...
#include "DockingPane/TabThemes/XTPDockingPanePanelTheme2022.h"
...
#include "DockingPane/TabColorSets/XTPDockingPanePanelColorSet2022.h"
...
CXTPDockingPaneVisualStudio2022Theme::CXTPDockingPaneVisualStudio2022Theme()
{
	// Tab paint manager
	m_pTabPaintManager->SetAppearanceSet(new CXTPDockingPaneTabTheme2022());
	m_pTabPaintManager->SetColorSet(new CXTPDockingPaneTabColorSet2022());

	// Panel paint manager
	m_pPanelPaintManager->SetAppearanceSet(new CXTPDockingPanePanelTheme2022());
	m_pPanelPaintManager->SetColorSet(new CXTPDockingPanePanelColorSet2022());

	// Pane color sets
	SetPaneColorSets(new CXTPDockingPaneColorSet2022, new CXTPDockingPaneColorSet2022);
}
...
void CXTPDockingPaneVisualStudio2022Theme::RefreshMetrics()
{
...
void CXTPDockingPaneVisualStudio2022Theme::DrawSplitter(CDC* pDC,
...
void CXTPDockingPaneVisualStudio2022Theme::DrawTitleBar(CDC* pDC, CXTPDockingPaneBase* pPane,
...
void CXTPDockingPaneVisualStudio2022Theme::DrawAutoHidePanel(CDC* pDC, CRect rc,
