// XTPDockingPaneThemeVisualStudio2005Beta1.cpp : implementation of the
// CXTPDockingPaneVisualStudio2005Beta1Theme class.
//
...
CXTPDockingPaneVisualStudio2005Beta1Theme::CXTPDockingPaneVisualStudio2005Beta1Theme()
{
	CAppearanceSetPropertyPageFlat* pAppearanceFlat = (CAppearanceSetPropertyPageFlat*)
														  m_pTabPaintManager->SetAppearance(
															  xtpTabAppearancePropertyPageFlat);
	...
	pAppearanceFlat = (CAppearanceSetPropertyPageFlat*)m_pPanelPaintManager->SetAppearance(
		xtpTabAppearancePropertyPageFlat);
	pAppearanceFlat->m_bBlurPoints = FALSE;
