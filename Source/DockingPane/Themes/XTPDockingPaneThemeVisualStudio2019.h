// XTPDockingPaneThemeVisualStudio2019.h
//
...
#if !defined(__XTPDOCKINGPANETHEMEVISUALSTUDIO2019_H__)
#	define __XTPDOCKINGPANETHEMEVISUALSTUDIO2019_H__
//}}AFX_CODEJOCK_PRIVATE
...
//=============================================================================
// Summary:
//     CXTPDockingPaneVisualStudio2019Theme is used to define drawing routines
//     specific to a Visual Studio 2019 docking pane theme.
//=============================================================================
class _XTP_EXT_CLASS CXTPDockingPaneVisualStudio2019Theme
	: public CXTPDockingPaneVisualStudio2012Theme
{
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPDockingPaneVisualStudio2019Theme object.
	//-------------------------------------------------------------------------
	CXTPDockingPaneVisualStudio2019Theme();

	//-------------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPDockingPaneVisualStudio2019Theme object, handles
	//     cleanup and deallocation.
	//-------------------------------------------------------------------------
	virtual ~CXTPDockingPaneVisualStudio2019Theme();
...
#endif // !defined(__XTPDOCKINGPANETHEMEVISUALSTUDIO2019_H__)
