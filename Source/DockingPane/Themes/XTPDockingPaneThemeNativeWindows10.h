// XTPDockingPaneThemeNativeWindows10.h
//
...
#if !defined(__XTPDOCKINGPANETHEMENATIVEWINDOWS10_H__)
#	define __XTPDOCKINGPANETHEMENATIVEWINDOWS10_H__
//}}AFX_CODEJOCK_PRIVATE
...
//=============================================================================
// Summary:
//     CXTPDockingPaneNativeWindows10Theme is used to define drawing routines
//     specific to a Native Windows 10 docking pane theme.
//=============================================================================
class _XTP_EXT_CLASS CXTPDockingPaneNativeWindows10Theme
	: public CXTPDockingPaneVisualStudio2012Theme
{
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPDockingPaneNativeWindows10Theme object.
	//-------------------------------------------------------------------------
	CXTPDockingPaneNativeWindows10Theme();

	//-------------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPDockingPaneNativeWindows10Theme object, handles
	//     cleanup and deallocation.
	//-------------------------------------------------------------------------
	virtual ~CXTPDockingPaneNativeWindows10Theme();
...
#endif // !defined(__XTPDOCKINGPANETHEMENATIVEWINDOWS10_H__)
