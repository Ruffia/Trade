// XTPDockingPaneThemeVisualStudio2017.cpp : implementation of the
// CXTPDockingPaneVisualStudio2017Theme class.
//
...
#include "DockingPane/ColorSets/XTPDockingPaneColorSet2017.h"
...
#include "DockingPane/TabThemes/XTPDockingPanePanelTheme2017.h"
...
#include "DockingPane/TabColorSets/XTPDockingPanePanelColorSet2017.h"
...
CXTPDockingPaneVisualStudio2017Theme::CXTPDockingPaneVisualStudio2017Theme()
{
	// Tab paint manager
	m_pTabPaintManager->SetAppearanceSet(new CXTPDockingPaneTabTheme2017());
	m_pTabPaintManager->SetColorSet(new CXTPDockingPaneTabColorSet2017());

	// Panel paint manager
	m_pPanelPaintManager->SetAppearanceSet(new CXTPDockingPanePanelTheme2017());
	m_pPanelPaintManager->SetColorSet(new CXTPDockingPanePanelColorSet2017());

	// Pane color sets
	SetPaneColorSets(new CXTPDockingPaneColorSet2017, new CXTPDockingPaneColorSet2017);
}
...
void CXTPDockingPaneVisualStudio2017Theme::RefreshMetrics()
{
...
void CXTPDockingPaneVisualStudio2017Theme::DrawSplitter(CDC* pDC,
...
void CXTPDockingPaneVisualStudio2017Theme::DrawTitleBar(CDC* pDC, CXTPDockingPaneBase* pPane,
...
void CXTPDockingPaneVisualStudio2017Theme::DrawAutoHidePanel(CDC* pDC, CRect rc,
