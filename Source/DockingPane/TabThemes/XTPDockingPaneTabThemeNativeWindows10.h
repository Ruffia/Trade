// XTPDockingPaneTabThemeNativeWindows10.h
//
...
#if !defined(__XTPDOCKINGPANETABTHEMENATIVEWINDOWS10_H__)
#	define __XTPDOCKINGPANETABTHEMENATIVEWINDOWS10_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
class _XTP_EXT_CLASS CXTPDockingPaneTabThemeNativeWindows10 : public CXTPDockingPaneTabTheme2012
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	...
	//-----------------------------------------------------------------------
	CXTPDockingPaneTabThemeNativeWindows10();
...
#endif // !defined(__XTPDOCKINGPANETABTHEMENATIVEWINDOWS10_H__)
