...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to expand a collapsed frame.
	//-----------------------------------------------------------------------
	void Expand();

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the top-level container of a floating frame.
	// Returns:
	//     A pointer to the top-level container of a floating frame.
	//-----------------------------------------------------------------------
	CXTPDockingPaneSplitterContainer* GetTopPane() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Determines if the frame is collapsed.
	//-----------------------------------------------------------------------
	BOOL IsCollapsed() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to collapse the frame.
	// Parameters:
	//     bDelay - TRUE to collapse the frame after a small delay with an animation.
	//-----------------------------------------------------------------------
...
protected:
	...
	// Parameters:
	//     pPane - Child pane that will be placed to the frame.
	//     rc    - Rectangle of the floating frame.
	//-----------------------------------------------------------------------
...
protected:
	...
	// Parameters:
	//     pPane - Pointer to a CXTPDockingPaneBase object to remove.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member is called by the framework when the mouse button is
	//     pressed on a caption button.
	// Parameters:
	...
	// Returns:
	//     A pointer to the currently selected pane.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     TRUE is themed floating panes are used, otherwise FALSE.
	//-----------------------------------------------------------------------
	BOOL IsThemed() const;
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to get the min/max information for the pane window.
	// Parameters:
	//     pMinMaxInfo - LPMINMAXINFO to fill with the min/max information.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to animate a collapsed frame.
	// Parameters:
	//     bActivate - TRUE to activate the frame.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member is called to update the opacity of a floating frame.
	// See Also:
	//     CXTPDockingPaneManager::SetFloatingFramesOpacity
	//-----------------------------------------------------------------------
	virtual void UpdateWindowOpacity();

	//-------------------------------------------------------------------------
	// Summary:
	//     This method is called when focus is changed inside the application.
	//-------------------------------------------------------------------------
	void OnFocusChanged();
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called if some action occurs.
	// Parameters:
	//     action - Docking pane action.
	// Returns:
	//     TRUE if the action was canceled.
	//-----------------------------------------------------------------------
...
protected:
	...
	int m_nSlideStep;		  // Current step of the animation process.
	int m_nDeactivationCount; // Deactivation counter.

	BOOL m_bCollapsed; // Pane is collapsed.
	BOOL m_bExpanded;  // Pane is expanded.
	BOOL m_bSlideOut;  // Pane is currently expanding.

	BOOL m_bDelayInvalidate; // TRUE to redraw the frame after a small delay.
