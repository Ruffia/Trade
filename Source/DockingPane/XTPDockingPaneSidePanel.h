...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves a CXTPDockingPaneTabbedContainer object that points to the
	//     parent container for this container.
	// Returns:
	//     A CXTPDockingPaneTabbedContainer object that points to the parent
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine the direction of the
	//     auto-hide panel.
	// Returns:
	//     The auto-hide panel's direction.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A pointer to the currently selected pane in the side panel.
	//-----------------------------------------------------------------------
...
public:
	...
	// Returns:
	//     TRUE if the frame is collapsed, FALSE if the frame is visible.
	//-----------------------------------------------------------------------
	...
	//     rect      - Position of the side panel.
	//-----------------------------------------------------------------------
...
protected:
	...
	// Parameters:
	//     pClone           - Pointer to a CXTPDockingPaneSidePanel object.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to insert a pane into the collection.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to determine if the side panel orientation
	//     is horizontal.
	// Returns:
	//     TRUE if the side panel orientation is horizontal, otherwise FALSE.
	//-----------------------------------------------------------------------
