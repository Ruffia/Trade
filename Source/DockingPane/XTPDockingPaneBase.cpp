...
void CXTPDockingPaneBase::Copy(CXTPDockingPaneBase* pClone, CXTPPaneToPaneMap* /*pMap*/,
							   DWORD /*dwIgnoredOptions*/)
{
	m_szDocking = pClone->m_szDocking;
}

CXTPDockingPaneBase* CXTPDockingPaneBase::Clone(CXTPDockingPaneLayout* pLayout,
...
BEGIN_DISPATCH_MAP(CXTPDockingPaneClientContainer, CXTPCmdTarget)
	...
	DISP_FUNCTION_ID(CXTPDockingPaneClientContainer, "Pane", DISPID_VALUE, OleGetPane, VT_DISPATCH,
					 VTS_I4)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneClientContainer, "ParentContainer", 20, OleGetContainer,
						SetNotSupported, VT_DISPATCH)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneClientContainer, "Type", 21, OleGetType, SetNotSupported,
						VT_I4)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneClientContainer, "hWnd", DISPID_HWND, OleGetHwnd,
						SetNotSupported, VT_HANDLE)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneClientContainer, "IsEmpty", 22, OleIsEmpty, SetNotSupported,
						VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPDockingPaneClientContainer, "Position", 23, OleGetPosition,
