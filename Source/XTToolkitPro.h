...
#	if defined(_XTP_INCLUDE_GRIDCONTROL)
#		pragma message(                                                                           \
			"Including GridControl  (Use _XTP_EXCLUDE_GRIDCONTROL  to exclude from build)")
#		include "GridControl/Includes.h"
#	endif
...
#		if defined(_XTP_INCLUDE_TABMANAGER) && defined(_XTP_INCLUDE_CONTROLS)                     \
...
#		define _XTPLIB_VISUALSTUDIO_VERSION "vc170"
#	elif
...
#		pragma comment(lib, "ToolkitPro" _XTPLIB_PROJECT_EVAL _XTPLIB_FILE_VERSION                \
								 _XTPLIB_VISUALSTUDIO_VERSION _XTPLIB_PLATFORM                     \
									 _XTPLIB_PROJECT_CONFIGURATION ".lib")
#		pragma message(                                                                           \
			"Automatically linking with ToolkitPro" _XTPLIB_PROJECT_EVAL _XTPLIB_FILE_VERSION      \
