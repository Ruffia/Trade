// XTPShortcutBarVisualStudio2017Theme.h
//
...
#if !defined(__XTPSHORTCUTBARVISUALSTUDIO2017THEME_H__)
#	define __XTPSHORTCUTBARVISUALSTUDIO2017THEME_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//     CXTPShortcutBarVisualStudio2017Theme is a CXTPShortcutBarOffice2013Theme
//     derived class that represents a Visual Studio 2017 shortcut bar theme.
//===========================================================================
class _XTP_EXT_CLASS CXTPShortcutBarVisualStudio2017Theme : public CXTPShortcutBarOffice2013Theme
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPShortcutBarVisualStudio2017Theme object.
	//-----------------------------------------------------------------------
	CXTPShortcutBarVisualStudio2017Theme();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPShortcutBarVisualStudio2017Theme object,
	//     handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPShortcutBarVisualStudio2017Theme();
...
#endif // !defined(__XTPSHORTCUTBARVISUALSTUDIO2017THEME_H__)
