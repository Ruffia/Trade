// XTPShortcutBarNativeWindows10Theme.h
//
...
#if !defined(__XTPSHORTCUTBARNATIVEWINDOWS10THEME_H__)
#	define __XTPSHORTCUTBARNATIVEWINDOWS10THEME_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//     CXTPShortcutBarNativeWindows10Theme is a CXTPShortcutBarOffice2013Theme
//     derived class that represents a Native Windows 10 shortcut bar theme.
//===========================================================================
class _XTP_EXT_CLASS CXTPShortcutBarNativeWindows10Theme : public CXTPShortcutBarOffice2013Theme
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPShortcutBarNativeWindows10Theme object.
	//-----------------------------------------------------------------------
	CXTPShortcutBarNativeWindows10Theme();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPShortcutBarNativeWindows10Theme object,
	//     handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPShortcutBarNativeWindows10Theme();
...
#endif // !defined(__XTPSHORTCUTBARNATIVEWINDOWS10THEME_H__)
