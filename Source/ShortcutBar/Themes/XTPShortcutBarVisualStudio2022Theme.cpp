// XTPShortcutBarVisualStudio2022Theme.cpp
//
...
//////////////////////////////////////////////////////////////////////////
// CXTPShortcutBarVisualStudio2022Theme

CXTPShortcutBarVisualStudio2022Theme::CXTPShortcutBarVisualStudio2022Theme()
{
	EnableOfficeFont();
}
...
void CXTPShortcutBarVisualStudio2022Theme::RefreshMetrics()
{
...
void CXTPShortcutBarVisualStudio2022Theme::DrawHiliteBorder(CDC* pDC, CRect rc)
{
	if (m_bHiliteBorders)
	{
...
void CXTPShortcutBarVisualStudio2022Theme::DrawPaneCaptionMinimizeButton(CDC* pDC,
...
int CXTPShortcutBarVisualStudio2022Theme::DrawPaneItemCaption(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2022Theme::FillShortcutItemEntry(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2022Theme::FillNavigationItemEntry(CDC* pDC,
																   CXTPShortcutBarItem* pItem)
{
	CRect rc = pItem->GetItemRect();
