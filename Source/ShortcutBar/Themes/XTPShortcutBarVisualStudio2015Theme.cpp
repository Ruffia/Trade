...
void CXTPShortcutBarVisualStudio2015Theme::DrawPaneCaptionMinimizeButton(CDC* pDC,
...
int CXTPShortcutBarVisualStudio2015Theme::DrawPaneItemCaption(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2015Theme::FillShortcutItemEntry(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2015Theme::FillNavigationItemEntry(CDC* pDC,
																   CXTPShortcutBarItem* pItem)
{
	CRect rc = pItem->GetItemRect();
