// XTPShortcutBarVisualStudio2019Theme.cpp
//
...
CXTPShortcutBarVisualStudio2019Theme::CXTPShortcutBarVisualStudio2019Theme()
{
	EnableOfficeFont();
}
...
void CXTPShortcutBarVisualStudio2019Theme::RefreshMetrics()
{
...
void CXTPShortcutBarVisualStudio2019Theme::DrawHiliteBorder(CDC* pDC, CRect rc)
{
	if (m_bHiliteBorders)
	{
...
void CXTPShortcutBarVisualStudio2019Theme::DrawPaneCaptionMinimizeButton(CDC* pDC,
...
int CXTPShortcutBarVisualStudio2019Theme::DrawPaneItemCaption(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2019Theme::FillShortcutItemEntry(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2019Theme::FillNavigationItemEntry(CDC* pDC,
																   CXTPShortcutBarItem* pItem)
{
	CRect rc = pItem->GetItemRect();
