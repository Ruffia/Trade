// XTPShortcutBarVisualStudio2017Theme.cpp
//
...
//////////////////////////////////////////////////////////////////////////
// CXTPShortcutBarVisualStudio2017Theme

CXTPShortcutBarVisualStudio2017Theme::CXTPShortcutBarVisualStudio2017Theme()
{
	EnableOfficeFont();
}
...
void CXTPShortcutBarVisualStudio2017Theme::RefreshMetrics()
{
...
void CXTPShortcutBarVisualStudio2017Theme::DrawHiliteBorder(CDC* pDC, CRect rc)
{
	if (m_bHiliteBorders)
	{
...
void CXTPShortcutBarVisualStudio2017Theme::DrawPaneCaptionMinimizeButton(CDC* pDC,
...
int CXTPShortcutBarVisualStudio2017Theme::DrawPaneItemCaption(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2017Theme::FillShortcutItemEntry(CDC* pDC,
...
void CXTPShortcutBarVisualStudio2017Theme::FillNavigationItemEntry(CDC* pDC,
																   CXTPShortcutBarItem* pItem)
{
	CRect rc = pItem->GetItemRect();
