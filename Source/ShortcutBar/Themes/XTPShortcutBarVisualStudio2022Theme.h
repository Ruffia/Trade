// XTPShortcutBarVisualStudio2022Theme.h
//
...
#if !defined(__XTPSHORTCUTBARVISUALSTUDIO2022THEME_H__)
#	define __XTPSHORTCUTBARVISUALSTUDIO2022THEME_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//     CXTPShortcutBarVisualStudio2022Theme is a CXTPShortcutBarOffice2013Theme
//     derived class that represents a Visual Studio 2022 shortcut bar theme.
//===========================================================================
class _XTP_EXT_CLASS CXTPShortcutBarVisualStudio2022Theme : public CXTPShortcutBarOffice2013Theme
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPShortcutBarVisualStudio2022Theme object.
	//-----------------------------------------------------------------------
	CXTPShortcutBarVisualStudio2022Theme();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPShortcutBarVisualStudio2022Theme object,
	//     handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPShortcutBarVisualStudio2022Theme();
...
#endif // !defined(__XTPSHORTCUTBARVISUALSTUDIO2022THEME_H__)
