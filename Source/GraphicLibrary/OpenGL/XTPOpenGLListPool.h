...
//===========================================================================
// Summary:
//     Provides a convenient API around an OpenGL list for reliable
//     list management.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Allocates an OpenGL list. Once allocated, the list must be
	//     committed using the CommitList method after being populated.
	// Parameters:
	//     mode - List compilation flags, can be either GL_COMPILE
	//            or GL_COMPILE_AND_EXECUTE.
	// Returns: 
	//     The OpenGL list identifier if successful, otherwise 0. 
	// See also:
...
//===========================================================================
// Summary:
//     Provides access to the global instance of an OpenGL list pool object.
// Returns:
//     A pointer to the global instance of an OpenGL list pool object.
//===========================================================================
