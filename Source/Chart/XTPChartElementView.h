...
public:
	...
	//     bAddToParent - If TRUE, then the view will be added to parent's child elements.
...
public:
	...
	//     with this view.
	// Returns:
	//     An integer specifying the number of children.
	//-----------------------------------------------------------------------
	int GetCount() const;
	...
	//     Derived class objects will return more specific device command objects
	//     according to their type.
	// Remarks:
	//     This is a virtual function, so sub-classes can override this function
	//     and can give specific implementations according to their type.
	//-------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Provides access to the collection of children elements
	//      owned by the view.
	// Returns:
	//      A pointer to the first element in the collection. The total number
	//      of elements can be determined by use GetCount method.
	// See also:
	//      GetCount
	//-----------------------------------------------------------------------
