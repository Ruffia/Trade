...
public:
	...
	//     pParentView - The pointer to the parent view object.
	//-----------------------------------------------------------------------
	CXTPChartRangeAreaSeriesLabelView(CXTPChartSeriesLabel* pLabel,
									  CXTPChartSeriesPointView* pPointView,
									  CXTPChartElementView* pParentView);
	...
	//-----------------------------------------------------------------------
	using CXTPChartPointSeriesLabelView::GetAnchorPoint;

	virtual CXTPChartPointF GetAnchorPoint(BOOL bMinValue) const;

protected:
	using CXTPChartPointSeriesLabelView::CreateDeviceCommand;
