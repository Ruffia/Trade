...
//===========================================================================
// Summary:
//     CXTPChartRangeSplineAreaSeriesStyle is a CXTPChartAreaSeriesStyle derived class which
//     represents the area series style.
// Remarks:
...
public:
	...
	//     pDiagramView - Pointer to a chart diagram view object.
	//-----------------------------------------------------------------------
	CXTPChartRangeSplineAreaSeriesView(CXTPChartSeries* pSeries,
									   CXTPChartDiagramView* pDiagramView);
...
public:
	...
	//-----------------------------------------------------------------------
	CXTPChartRangeSplineAreaSeriesPointView(CXTPChartSeriesPoint* pPoint,
											CXTPChartElementView* pParentView);
