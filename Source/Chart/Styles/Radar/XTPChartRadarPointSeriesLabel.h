...
public:
	...
	// Returns:
	//     An intger value denoting the angle of the label stem.
	//-----------------------------------------------------------------------
	int GetAngle() const;

protected:
	CXTPChartElementView* CreateView(CXTPChartDeviceContext* pDC,
...
public:
	...
	// Parameters:
	//     pLabel - The pointer to the chart series label object.
	//     pPointView - A pointer to the chart series view.
	//-----------------------------------------------------------------------
	CXTPChartRadarPointSeriesLabelView(CXTPChartSeriesLabel* pLabel,
									   CXTPChartSeriesPointView* pPointView,
									   CXTPChartElementView* pParentView);
	...
	//     ptAnchorPoint - Anchor point.
	//     dAnchorAngle  - Anchor angle.
	//     text          - Text.
	// Returns:
	...
	virtual CXTPChartDeviceCommand* CreateDeviceCommand(
		CXTPChartDeviceContext* pDC, const CXTPChartPointF& ptAnchorPoint, double dAnchorAngle,
		const CXTPChartString&
			text); // <combine
				   // CXTPChartRadarPointSeriesLabelView::CreateDeviceCommand@CXTPChartDeviceContext*>
	...
	void CalculateLayout(CXTPChartDeviceContext* pDC, const CXTPChartPointF& ptAnchorPoint,
						 double dAnchorAngle, const CXTPChartString& text);
