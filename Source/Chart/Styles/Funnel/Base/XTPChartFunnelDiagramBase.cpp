...
void CXTPChartFunnelDiagramBaseImpl::CalculateSeriesLayout(CXTPChartDeviceContext* pDC,
														   CXTPChartDiagramView* pView)
{
	...
	{
		CXTPChartFunnelSeriesViewBase* pSeriesView = static_cast<CXTPChartFunnelSeriesViewBase*>(
			pView->GetSeriesView()->GetAt(i));
