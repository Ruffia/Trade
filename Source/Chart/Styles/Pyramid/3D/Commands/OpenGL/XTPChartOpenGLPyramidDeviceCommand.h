...
private:
	void DrawTriangle(CXTPChartOpenGLDeviceContext& dc, const CXTPPoint3d& a, const CXTPPoint3d& va,
					  const CXTPPoint3d& b, const CXTPPoint3d& vb, const CXTPPoint3d& c,
					  const CXTPPoint3d& vc);
	void DrawPyramidSlice(CXTPChartOpenGLDeviceContext& dc);

	void ComputeConnectorPoints(CXTPChartOpenGLDeviceContext& dc);
