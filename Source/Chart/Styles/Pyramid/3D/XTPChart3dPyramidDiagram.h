...
#if !defined(__XTPCHART3DPYRAMIDDIAGRAM_H__)
#	define __XTPCHART3DPYRAMIDDIAGRAM_H__
//}}AFX_CODEJOCK_PRIVATE
...
//     CXTPChartDiagram.
//===========================================================================
class _XTP_EXT_CLASS CXTPChart3dPyramidDiagram : public CXTPChart3dPyramidDiagramBase
{
	DECLARE_SERIAL(CXTPChart3dPyramidDiagram);

public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPChart3dPyramidDiagram object.
	//-----------------------------------------------------------------------
...
public:
	...
	DECLARE_OLETYPELIB_EX(CXTPChart3dPyramidDiagram);
	DECLARE_OLECREATE_EX(CXTPChart3dPyramidDiagram)
	//}}AFX_CODEJOCK_PRIVATE
#	endif
};

#	include "Common/Base/Diagnostic/XTPEnableNoisyWarnings.h"
#endif //#if !defined(__XTPCHART3DPYRAMIDDIAGRAM_H__)
