// XTPChart2dPyramidDiagramView.h
//
...
#if !defined(__XTPCHART2DPYRAMIDDIAGRAMVIEW_H__)
#	define __XTPCHART2DPYRAMIDDIAGRAMVIEW_H__
//}}AFX_CODEJOCK_PRIVATE
...
{
	DECLARE_DYNAMIC(CXTPChartPyramidDiagramView);
...
public:
	...
	// Parameters:
	//     pDiagram - A pointer to the pyramid diagram object.
...
#endif //#if !defined(__XTPCHART2DPYRAMIDDIAGRAMVIEW_H__)
