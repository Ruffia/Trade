...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPChartPyramidSeriesStyleBase object, handles cleanup.
	//-------------------------------------------------------------------------
	...
	//     looks more stretched towards its cone or if it has a wider base.
	...
	// Returns:
	//     Returns the pointer to a CXTPChartFillStyle object, which abstracts
	//     various fill styles.
	//-------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Obtains the border object pointer.
	// Returns:
