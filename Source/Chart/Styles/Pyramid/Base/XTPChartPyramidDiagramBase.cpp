// XTPChartPyramidDiagramBase.cpp
//
...
void CXTPChartPyramidDiagramBaseImpl::CalculateSeriesLayout(CXTPChartDeviceContext* pDC,
															CXTPChartDiagramView* pView)
{
	...
	{
		CXTPChartPyramidSeriesViewBase* pSeriesView =
			(CXTPChartPyramidSeriesViewBase*)pView->GetSeriesView()->GetAt(i);
