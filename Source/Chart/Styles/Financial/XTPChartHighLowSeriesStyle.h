...
//===========================================================================
// Summary:
//     This class represents the stock series style in the chart. Objects
//     of this class are a kind of series style of a chart.
// Remarks:
...
public:
	...
	// Returns:
	//     An integer value for the thickness of the tick lines currently used.
	//-----------------------------------------------------------------------
...
public:
	...
	// Returns:
	//     An CXTPChartColor object representing a 32 bit ARGB value.
	//-----------------------------------------------------------------------
...
protected:
	...
	// Returns:
	//     A pointer to a CXTPChartHighLowSeriesView object, which is a kind of
	//     CXTPChartSeriesView.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     This class abstracts the view of the stock series of the chart. Objects
//     of this class are a kind of series view object of a chart.
// Remarks:
//     Stock charts are used primarily to describe price movements of a security
//     (finance), derivative, or currency over time.
//===========================================================================
...
public:
	...
	//     pDiagramView - A pointer to a chart diagram view object.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to create a stock series point view object.
	// Parameters:
	//     pDC    - A pointer to a chart device context.
	//     pPoint - A pointer to a chart series point object.
	// Returns:
	//     A pointer to a stock chart series point view object.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     This class abstracts the view of the stock series point of the chart. Objects
//     of this class are a kind of series point view object of a chart.
// Remarks:
//     Stock charts are used primarily to describe price movements of a security
//     (finance), derivative, or currency over time.
//===========================================================================
