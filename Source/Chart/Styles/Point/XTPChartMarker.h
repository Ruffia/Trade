...
public:
	...
	// Parameters:
	//     pOwner - A pointer to the chart series style object which owns this object.
	//-----------------------------------------------------------------------
...
public:
	...
	virtual CXTPChartDeviceCommand* CreateDeviceCommand(CXTPChartDeviceContext* pDC,
														...
														CXTPChartColor color, CXTPChartColor color2,
	...
	//-------------------------------------------------------------------------
	virtual CXTPChartDeviceCommand* CreateDeviceCommand(CXTPChartDeviceContext* pDC,
														const CXTPChartPointF& point, int nWidth,
														CXTPChartColor color, CXTPChartColor color2,
														CXTPChartColor colorBorder);
...
protected:
	...
	BOOL m_bVisible; // TRUE if the marker is visible and FALSE if the marker is invisible.
