...
//===========================================================================
// Summary:
//     This enumeration tells the various positions available for the pie label.
//===========================================================================
...
public:
	...
	// Returns:
	//     A pie label position object describing the position of the pie label.
	//-------------------------------------------------------------------------
	...
	// Returns:
	//     A pointer to a CXTPChartPieSeriesStyleBase object.
	//-------------------------------------------------------------------------
...
public:
	...
	// Returns:
	//     Returns TRUE if the label is inside the pie, FALSE otherwise.
	//-------------------------------------------------------------------------
	BOOL IsInside() const;
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//      Constructs a CXTPChartPieSeriesLabelViewBase object.
	// Parameters:
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//      Constructs a CXTPChartPieSeriesLabelsViewBase object.
	// Parameters:
	//      pParentView - Parent view pointer.
	//-----------------------------------------------------------------------
