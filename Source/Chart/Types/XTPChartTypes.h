...
public:
	...
	// Returns:
	//     An ARGB value specifying the color.
	//-----------------------------------------------------------------------
	ARGB GetValue() const
	{
		return Argb;
	...
	// Parameters:
	//     argb - An ARGB value specifying the color.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A BOOL value. TRUE if the object is empty, FALSE otherwise.
	//-----------------------------------------------------------------------
	BOOL IsEmpty() const
	{
		return Argb == Empty;
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to do the cleanup.
	//-----------------------------------------------------------------------
	void Release();
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a rotation object with no rotation by default.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a rotation object with the provided rotation parameters.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Checks if any rotation is applied.
	// Returns:
	//     A BOOL value. TRUE if any rotation is applied, FALSE otherwise.
	//-----------------------------------------------------------------------
	BOOL IsRotated() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Reads rotation angle value from a string provided.
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a copy of a provided 3D box.
	// Parameters:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Determines if a box is valid, e.i. minimal points are less than or equal
	//     to maximal points.
	// Returns:
	//     A BOOL value. TRUE if a box is valid, FALSE otherwise.
	//-----------------------------------------------------------------------
	BOOL IsValid() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Includes a point into the box. If the point exceeds any box side
	//     then the box size gets increased.
	// Parameters:
	//     pt - A point to include into the box.
	//     bCenterCandidate - If TRUE, the point is considered a center candidate
	//                        when GetCenter is called for center candidates.
	// See also:
	//     GetCenter
	//-----------------------------------------------------------------------
	...
	//     then the center of the box is computed as a medium point between
	//     the minimal and maximal points. Otherwise the closest to the physical
	//     box center point added with CentedCandidate = TRUE is returned.
	// Parameters:
	//     bAmongstCenterCandidates - If TRUE, only center candidate points
	//                                are considered and the closest one to
	//                                the physical center is returned.
	// Returns:
	//     A center box point.
	// See also:
	//     Include
	...
	//          the far box face along the Z axis. The next 4 points represent
	//          the close box face along the Z axis.
	//-----------------------------------------------------------------------
