...
{
	xtpChartAxisNear, // For Y axis, near means left side of the chart. For X axis it is the bottom
					  // side of the chart.
	xtpChartAxisFar // For Y axis, far means right side of the chart. For X axis it is the top side
					// of the chart.
};
...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Gets/sets the color of the axis.
	// Parameters:
	...
	CXTPChartColor GetColor() const;			// <combine CXTPChartAxis::GetActualColor>
	void SetColor(const CXTPChartColor& color); // <combine CXTPChartAxis::GetActualColor>

	//-------------------------------------------------------------------------
	// Summary:
	//     Gets/sets the first interlaced strips color of the axis.
	// Parameters:
	//     color - Color to be set.
	// Returns:
	//     Returns the pointer to CXTPChartColor object, which give ARGB color value.
	...
	CXTPChartColor GetActualInterlacedColor() const; // <combine CXTPChartAxis::GetInterlacedColor>
	void SetInterlacedColor(const CXTPChartColor& color); // <combine
														  // CXTPChartAxis::GetInterlacedColor>

	//-------------------------------------------------------------------------
	// Summary:
	//     Gets/sets the second interlaced strips color of the axis.
	// Parameters:
	//     color - Color to be set.
	// Returns:
	//     Returns the pointer to CXTPChartColor object, which give ARGB color value.
	...
	CXTPChartColor GetActualInterlacedColor2() const;	  // <combine
														   // CXTPChartAxis::GetInterlacedColor2>
	void SetInterlacedColor2(const CXTPChartColor& color); // <combine
														   // CXTPChartAxis::GetInterlacedColor2>
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Use this function to set the space between grid lines.
	// Parameters:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Use this function to get the space between grid lines.
	// Returns:
...
protected:
	...
	BOOL m_bReversed;  // FALSE if the axis valus are in natural order, TRUE if it is in reverse
					   // order.
	...
	BOOL m_bGridSpacingAuto; // TURE if automatic spaceing of grid lines selected.FALSE for specific
							 // values.
	BOOL m_bAllowZoom;
...
//===========================================================================
// Summary:
//     CXTPChartAxisX is a derived class from the CXTPChartAxis class
...
//===========================================================================.
// Summary:
//     CXTPChartAxisY is a derived class from the CXTPChartAxis class
