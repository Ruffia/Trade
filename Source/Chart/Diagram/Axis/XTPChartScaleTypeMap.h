...
//===========================================================================
// Summary:
//     This class abstracts a scale type map. It acts as an abstract base for
//     various specialized scale type classes.
//===========================================================================
...
public:
	...
	//     associated with.
	// Returns:
	//     A pointer to a chart axis object.
	//-------------------------------------------------------------------------
	CXTPChartAxis* GetAxis() const;

	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function when there is a change in the values of the series or
	//     a change in the scale.
	// Parameters:
	//     pAxisView - Pointer to a CXTPChartAxisView object.
	//     pSeries   - Pointer to a CXTPChartSeries object.
	//     pPoint    - Pointer to a CXTPChartSeriesPoint object.
	//-------------------------------------------------------------------------
	virtual void UpdateSeries(CXTPChartAxisView* pAxisView);
	virtual void UpdateSeries(
		CXTPChartSeries* pSeries); // <combine
								   // CXTPChartScaleTypeMap::UpdateSeries@CXTPChartAxisView*>
	virtual void UpdateSeriesPointArgument(
		CXTPChartSeriesPoint* pPoint); // <combine
									   // CXTPChartScaleTypeMap::UpdateSeries@CXTPChartAxisView*>

	//-------------------------------------------------------------------------
	// Summary:
	//     Use this function to convert a double value to a string. This actually
	//     converts the internal representation of data to a more meaningful value.
	// Returns:
	//     A CXTPChartString object representing the string value.
	//-------------------------------------------------------------------------
	virtual CXTPChartString InternalToValue(CXTPChartNumberFormat* pFromat,
											double dValue) const = 0;
...
public:
	...
	// Parameters:
	//     pAxis - A pointer to a chart axis object.
	// Remarks:
...
//     is specialized into an array of strings.
//===========================================================================
...
//===========================================================================
// Summary:
//     This class abstracts a scale type map, which represents qualitative values.
...
public:
	...
	using CXTPChartScaleTypeMap::UpdateSeries;
...
protected:
	...
	int FillNextsList(CXTPChartSeries* pSeries, int i, CXTPChartStrings& nexts,
