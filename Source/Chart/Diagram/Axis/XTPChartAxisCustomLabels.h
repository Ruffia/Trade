...
//===========================================================================
// Summary:
//     CXTPChartAxisCustomLabel is a CXTPChartElement derived class.
...
public:
	...
	double GetAxisValueInternal() const; // <combine CXTPChartAxisCustomLabel::GetAxisValue>
	...
	void SetAxisValue(double dValue); // <combine CXTPChartAxisCustomLabel::SetAxisValue@LPCTSTR>

public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to Store/Load the label properties using the specified data
	//     object.
	// Parameters:
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     This function adds a new custom label to the collection of labels.
	// Parameters:
	...
	// Returns:
	//     The pointer to the CXTPChartAxisCustomLabel object at the index selected.
	//-----------------------------------------------------------------------
...
AFX_INLINE CXTPChartAxisCustomLabel* CXTPChartAxisCustomLabels::GetAt(int nIndex) const
{
	return nIndex >= 0 && nIndex < m_arrElements.GetSize()
			   ? (CXTPChartAxisCustomLabel*)m_arrElements.GetAt(nIndex)
			   : NULL;
}
