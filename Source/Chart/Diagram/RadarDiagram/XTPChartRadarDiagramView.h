...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to get the view for an axis object.
	// Parameters:
	//     pAxis - A pointer to the axis object whose view is to be returned.
	// Returns:
	//     The view for the specified axis object.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Use this function to add an axis view to the diagram view boundary.
	// Parameters:
	//     pDC          - A pointer to the chart device context.
	...
	//                    added.
	//-----------------------------------------------------------------------
	CXTPChartRadarAxisView* AddAxisView(CXTPChartDeviceContext* pDC,
										CXTPChartElementView* pParentView, CXTPChartAxis* pAxis);

public:
	virtual CXTPChartDeviceCommand* CreatePolygonStripDeviceCommand(
	...
	virtual CXTPChartDeviceCommand* CreatePolygonLineDeviceCommand(CXTPChartDeviceContext* /*pDC*/,
																   double dRadius,
