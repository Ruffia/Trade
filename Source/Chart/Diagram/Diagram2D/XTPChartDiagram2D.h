...
public:
	...
	// Returns:
	//     A pointer to a CXTPChartAxis object. The specific type is CXTPChartAxisX.
	//-------------------------------------------------------------------------
	...
	// Returns:
	//     A pointer to a CXTPChartAxis object. The specific type is CXTPChartAxisY.
	//-------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Gets/sets the pane to which this object is associated with.
	// Parameters:
	//     pPane - Pointer to a CXTPChartDiagram2DPane object.
	// Returns:
	//     A pointer to a CXTPChartDiagram2DPane object.
	//-------------------------------------------------------------------------
	CXTPChartDiagram2DPane* GetPane() const;
	void SetPane(CXTPChartDiagram2DPane* pPane); // <combine CXTPChartDiagram2D::GetPane>

	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function to get the diagram appearance object associated
	//     with this object.
	// Returns:
	//     A pointer to a CXTPChartDiagram2DAppearance object.
	//-------------------------------------------------------------------------
...
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function to create the view of a 2D diagram object.
	// Parameters:
	//     pDC     - A pointer to a chart device context object.
...
protected:
	...
	// Parameters:
	//     pDC      - A pointer to a chart device context object.
	//     pView    - A pointer to the associated diagram view object.
