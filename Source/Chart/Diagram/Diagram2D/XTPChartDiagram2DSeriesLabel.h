...
public:
	...
	// Parameters:
	//     pLabel - The pointer to a chart series label object.
	//     pPointView - A pointer to a chart series view.
	//-----------------------------------------------------------------------
	CXTPChartDiagram2DSeriesLabelView(CXTPChartSeriesLabel* pLabel,
	...
	virtual CXTPChartDeviceCommand* CreateDeviceCommand(
		...
		CXTPChartPointF
			ptCenterPoint); // <combine
							// CXTPChartDiagram2DSeriesLabelView::CreateDeviceCommand@CXTPChartDeviceContext*>
	virtual CXTPChartDeviceCommand* CreateDeviceCommand(
