...
//===========================================================================
// Summary:
//     This class helper is used to format number to string.
//===========================================================================
...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this method to set a new pattern.
	// Parameters:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this method to specify format category of double value (Number, Currency, Percent,
	//     Scientific, etc.).
	// Parameters:
	...
	// Parameters:
	//     nDecimalPlaces - Non-negative number specified number of digits after decimal points, or
	//                      -1 to use locale value.
	//-------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this method to set a new currency symbol for the xtpChartCurrency category.
	// Parameters:
...
protected:
	CString m_strPattern;					  // Format pattern
