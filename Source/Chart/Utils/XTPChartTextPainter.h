...
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPChartTextPainterBase object, handles cleanup.
	//-------------------------------------------------------------------------
...
protected:
	...
	//     to this function within derived classes.
	//-------------------------------------------------------------------------
...
public:
	...
	// Returns:
	//     An enumerated value, XTPChartTextRotation specifies the text rotation type.
	// Remarks:
	//     This is a pure virtual function, so give meaningful implementation
	//     to this function within derived classes.
	//-------------------------------------------------------------------------
