...
void CXTPChartDrawThread::DrawContent()
{
	...
	{
		CXTPChartDeviceContext* pDC = m_pControl->GetContent()->CreateDeviceContext(
			m_pControl, memDC, CRect(0, 0, m_szImage.cx, m_szImage.cy), FALSE);
