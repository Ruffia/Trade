...
//-----------------------------------------------------------------------
// Summary:
//      Defines a callback interface for a chart device command event sink.
// See also:
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//      Notifies that a command has entered the BeforeExecute step.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Notifies that a command has entered the AfterExecute step.
	// Parameters:
	//      pCommand - Sender command pointer.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Notifies about updated boundaries for the command result.
	// Parameters:
	//      pCommand - Sender command pointer.
	//      rcBounds - Updated boundary rectangle.
	//-----------------------------------------------------------------------
	virtual void OnUpdateBounds(CXTPChartDeviceCommand* pCommand, CRect rcBounds);

	//-----------------------------------------------------------------------
	// Summary:
	//      Invoked when an event sink is to be unsubscribed from command events.
	// Parameters:
	//      pCommand - Sender command pointer.
	//-----------------------------------------------------------------------
...
public:
	...
	// Returns:
	//      TRUE if the execution of the command has been committed, FALSE otherwise.
	// See also:
	//      Commit
	//-----------------------------------------------------------------------
	...
	// Remarks:
	//     A device command object keeps an array of child device commands.
	...
	// Returns:
	//      TRUE if the command is currently enabled, FALSE otherwise.
	// See also:
	//      SetEnabled
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//      bEnabled - TRUE to enable the command, FALSE to disable the command.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//      Device context pointer for which the command is currently
...
//-----------------------------------------------------------------------
// Summary:
//      Defines a base class interface for a 2D hit test command.
//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//      Constructs a CXTPChartHitTestElementCommand object instance.
	// Parameters:
