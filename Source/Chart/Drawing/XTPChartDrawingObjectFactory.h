...
//      and a base class interface for an abstract drawing object factory.
// See also:
...
public:
	...
	static CXTPChartDeviceCommand* AFX_CDECL Create3dGradientPieDeviceCommand(
		...
		const CXTPChartColor& color, const CXTPChartColor& color2, BOOL bStartGap = FALSE,
		BOOL bEndGap = FALSE);
...
//-----------------------------------------------------------------------
// Summary:
//      Implements a 2D drawing object factory singleton.
// See also:
...
//-----------------------------------------------------------------------
// Summary:
//      Implements a 3D drawing object factory singleton.
// See also:
