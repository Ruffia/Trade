...
CXTPChartLegend::CXTPChartLegend(CXTPChartContent* pOwner)
{
	...
	m_nSortDirection	   = xtpChartLegendNone;
...
CXTPChartLegendView* CXTPChartLegend::CreateView(CXTPChartDeviceContext* pDC,
...
void CXTPChartLegend::DoPropExchange(CXTPPropExchange* pPX)
{
	...
	PX_Enum(pPX, _T("SortDirection"), m_nSortDirection, xtpChartLegendNone);
...
BEGIN_DISPATCH_MAP(CXTPChartLegend, CXTPChartElement)
	...
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "VerticalAlignment", 3, GetVerticalAlignment,
						SetVerticalAlignment, VT_I4)
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "HorizontalAlignment", 4, GetHorizontalAlignment,
						SetHorizontalAlignment, VT_I4)

	DISP_PROPERTY_EX_ID(CXTPChartLegend, "TextColor", 5, OleGetTextColor, OleSetTextColor, VT_COLOR)
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "BackgroundColor", 6, OleGetBackgroundColor,
						OleSetBackgroundColor, VT_COLOR)
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "MarkerVisible", 7, IsMarkerVisible, SetMarkerVisible,
						VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "MarkerWidth", 8, OleGetMarkerWidth, OleSetMarkerWidth,
						VT_I4)
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "MarkerHeight", 9, OleGetMarkerHeight, OleSetMarkerHeight,
						VT_I4)
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "Antialiasing", 10, GetAntialiasing, SetAntialiasing,
						VT_BOOL)
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "FillStyle", 11, OleGetFillStyle, SetNotSupported,
						VT_DISPATCH)
	...
	DISP_PROPERTY_EX_ID(CXTPChartLegend, "Font", DISPID_FONT, OleGetFont, SetNotSupported,
						VT_DISPATCH)

	DISP_PROPERTY_EX_ID(CXTPChartLegend, "SortDirection", 16, OleGetSortDirection,
						OleSetSortDirection, VT_I4)
...
void CXTPChartLegend::OleSetSortDirection(XTPChartLegendSortDirection val)
{
	SetSortDirection(val);
}

XTPChartLegendSortDirection CXTPChartLegend::OleGetSortDirection()
{
