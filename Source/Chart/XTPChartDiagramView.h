...
public:
	...
	// Returns:
	//     A CRect object containing the bounds of the diagram.
	//-----------------------------------------------------------------------
	...
	//     view.
	// Returns:
	//     A CXTPChartDiagram pointer. The actual type could be
	//     CXTPChartDiagram2D or CXTPChartDiagram3D.
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//      Creates a view device command.
	// Parameters:
	//      pDC - Device context pointer for which a command is to be created.
	// Returns:
	//      A new view device command. A caller is responsible for deleting
	//      the command object.
	//-----------------------------------------------------------------------
	virtual CXTPChartDeviceCommand* CreateDeviceCommand(CXTPChartDeviceContext* pDC);
