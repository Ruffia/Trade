...
protected:
	...
	CXTPChartLegendAppearance* m_pLegendAppearance; // Pointer to the legend appearance object.
};
...
public:
	...
	DECLARE_OLETYPELIB_EX(CXTPChartAxisAppearance);
	...
	afx_msg OLE_COLOR OleGetGridLinesColor();
	afx_msg void OleSetGridLinesColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetGridLinesMinorColor();
	afx_msg void OleSetGridLinesMinorColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetAxisLabelTextColor();
	afx_msg void OleSetAxisLabelTextColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetAxisTitleTextColor();
	afx_msg void OleSetAxisTitleTextColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetConstantLineColor();
	afx_msg void OleSetConstantLineColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetConstantLineTextColor();
	afx_msg void OleSetConstantLineTextColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetStripColor();
	afx_msg void OleSetStripColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetStripColor2();
	afx_msg void OleSetStripColor2(OLE_COLOR clr);
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Obtains axis appearance object pointer.
	// Returns:
	//      Axis appearance object pointer.
	//-----------------------------------------------------------------------
...
public:
	DECLARE_DISPATCH_MAP()
	DECLARE_INTERFACE_MAP()
	DECLARE_OLETYPELIB_EX(CXTPChartDiagram2DAppearance);

	afx_msg OLE_COLOR OleGetBackgroundColor();
	afx_msg void OleSetBackgroundColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetBackgroundColor2();
	afx_msg void OleSetBackgroundColor2(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetBorderColor();
	afx_msg void OleSetBorderColor(OLE_COLOR clr);
	afx_msg LPDISPATCH OleGetBackgroundFillStyle();
	afx_msg LPDISPATCH OleGetAxisAppearance();
...
public:
	...
	BOOL Antialiasing;					   // Antialiasing enable flag.
	...
	static const float DefaultMaterialShininess; // Default material shininess factor in range
												 // [0..1].
	static const BOOL DefaultAntialiasing;		 // Default antialiasing enable flag.

#	ifdef _XTP_ACTIVEX
public:
	DECLARE_DISPATCH_MAP()
	DECLARE_INTERFACE_MAP()
	DECLARE_OLETYPELIB_EX(CXTPChartDiagram3DAppearance);

	afx_msg double OleGetLightPositionX();
	afx_msg void OleSetLightPositionX(double dValue);
	afx_msg double OleGetLightPositionY();
	afx_msg void OleSetLightPositionY(double dValue);
	afx_msg double OleGetLightPositionZ();
	afx_msg void OleSetLightPositionZ(double dValue);
	afx_msg OLE_COLOR OleGetLightAmbientColor();
	afx_msg void OleSetLightAmbientColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetLightDiffuseColor();
	afx_msg void OleSetLightDiffuseColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetLightSpecularColor();
	afx_msg void OleSetLightSpecularColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetLightModelAmbientColor();
	afx_msg void OleSetLightModelAmbientColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetMaterialEmissionColor();
	afx_msg void OleSetMaterialEmissionColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetMaterialDiffuseColor();
	afx_msg void OleSetMaterialDiffuseColor(OLE_COLOR clr);
	afx_msg OLE_COLOR OleGetMaterialSpecularColor();
	afx_msg void OleSetMaterialSpecularColor(OLE_COLOR clr);
	afx_msg double OleGetMaterialShininess();
	afx_msg void OleSetMaterialShininess(double dValue);
	afx_msg BOOL OleGetAntialiasing();
	afx_msg void OleSetAntialiasing(BOOL bValue);
...
public:
	...
	afx_msg LPDISPATCH OleGetDiagram2DAppearance();
	afx_msg LPDISPATCH OleGetDiagram3DAppearance();
	//}}AFX_CODEJOCK_PRIVATE
#	endif
