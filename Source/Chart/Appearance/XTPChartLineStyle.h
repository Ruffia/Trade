...
public:
	...
	virtual CXTPChartDeviceCommand* CreateDeviceCommand(
		...
		const CXTPChartColor& color); // <combine CXTPChartLineStyle::CreateDeviceCommand@const
									  // CXTPChartPointF&@const CXTPChartPointF&@const
									  // CXTPChartColor&>
