...
public:
	...
	virtual CXTPChartDeviceCommand* CreateCircleDeviceCommand(
		const CXTPChartPointF& center, double radius, const CXTPChartColor& color,
		const CXTPChartColor& color2); // <combine CXTPChartFillStyle::CreateDeviceCommand@const
									   // CXTPChartPoints&@const CXTPChartColor&@const
									   // CXTPChartColor&>
