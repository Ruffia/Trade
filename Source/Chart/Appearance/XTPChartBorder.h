...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to set the thickness of the chart border.
	// Parameters:
	//     thickness - Thickness to be set.
	//-----------------------------------------------------------------------
...
public:
	...
	virtual CXTPChartDeviceCommand* CreateInnerBorderDeviceCommand(
		const CXTPChartRectF& rcBounds,
		const CXTPChartColor& color); // <combine
									  // CXTPChartBorder::CreateInnerBorderDeviceCommand@const
									  // CXTPChartRectF&@const CXTPChartColor&>
