...
public:
	...
	void SetLineStyle(CXTPChartLineStyle* pLineStyle);

	CXTPChartColor GetLineColor() const;

	void SetLineColor(CXTPChartColor clrLine);
...
AFX_INLINE void CXTPChartErrorBar::SetLineStyle(CXTPChartLineStyle* pLineStyle)
{
	m_pLineStyle = pLineStyle;
}
...
AFX_INLINE void CXTPChartErrorBar::SetLineColor(CXTPChartColor clrLine)
{
	m_clrLine = clrLine;
}
...
{
public:
	CXTPChartErrorBarView(CXTPChartErrorBar* pErrorBar, CXTPChartSeriesPointView* pPointView,
						  CXTPChartElementView* pParentView);
