...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function to get/set the the collection of the series points.
	// Parameters:
	//     pPoints - new series point collection object pointer.
	// Returns:
	//     A pointer to a CXTPChartSeriesPointCollection object.
	//-------------------------------------------------------------------------
	CXTPChartSeriesPointCollection* GetPoints() const;
	void SetPoints(CXTPChartSeriesPointCollection* pPoints); // <combine GetPoints>

	//-------------------------------------------------------------------------
	// Summary:
	//     Use this function to get the series style of the chart series.
	// Returns:
	//     A pointer to a CXTPChartSeriesStyle object. The type of the specific
	...
	// Parameters:
	//     pView - A pointer to a CXTPChartSeriesStyle object. The type of the specific
	//             object depends on the style of series chosen, eg: bar style, bubble
	//             style etc.
	//-------------------------------------------------------------------------
	...
	// Parameters:
	//     pDiagram - A pointer to a CXTPChartDiagram object. The type of the specific
	...
	// Returns:
	//     A pointer to a CXTPChartDiagram object. The type of the specific
	...
	//     how to convert numbers to strings for the legend.
	// Returns:
	...
	// Parameters:
	//     bVisible - A BOOL value. TRUE to make the series visible, FALSE to hide the series.
	//-------------------------------------------------------------------------
	void SetVisible(BOOL bVisible);

	//-------------------------------------------------------------------------
	// Summary:
	//     Call this function to check if the series is visible.
	// Returns:
	//     A BOOL value. TRUE if the series is visible, FALSE otherwise.
	//-------------------------------------------------------------------------
	...
	// Parameters:
	//     bVisible - A BOOL value. TRUE to make the legend item visible,
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to check if the legend item is visible.
	// Returns:
...
public:
	...
	//     collection.
	// Returns:
	//     A pointer to a chart series object.
	//-------------------------------------------------------------------------
...
AFX_INLINE CXTPChartSeries* CXTPChartSeriesCollection::GetAt(int nIndex) const
{
	return nIndex >= 0 && nIndex < m_arrElements.GetSize()
			   ? (CXTPChartSeries*)m_arrElements.GetAt(nIndex)
			   : NULL;
}
