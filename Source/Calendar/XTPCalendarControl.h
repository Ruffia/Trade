...
//     similar to an Outlook 2003 interface.
//
...
//
//     Note that each event now has a standard "Schedule" property, defining
...
//           This could be implemented through pressing the Save button for example.
...
//        you have many CalendarEvents records and do not want to store
...
//
// See Also:
//     CXTPCalendarView, CXTPCalendarData, CXTPCalendarResource
//===========================================================================
...
public:
	...
	virtual void SetPaintTheme(
		CXTPCalendarPaintManager* pPaintManager,
		CXTPCalendarTheme* pTheme); // <combine CXTPCalendarControl::SetPaintTheme@XTPCalendarTheme>
	...
	// See Also:
	//     CXTPCalendarView overview, XTPCalendarViewType, GetActiveView
	//-----------------------------------------------------------------------
...
public:
	...
	// See Also:
	//     CXTPCalendarControl::CUpdateContext, AdjustLayout, AdjustScrollBar,
	...
	virtual void AdjustLayout(CDC* pDC,
							  const CRect& rcView); // <combine CXTPCalendarControl::AdjustLayout>
...
public:
	...
	// See Also:
	//     SetWorkWeekMask, XTPCalendarWeekDay
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetWorkWeekMask, XTPCalendarWeekDay
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetFirstDayOfWeek, XTPCalendarWeekDay
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetFirstDayOfWeek, XTPCalendarWeekDay
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetWorkDayStartTime, GetWorkDayEndTime, SetWorkDayEndTime
	//-----------------------------------------------------------------------
	...
	//     nSec  - An int. A reference to the seconds part of the result.
	// See Also:
	//     SetWorkDayEndTime, GetWorkDayStartTime, SetWorkDayStartTime
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetWorkDayStartTime, GetWorkDayEndTime, SetWorkDayEndTime
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetWorkDayEndTime, GetWorkDayStartTime, SetWorkDayStartTime
	//-----------------------------------------------------------------------
	...
	//     bIgnoreDefaultValues  - Tells the event properties dialog to ignore default reminder
	...
	// See Also:
	//     MonthView_SetCompressWeekendDays
	//-----------------------------------------------------------------------
	...
	//                 FALSE otherwise.
	// See Also:
	//     MonthView_IsCompressWeekendDays
	//-----------------------------------------------------------------------
...
public:
	...
	//     to the day view for the specified day.
	// See Also:
	//     CXTPCalendarDayView overview, XTPCalendarViewType,
...
protected:
	...
	// See Also:
	//     CXTPCalendarView overview, GetActiveView
	//-----------------------------------------------------------------------
...
public:
	...
	// See Also:
	//     XTP_NOTIFY_CODE, GetConnection
	//-----------------------------------------------------------------------
	virtual void SendNotification(XTP_NOTIFY_CODE EventCode, WPARAM wParam, LPARAM lParam);
	virtual void SendNotificationAlways(
		XTP_NOTIFY_CODE EventCode, WPARAM wParam,
		LPARAM lParam); // <COMBINE
						// CXTPCalendarControl::SendNotification@XTP_NOTIFY_CODE@WPARAM@LPARAM>
...
public:
	...
	// See Also:
	//     OnCommand, OnCut, OnCopy, OnPaste
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     OnCommand, OnUndo, OnCopy, OnPaste
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     OnCommand, OnUndo, OnCut, OnPaste
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     OnUpdateUndo, OnUpdateCut, OnUpdateCopy, OnUpdatePaste
	//-----------------------------------------------------------------------
	...
	//     pCmdUI - pointer to the CCmdUI object.
	// See Also:
	//     OnUpdateUndo, OnUpdateUndo, OnUpdateCopy, OnUpdatePaste
	//-----------------------------------------------------------------------
	...
	//     pCmdUI - pointer to the CCmdUI object.
	// See Also:
	//     OnUpdateUndo, OnUpdateUndo, OnUpdateCut, OnUpdatePaste
	//-----------------------------------------------------------------------
	...
	//     pCmdUI - pointer to the CCmdUI object.
	// See Also:
	//     OnUpdateUndo, OnUpdateUndo, OnUpdateCut, OnUpdateCopy
	//-----------------------------------------------------------------------
	...
	// See Also:
	//      CXTPCalendarViewEventSubjectEditor, OnWndMsg().
	//-----------------------------------------------------------------------
...
public:
	...
	// See Also:
	//     XTPCalendarUpdateOptions, AdjustLayout,
	//     AdjustScrollBar, RedrawControl
	//=======================================================================
...
public:
	...
	//     identifies the type of the data provider which is specified there.
	// Returns:
