...
//
// See Also:
//     CXTPCalendarView, CXTPCalendarDayView, CXTPCalendarMonthView,
...
public:
	...
	virtual void AdjustLayout2(
		...
		BOOL bCallPostAdjustLayout = TRUE); //<COMBINE
											// CXTPCalendarWeekView::AdjustLayout@CDC*@const
											// CRect&@BOOL>
	...
	virtual void Draw2(CDC* pDC); //<COMBINE CXTPCalendarWeekView::Draw@CDC*>
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to obtain the width of a weeks
	//     day rectangle.
	// Returns:
	//     An int that contains the width of a day rectangle.
	//-----------------------------------------------------------------------
	int GetDayWidth() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to obtain the height of a weeks
	//     day rectangle.
	// Returns:
	//     An int that contains the height of a day rectangle.
	//-----------------------------------------------------------------------
	int GetDayHeight() const;

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(GetDayHeight)
...
protected: // member function
	...
	// Remarks:
	//     The first day of the week depends on region.
	//-----------------------------------------------------------------------
...
AFX_INLINE int CXTPCalendarWeekView::GetDayHeight() const
{
	return m_LayoutX.m_nDayHeight;
}
