...
//
// See Also:
//      CArray overview, CXTPCalendarSchedule overview.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Creates and adds a new schedule object by its name.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Removes a schedule object from the array by its ID.
	// Parameters:
	//     uScheduleID - The ID for the schedule.
	// Returns:
	//     TRUE if object was found and removed from the array;
	//     FALSE otherwise.
	// See Also:
	//     AddNewSchedule
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Returns a name of the schedule by its numeric ID.
	// Parameters:
	//     uScheduleID - The ID for the schedule.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets a new schedule name by its numeric ID.
	// Parameters:
	//     uScheduleID - The ID for the schedule.
	...
	//     or load schedule data from storage.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//       Finds the next available ID which does not exist in the array.
	// Returns:
...
//     a person, a shared resource, or even a group of people or resources.
//
// Remarks:
//
...
//     for people could be stored inside the Memory data provider (somebody's
...
//
// See Also:
//     CXTPCalendarControl, CXTPCalendarData
//===========================================================================
...
public:
	...
	// Summary:
	//     Default object constructor.
	//     Constructs a CXTPCalendarResource object.
	// Parameters:
	//     pCalendarCtrl - Pointer to the parent Calendar control.
	// See Also:
	//     ~CXTPCalendarResource
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CXTPCalendarData overview, SetDataProvider
	//-----------------------------------------------------------------------
	...
	//     bCloseDataProviderWhenDestroy - If this parameter is TRUE, the Close method
	//                                     of the data provided will be called on this
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get the collection of all schedule
	//     IDs for this resource.
	// Returns:
	//     A pointer to the CUIntArray collection which contains numeric IDs
	...
	//          If there are not any schedules specified inside this resource,
	//          the Calendar will show all available events.
	// Returns:
	//     TRUE if a schedule ID exists in the Schedules collection for
	//     this resource; FALSE otherwise.
	// See Also:
	//     GetSchedules, IsSchedulesSetEmpty
	//-----------------------------------------------------------------------
	virtual BOOL ExistsScheduleID(UINT uScheduleID, BOOL bReturnTrueIfSchedulesSetEmpty = TRUE);

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to remove events which are not from this
	//     resource.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if the schedules set in this
	//     resource is empty or not.
	// Returns:
	//     TRUE if the schedules set is empty for this resource;
	//     FALSE if at least 1 schedule exists.
	// See Also:
	//     GetSchedules, ExistsScheduleID
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A COLORREF with the color of the resource object.
	// See Also:
	//     SetColor
	//-----------------------------------------------------------------------
...
protected:
	...
	BOOL m_bCloseDataProviderWhenDestroy; // If TRUE - call Close() method for the data provider
...
//===========================================================================
// Summary:
//     This class implements CXTPCalendarResource functionality with the addition
//     of a notifications mechanism implemented by CXTPNotifySink.
// See also:
...
public:
	...
	// Summary:
	//     Default object constructor.
	//     Constructs a CXTPCalendarResourcesNf object.
	// See Also:
	...
	// See Also:
	//     GetConnection, GetResourcesGroupedByDP
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a resource object for a specified
	//     data provider.
	// Remarks:
	//     This method returns a resource from a temporary internal collection.
	// Parameters:
	...
	//     during the ReBuildInternalData method execution.
	// See Also:
	//     GetResourcesGroupedByDP, ReBuildInternalData
	//-----------------------------------------------------------------------
...
{
	ASSERT(NULL != pcszResourceName);
	m_strResourceName = (NULL != pcszResourceName ? CString(pcszResourceName) : m_strResourceName);
}
