...
public:
	...
	//     color.
	//     clrUnderLineHdr - A COLORREF object that specifies the color of header's
	//                       underline.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     An RGB value representing the event background color.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get the edge color for
	//     the specified event.
	// Parameters:
	//     pEvent : Points to the Calendar event.
	// Returns:
	//     An RGB value representing the event edge color.
	//-----------------------------------------------------------------------
