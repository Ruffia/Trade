...
public:
	...
	//                    property value.
	// Remarks:
	//      The corresponding method for ActiveX returns a VT_EMPTY variant value
	//      instead of FALSE.
	// Returns:
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//      This helper function is used to load a properties collection from a XML
	//      string source.
	// Parameters:
	//      pcszXMLData - [in] A pointer to a XML string data source.
	// Remarks:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      This helper function is used to store a properties collection to a XML
	//      string.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      This helper function is used to copy properties from a source collection
	//      object to a destination collection.
	// Parameters:
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Call this member function to prepare a property name before passing it
	//      to the map access functions.
	// Parameters:
	//      pcszName    - [in] A pointer to a property name string.
	// Remarks:
	//      If m_bNameIgnoreCase is TRUE, property names are converted to
	//      lower case.
	// Returns:
	//      Prepared property name string to pass to the map access functions.
	//-----------------------------------------------------------------------
