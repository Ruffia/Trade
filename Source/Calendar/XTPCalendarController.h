...
// Remarks:
//     A CXTPCalendarController object provides synchronization
...
//     second one.
// See Also:
//     CXTPCalendarControl, CXTPDatePickerControl
//===========================================================================
...
public:
	...
	// See Also:
	//     CXTPCalendarControl overview, SetDatePicker
	//-----------------------------------------------------------------------
	...
	//     object with this calendar controller.
	// See Also:
	//     CXTPDatePickerControl overview, SetCalendar
	//-----------------------------------------------------------------------
	virtual void SetDatePicker(CXTPDatePickerControl* pDatePickerCtrl);

	//-----------------------------------------------------------------------
	// Summary:
	//     Gets a calendar control object associated with the controller.
	// Returns:
	...
	//     controller or NULL.
	// See Also:
	//     SetCalendar, SetDatePicker, GetDatePicker
	//-----------------------------------------------------------------------
	virtual CXTPCalendarControl* GetCalendar() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Gets a date picker control object associated with the controller.
	// Returns:
	...
	//     controller or NULL.
	// See Also:
	//     SetCalendar, SetDatePicker, GetCalendar
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to determine whether Bold font is used
...
protected:
	...
	// See Also:
	//     CXTPCalendarController overview
	//-----------------------------------------------------------------------
	virtual void AdviseToNotifications();

	//-----------------------------------------------------------------------
	// Summary:
	//      This member function gets the first day of week from the calendar control
	//      and set the same value to the date picker control.
	// See Also:
	//      OnEvent_CalendarOptionsChanged(), CXTPCalendarController overview
	//-----------------------------------------------------------------------
	virtual void SetFirstDayOfWeekToDatePicker();

	//-----------------------------------------------------------------------
	// Summary:
	//      This member function is used to determine if Compressed Weekend Day -
	//      Sunday, is used as the first day of week in the active calendar view.
	// Remarks:
	...
	// See Also:
	//      CXTPCalendarWeekView, CXTPCalendarMonthView,
	...
	//     configuration is changed in the CalendarControl.
	// Parameters:
	//     Event - Events code.
	//     wParam - First user's parameter.
	//     lParam - Second user's parameter.
	...
	virtual void OnEvent_DtPickGetItemMetrics(
		XTP_NOTIFY_CODE Event, WPARAM wParam,
		LPARAM lParam); //<COMBINE
						// CXTPCalendarController::OnEvent_DatePicker@XTP_NOTIFY_CODE@WPARAM@LPARAM>
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to determine if the specified day has events or not.
	// Parameters:
