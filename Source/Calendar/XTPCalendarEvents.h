...
//
//      As with a C array, the access time for an indexed element of this
...
//
// See Also:
//      CArray overview, CXTPCalendarEvent overview.
//===========================================================================
...
public:
	...
	// </code>
	// See Also:
	//     GetAt, RemoveAll, GetCount, CXTPCalendarEvents overview,
	...
	// </code>
	// See Also:
	//     CXTPCalendarEvents overview, GetAt, RemoveAll, GetCount,
	...
	// See Also:
	//     Sort method, CompareEvents_ForView function,
	...
	// Example:
	//     See example for CXTPCalendarEvents::Sort method.
	//-----------------------------------------------------------------------
	...
	//     See example for CXTPCalendarEvents::Sort method.
	// See Also:
	//     method CXTPCalendarEvents::Sort overview,
