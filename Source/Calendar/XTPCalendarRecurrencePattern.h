...
public:
	...
	//     array if the necessary one is found there.
	// Parameters:
	//     pOccEvent - Pointer to the occurrence event object.
	//     pPattern  - Pointer to the parent Recurrence Pattern object for
	//                 those occurrences.
	// Returns:
	//     Nonzero if updated successfully; zero if update failed.
	// See Also:
	//     UpdateOccIfNeedEx
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Loads an array of occurrences information from the Calendar
...
//     a schedule for recurrence events.
// See Also:
...
public:
	...
	// Returns:
	//     A DWORD containing a unique pattern ID.
	// See Also:
	//     CXTPCalendarRecurrencePattern()
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetStartTime(COleDateTime dtStart)
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetDurationMinutes(int nMinutes), GetDuration()
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetDuration(COleDateTimeSpan spDuration, BOOL bKeepStart = TRUE)
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetStartOccurrenceTime(COleDateTime dtStart)
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     XTPCalendarEventRecurrenceType, XTP_CALENDAR_RECURRENCE_OPTIONS,
	...
	// See Also:
	//     SetPatternStartTime(COleDateTime dtStart)
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetPatternEndDate(COleDateTime dtEnd)
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     COleDateTime GetPatternEndDate()
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetEndAfterOccurrences, GetPatternEndDate, IsNoEndDate
	//-----------------------------------------------------------------------
	...
	//                    pattern end.
	// See Also:
	//     GetEndAfterOccurrences, GetPatternEndDate, IsNoEndDate
	//-----------------------------------------------------------------------
	virtual void SetEndAfterOccurrences(int nOccurrences);

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to determine if the pattern has
	//     an end date.
	// Returns:
	//     A BOOL. TRUE if the pattern end is not set. FALSE otherwise.
	// See Also:
	//     SetNoEndDate(), GetEndAfterOccurrences(), GetPatternEndDate()
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     IsNoEndDate(), GetEndAfterOccurrences(), GetPatternEndDate()
	//-----------------------------------------------------------------------
	...
	//                   master event.
	// Returns:
	//     TRUE if succesfully obtain the dates, FALSE otherwise.
	// See Also:
	//     CXTPCalendarEvents, CXTPCalendarEvent
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetMasterEventID(DWORD dwEventID).
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CXTPCalendarEvent, CXTPCalendarEvent, RemoveAllExceptions()
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     RemoveException(CXTPCalendarEvent* pException, CXTPCalendarEvent*
	...
	// Remarks:
	//     This member function is used to store data to or load data from
	//     storage.
	//-----------------------------------------------------------------------
...
public:
	...
	//               found.
	//     dtStart - A COleDateTime object that contains the start date of the search
	//               interval.
