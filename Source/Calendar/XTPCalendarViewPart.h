...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to overload the function call operator
	//     for the CXTPCalendarViewPartFontValue class.
	// Remarks:
	//     Use the default font if the custom font does not work. Otherwise,
	//     use a custom font.
...
public:
	...
	//      bAutoDestroy - Set to TRUE if the value being set will be
	...
	//      If the default value is not set - method does nothing.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to get the current value.
	// Remarks:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to get the standard value.
	// Returns:
	//     Standard value.
	// See Also:
	//     SetStandardValue, SetCustomValue, SetDefaultValue
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member operator is used to get the current value.
	// Remarks:
	//     The default value is used if the custom value is not set. Otherwise,
	//     a custom value is used.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to set the standard value using the
	//     current value from the specified object.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member operator is used to set the custom value.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method reads data from or writes data to an archive.
	// Parameters:
...
// Summary:
//      Helper class template provides functionality to manage customized
//      values for the specified class objects.
//===========================================================================
...
public:
	...
	//      bAutoDelete - Set to TRUE if the value being set will be
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is use to get the standard value.
	// Returns:
...
public:
	...
	//
	// Summary:
	//     Used to assign the standard value to a view part element.
	// Parameters:
	...
	//
	// Summary:
	//     Used to assign the custom value to a view part element.
	// Parameters:
	//     pFont :  pointer to CFont object
	// ----------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is use to set the standard value using the
	//     current value from the specified object.
	// Parameters:
	//     refSrc - Reference to a source object.
	// See Also:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member operator is used to set a custom value.
	// Parameters:
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member operator is used to destroy/clear value data.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method reads value data from or writes value data to storage.
	// Parameters:
	//     pPX          - A CXTPPropExchange object to serialize to or from.
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This methods reads value data from or writes value data to storage.
	// Parameters:
	//     pPX          - A CXTPPropExchange object to serialize to or from.
	//     pcszPropName - A value name.
	//     rXValue      - Reference to value.
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to calculate the rectangle needed to draw an event.
	// Parameters:
	//     pDC : Pointer to a valid device context.
