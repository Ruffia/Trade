...
//===========================================================================
// Summary:
//     This class is used to add new Calendar Event Categories or Labels
...
public:
	// ------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPCalendarEventColorNewDlg object used
	//     to add new calendar event categories and labels.
	// Parameters:
	//     bCategories - TRUE to edit event category list, FALSE
...
protected:
	...
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to enable / disable the OK
