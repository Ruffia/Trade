...
//      CXTPCalendarEventRecurrenceDlg::DoModal() when the "Remove Recurrence"
//      button is pressed.
// See Also:
...
//===========================================================================
// Summary:
//      This class is used for manipulations with recurrence state of the events.
// See Also:
...
protected:
	...
	virtual void MsgBox_WrongValueRange(
		UINT nCtrlID, int nMin,
		int nMax); //<COMBINE CXTPCalendarEventRecurrenceDlg::MsgBox_WrongValue@CWnd*>
