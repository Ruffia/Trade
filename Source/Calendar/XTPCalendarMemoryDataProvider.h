...
// See Also:
//     CXTPCalendarData::EventsMapByID_T overview, CMap overview
//===========================================================================
...
//          of a CXTPCalendarDatabaseDataProvider object. Then use the Open() member
//          function to establish a connection to the data source and initialize the
//          object. This class provides a number of functions to manipulate events and
//          events related data. After finishing work with the data source, you should
//          call the Close() member function to close the connection, de-initialize the
//          object and free unused resources.
// See Also:
...
public:
	...
	//     call the Open() member function immediately after construction.
	// See Also:
	//     Open()
	//-----------------------------------------------------------------------
	...
	//     will be saved to the archive.
	//     For the load case, existing data is not removed from the data
	//     provider and new data will be loaded from the specified
	//     archive and added to the existing data set.
	//     Call RemoveAllEvents() manually if you need a cleanup before load.
	//     For load and save operations, the _Load() and _Save() protected methods
	//     are used respectfully. Method can throw CArchiveException.
	// See Also:
	//     _Load(), _Save()
	//-----------------------------------------------------------------------
...
protected:
	...
	//     new data will be loaded from the specified archive and
