...
//     Month View.
// See Also:
//     CXTPCalendarMonthView::CMonthViewGrid::GetWeeksCount,
...
public:
	...
	virtual void AdjustLayout2(
		...
		BOOL bCallPostAdjustLayout = TRUE); //<COMBINE
											// CXTPCalendarMonthView::AdjustLayout@CDC*@const
											// CRect&@BOOL>
...
public:
	...
	// See Also:
	//     CXTPCalendarMonthView overview
	//=======================================================================
	...
	public:
		...
		// See Also:
		//     SetBeginDate, ShiftDateToCell_00
		//-----------------------------------------------------------------------
		...
		// See Also:
		//     GetBeginDate, ShiftDateToCell_00
		//-----------------------------------------------------------------------
		...
		//              XTP_CALENDAR_MONTHVIEW_SHOW_WEEKS_MAX.
		// See Also:
		//     GetWeeksCount, XTP_CALENDAR_MONTHVIEW_SHOW_WEEKS_MIN,
		//     XTP_CALENDAR_MONTHVIEW_SHOW_WEEKS_MAX
		//-----------------------------------------------------------------------
		...
		//     of the day cell.
		// See Also:
		//     GetCelRect, GetWeeksCount, CRect
		//-----------------------------------------------------------------------
		...
		//     of the full grid cell.
		// See Also:
		//     GetDayRect, GetWeeksCount, GetColsCount, CRect
		//-----------------------------------------------------------------------
		...
		//     specified week day.
		// Parameters:
		//     nWeekDayIndex - An int that contains the index of the week day.
		//                     1-Sunday, 2-Monday, ....
		// Remarks:
		//     If the "compress weekend days" option is ON then, only one
		//     column number is returned for Saturday and Sunday.
		// Returns:
		//     An int that contains the column number for the specified week day.
		// See Also:
		//     GetColsCount, GetWeekDayForColIndex
		//-----------------------------------------------------------------------
		...
		//     specified column.
		// Parameters:
		//     nColIdx - An int that contains the index of the week day.
		//                     1-Sunday, 2-Monday, ....
		// Remarks:
		...
		//     grid.
		// See Also:
		//     GetScrollPos, CXTPCalendarMonthView::ScrollV,
		...
		// See Also:
		//     ScrollV, CXTPCalendarMonthView::ScrollV,
		//     CXTPCalendarMonthView::GetScrollBarInfoV.
		//-----------------------------------------------------------------------
		...
		//     pDC - Pointer to a valid device context.
		// See Also:
		//     AdjustLayout, CXTPCalendarMonthView::AdjustLayout
		//-----------------------------------------------------------------------
		...
		// See Also:
		//     CXTPCalendarMonthView::GetViewDay
		//-----------------------------------------------------------------------
		...
		// Returns:
		//     An int that contains the First Day Of Week index. (1-Sunday, 2-Monday ...)
		// See Also:
		//     GetWeekDayCol
		//-----------------------------------------------------------------------
	...
	protected:
		...
		//     scrollbar position.
		// See Also:
		//     ScrollV, GetScrollPos, CXTPCalendarMonthView::ScrollV,
		//     CXTPCalendarMonthView::GetScrollBarInfoV.
		//-----------------------------------------------------------------------
