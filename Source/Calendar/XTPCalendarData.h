...
public:
	...
	//     specified data source and initialize the object, you must call
	//     the Open() member function immediately after construction.
	// See Also:
	//     Open()
	//-----------------------------------------------------------------------
	CXTPCalendarData();
	...
	//     can call Open().
	// Returns:
	//     Boolean value representing success/failure result.
	//-----------------------------------------------------------------------
	virtual BOOL Open();
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method determines the type of the current Data Provider
	//     implementation.
	// Returns:
	//     The current Data Provider implementation type.
	// See also:
	...
	//     regular appointments for this day, and multi-day appointments which
	//     also have a part of this day.
	//     This method uses the DoRetrieveDayEvents realization and implements
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Reads an event from the data source.
	// Parameters:
	...
	//     some additional service processing.
	// Returns:
	//     A pointer to the new CXTPCalendarEvent object in which fields
	//     are filled with data from the data source.
	//-----------------------------------------------------------------------
	virtual CXTPCalendarEventPtr GetEvent(DWORD dwEventID);

	//-----------------------------------------------------------------------
	// Summary:
	//     Reads a recurrence pattern from the data source.
	// Parameters:
	...
	//     some additional service processing.
	// Returns:
	//     A pointer to the new CXTPCalendarRecurrencePatternPtr object in which
	//     fields are filled with data from the data source.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to add a new item to the event label list.
	// Parameters:
	//     nID     : Unique identifier for the label.
	//     strName : Name of the list to add.
	//     crLabel : Background base color for the list.
	// Returns:
	//     TRUE if the item was added to the list, otherwise FALSE.
	//-----------------------------------------------------------------------
	virtual BOOL AddEventLabel(int nID, CString strName, COLORREF crLabel);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to add a new item to the event
	//     category list.
	// Parameters:
	...
	// Returns:
	//     TRUE if the item was added to the category list, otherwise FALSE.
	//-----------------------------------------------------------------------
	virtual BOOL AddEventCategory(UINT uID, CString strName, COLORREF crBorder, COLORREF crBkBase);

	//-----------------------------------------------------------------------
	// Summary:
	//     Update event labels colors when the theme is changed.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to remove all items from the
	//     event category list.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to restore the event category list
	//     to default values.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to restore the event label list
	//     to default values.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function updates the default colors of the category list
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets common data provider cache mode.
	// Parameters:
	...
	//     all events.
	// See Also:
	//     _Save(), Serialize(), DoGetAllEvents_raw()
	//-----------------------------------------------------------------------
...
protected:
	...
	public:
		...
		//-------------------------------------------------------------------
		// Summary:
		//     Safely removes all elements from the cache.
		//-------------------------------------------------------------------
		void SafeRemoveAll();

		//-------------------------------------------------------------------
		// Summary:
		//     Checks whether events for this day are already stored in the cache.
		// Parameters:
		...
		//-------------------------------------------------------------------
		// Summary:
		//     Sets a flag that this day is in the cache.
		// Parameters:
		//     dtDay - A day to set.
		...
		//-------------------------------------------------------------------
		// Summary:
		//     Checks whether a specified event is already stored in the cache.
		// Parameters:
		...
		//-------------------------------------------------------------------
		// Summary:
		//     Adds a collection of events to the cache for a specified day.
		// Parameters:
		...
		//     stored in the cache and adds it there if not.
		// Parameters:
...
protected:
	...
	public:
		...
		//-----------------------------------------------------------------------
		// Summary:
		//     This member function is used to get the start iteration position.
		// Returns:
		//     A POSITION value that indicates a starting position for
		//     iterating the map; or NULL if the map is empty.
		// See Also:
		//     GetNextElement, CMap::GetStartPosition
		//-----------------------------------------------------------------------
		...
		//-----------------------------------------------------------------------
		// Summary:
		//      This member function is used to get the next object pointer.
		// Parameters:
		...
		// See Also:
		//      GetStartPosition, CMap::GetNextAssoc
		//-----------------------------------------------------------------------
