...
#define TRY_POINTER_CALL(proc)                                                                     \
	...
	{                                                                                              \
		...
		{                                                                                          \
			m_ptrWrappers[xtpWrapper##proc] = ::GetProcAddress(m_hMapiDll, xtpWrapperProc##proc);  \
		}                                                                                          \
...
HRESULT CXTPCalendarMAPIWrapper::HrQueryAllRows(LPMAPITABLE ptable, LPSPropTagArray ptaga,
...
HRESULT CXTPCalendarMAPIWrapper::HrGetOneProp(LPMAPIPROP pmp, ULONG ulPropTag,
...
HRESULT CXTPCalendarMAPIWrapper::HrThisThreadAdviseSink(LPMAPIADVISESINK lpAdviseSink,
...
HRESULT CXTPCalendarMAPIWrapper::HrAllocAdviseSink(LPNOTIFCALLBACK lpfnCallback, LPVOID lpvContext,
												   LPMAPIADVISESINK FAR* lppAdviseSink)
{
