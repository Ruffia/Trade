...
//===========================================================================
// Summary:
//      This class extends the TIME_ZONE_INFORMATION structure.
// Remarks:
...
public:
	...
	// Returns:
	//      A smart pointer to a CXTPCalendarTimeZone object.
	// See Also:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Reads all time zones from the registry and adds them to the
	//      collection.
	// Returns:
	//      TRUE - if all time zones were successfully read,
	//      otherwise - FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is used to find time zone information using a
	//     specified time zone's data.
	// Parameters:
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//      This structure represents a format of binary data stored in the
	//      "TZI" registry key.
	// See also:
	...
	//      If the rbstrValue parameter is not NULL, the SysFreeString()
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      This method is used to read a time zone's information stored as a
