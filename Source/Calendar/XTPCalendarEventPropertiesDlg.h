...
//===========================================================================
// Summary:
//     This class is used as the base class for all owner drawn
...
public:
	...
	//--------------------------------------------------------------------
	// Summary:
	//     Call this member function to initialize the combobox.
	// Parameters:
	//     pEvent - Pointer to the selected calendar event.
...
protected:
	...
	// Parameters:
	//     lpMIS - A pointer to a LPMEASUREITEMSTRUCT structure.
	// -----------------------------------------------------------
	virtual void MeasureItem(LPMEASUREITEMSTRUCT lpMIS);

	// -------------------------------------------------------------------
	// Summary:
	//     This member function is called to calculate the size
	//     for the color rectangle displayed for each item.
	// Parameters:
	//     rItem - Combobox client coordinates of the item.
	// Returns:
	//     Client coordinates of the color rectangle for the item.
	// -------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     This class implements the event category selector combobox.
//===========================================================================
...
public:
	...
	// Parameters:
	//     pChecked  - [in/out] A pointer to a CXTPCalendarEventCategoryIDs
	//                 collection to receive selected category's IDs.
	//     pbChanged - [in/out] This member is set to TRUE if the category's
	//                 IDs set changed.
	//--------------------------------------------------------------------
	...
	//     combobox category array.
	// Returns:
	//     A reference to the combobox category array.
	//-----------------------------------------------------------------------
...
protected:
	...
	//--------------------------------------------------------------------
	// Summary:
	//     Called to draw an event category item when the combobox
	//     is collapsed.
	// Parameters:
	...
	// -------------------------------------------------------------------
	// Summary:
	//     Use this member function to get the list box selected item (works
	...
	// -------------------------------------------------------------------
	// Summary:
	//     Use this member function to redraw the list box (works for
	//     dropped state only).
	// Parameters:
	//     bUpdateNow - Set as TRUE to call UpdateWindow, FALSE to
	//                  call Invalidate.
	// -------------------------------------------------------------------
...
protected:
	...
	CXTPCalendarEventCategoryIDs m_arChecked;   // Array which stores checked item IDs.
...
//===========================================================================
// Summary:
//     This class implements the event label selector combobox.
//===========================================================================
...
public:
	...
	//--------------------------------------------------------------------
	// Summary:
	//     Use this member to get the selected label ID.
	// Parameters:
	...
	//--------------------------------------------------------------------
	// Summary:
	//     Use this member to set the selected label ID.
	// Parameters:
	//     nID - A selected label ID.
	//--------------------------------------------------------------------
...
protected:
	//--------------------------------------------------------------------
	// Summary:
	//     This function implements the custom draw combobox items.
	// Parameters:
	//     lpDIS - A pointer to a LPDRAWITEMSTRUCT structure.
	//--------------------------------------------------------------------
	virtual void DrawItem(LPDRAWITEMSTRUCT lpDIS);
...
//===========================================================================
// Summary:
//     This class implements the busy status selector combobox.
//===========================================================================
...
//===========================================================================
// Summary:
//      This class is used to edit calendar event properties. This is a default
//      implementation which can be used as either an example or as a base class
//      for custom dialogs.
//      It is designed to be localized; XTPResourceManager is used to load
//      resources.
// See Also:
...
public:
	...
	//     pEditingEvent - [in, out] Pointer to editing event object. If NULL, then
	//                     a new event will be created.
	//     nIDTemplate   - [in] Contains the ID number of a dialog-box template resource.
	// Remarks:
	//     If pEditingEvent is NULL, then a new event will be created and the StartTime,
	...
	//     bAddEvent -      BOOL flag to add event (if TRUE) or modify existing (if FALSE).
	//     pParent -        Parent CWnd*.
	//     pEditingEvent -  Pointer to passed event.
