...
public:
	// ------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPCalendarEventColorDlg object used to
...
protected:
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to update the diplayed
	//     color for the color picker whenever a listbox
	//     selection changes.
	// Parameters:
	//     nIndex : Index of the listbox item to retrieve color
