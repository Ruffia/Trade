...
// Remarks:
//     This implementation uses a MS Access database as the data source.
...
//          of the CXTPCalendarDatabaseDataProvider object. Then use the Open() member
//          function to establish a connection to the data source and initialize the
//          object. The CXTPCalendarDatabaseDataProvider class provides a number of
//          functions to manipulate events and event related data. After finishing
//          work with the data source, call the Close() member function to close the
//          connection, de-initialize the object and free any unused resources.
// See Also:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to initialize a data provider using an
	//     existing ADO Connection object.
	// Parameters:
	...
	//     Also the calendar data provider does not close the ADO Connection
	//     through the Close method. You have to close it yourself.
	// Returns:
	//     TRUE is successful. FALSE otherwise.
	//-----------------------------------------------------------------------
