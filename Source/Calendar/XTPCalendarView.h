...
public:
	...
	// Returns:
	//     TRUE if the message is handled properly, FALSE otherwise.
	// Remarks:
...
//
// See Also:
//      CXTPCalendarDayView, CXTPCalendarWeekView, CXTPCalendarMonthView,
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to get the number of selected events.
	// Returns:
	//     A UINT that contains the number of selected events.
	//-----------------------------------------------------------------------
	UINT GetDiscreteSelectionCount() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function gets a selected event by using its event ordinal number.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function adds an event to the selection by using its event ordinal number.
	// Parameters:
	//     id :  event ordinal number.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function checks if an event is in the selection.
	// Parameters:
	//     id :  event ordinal number.
	// Returns:
	//     BOOL flag (TRUE if present in selection, FALSE otherwise).
	//-----------------------------------------------------------------------
	...
	//     Default object constructor.
	// Parameters:
	//     pCalendarControl - A Pointer to a CXTPCalendarControl object.
	// See Also:
	//     ~CXTPCalendarEvent()
	//-----------------------------------------------------------------------
	...
	virtual void AdjustLayout2(
		...
		BOOL bCallPostAdjustLayout = TRUE); //<COMBINE
											// CXTPCalendarView::AdjustLayout@CDC*@const
											// CRect&@BOOL>
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to process system keyboard events.
	// Parameters:
	//     nChar   - A UINT that specifies the virtual key code of the given key.
	...
	//     if any, is at a specified position index, and returns additional
	//     info in an XTP_CALENDAR_HITTESTINFO object.
	// Parameters:
	...
	// See Also:
	//     CXTPCalendarPaintManager, GetTheme
	//-----------------------------------------------------------------------
	...
	//
	// Remarks:
	//     It calls the CXTPCalendarControl::GetTheme() method.
	// Returns:
	...
	//      data.
	// Remarks:
	//      This member function wraps the CXTPCalendarData::GetCalendarOptions()
	//      method. If you read or change returned structure members, then
	...
	// Returns:
	//      A pointer to the calendar options data class CXTPCalendarOptions.
	// See Also:
	...
	// See Also:
	//     SelectViewEvent(), CXTPCalendarEvent
	//-----------------------------------------------------------------------
	...
	//     So far, you'll have to call Calendar.RedrawControl after that.
	// See Also:
	//     SelectEvent(), CXTPCalendarViewEvent
	//-----------------------------------------------------------------------
	...
	//     event's views.
	// Remarks:
	//     This method may return a few event views instances for one event.
	//     (multi-day events have a separate view event object for each day).
	// Returns:
	//     A pointer to a CXTPCalendarViewEvents object that contains the
	//     selected event's views.
	// See Also:
	//     CXTPCalendarViewEvents, CXTPCalendarViewDay,
	...
	// Remarks:
	//     This method returns one event view instance for one event.
	//     (multi-day events have a separate view event object for each day).
	// Returns:
	//     A smart pointer to a CXTPCalendarEvents object that contains the
	//     selected events.
	// See Also:
	//     GetSelectedViewEvents(), CXTPCalendarViewEvents
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A pointer to the last selected event view or NULL.
	// See Also:
	//     CXTPCalendarViewEvent, GetSelectedViewEvents().
	//-----------------------------------------------------------------------
	CXTPCalendarViewEvent* GetLastSelectedViewEvent() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if any view event is selected.
	// Parameters:
	//     TRUE if any view event is selected, FALSE otherwise.
	// See Also:
	//     GetSelectedViewEvents
	//-----------------------------------------------------------------------
	virtual BOOL HasSelectedViewEvent() const;

	//-----------------------------------------------------------------------
	// Summary:
	//      This member function is used to determine if just one event is selected.
	// Returns:
	//      TRUE - if only one event is selected,
	//      FALSE - if no events are selected or if more than one event is selected.
	// See Also:
	//      GetSelectedViewEvents(), SelectViewEvent(), SelectEvent().
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     Index of the last selected day or -1.
	// See Also:
	//     GetLastSelectedDate()
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     FindLastSelectedDay(), GetSelection(), SetSelection().
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A UINT that contains the timeout value in milliseconds.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to erase the undo buffer.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     point :     A CPoint that contains the mouse position coordinates.
	//     pHitInfo :  A pointer to an XTP_CALENDAR_HITTESTINFO struct that contains
	...
	//      subject editing.
	// Parameters:
	//      pcszInitialSubject - A pointer to the string which contains the initial
	//                           subject value for the new event (generally initial
	//                           char).
	//-----------------------------------------------------------------------
	...
	//     A CXTPCalendarViewEvent object that contains the view object or NULL.
	// See Also:
	//     GetNextTimeEditByTAB, UpdateNextTimeEditByTAB
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     FindEventToEditByTAB, UpdateNextTimeEditByTAB
	//-----------------------------------------------------------------------
	...
	//                iteration position.
	// See Also:
	//     GetNextTimeEditByTAB, FindEventToEditByTAB
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      This member function(s) is used to obtain the status of the vertical or
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      This member function(s) is used to set the date format string for the
	//      day view.
	// Parameters:
	//     pcszCustomFormat - Date format string.
	// Remarks:
	//      Long, Middle, Short and Shortest format strings are used for
	//      different header widths. Calendar control selects the longest format
	//      which can be drawn for active day header width.
	//      By default these format strings are built using locale settings
	...
	virtual void SetDayHeaderFormatMiddle(
		LPCTSTR pcszCustomFormat); // <COMBINE CXTPCalendarView::SetDayHeaderFormatLong@LPCTSTR>
	virtual void SetDayHeaderFormatShort(
		LPCTSTR pcszCustomFormat); // <COMBINE CXTPCalendarView::SetDayHeaderFormatLong@LPCTSTR>
	virtual void SetDayHeaderFormatShortest(
		LPCTSTR pcszCustomFormat); // <COMBINE CXTPCalendarView::SetDayHeaderFormatLong@LPCTSTR>

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if Today is visible.
	// Returns:
	//     A BOOL. TRUE if Today is visible, FALSE otherwise.
	//-----------------------------------------------------------------------
	...
	//     an event time string of maximum length (to reserve space).
	// Returns:
	...
	// Parameters:
	//     pDC       - Pointer to a valid device context.
	//     nWidth    - An int that contains the day header width in pixels.
	//     pTextFont - A pointer to a CFont object that is
	//                 used to calculate the text dimensions.
	// Remarks:
	//     Call this member function to create a day header format
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called by the framework view when it is activated
	//     or deactivated.
	// Parameters:
	...
	// Parameters:
	//     EventCode - An XTP_NOTIFY_CODE that contains the specific
	//                 code of the event.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This function is used to calculate the max width of the date
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      This member function gets a custom or default day header date format
	//      string.
	// Parameters:
	...
	// See Also:
	//     _ReadEventsFromClipboard, XTPCalendarClipboardCopyFlags,
	...
	//     collection.
	// See Also:
	//     _CopySelectedEvents, XTPCalendarClipboardCopyFlags,
	//     XTPCALENDARCTRL_CF_EVENT, COleDataSource
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function handles the changing of an event in the associated
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      This method is used to determine if specified editing operation is
	//      disabled.
	// Parameters:
	//      eOperation - A value from enum XTPCalendarEditOperation.
	//      pEventView - A pointer to event view.
	// Returns:
	//      TRUE if specified editing operation is disabled, otherwise FALSE.
	// See Also:
	...
	//      pEventView - A pointer to event view.
	// Returns:
	//      TRUE if specified editing operation is disabled or handled,
	//      otherwise FALSE.
	// See Also:
	//      XTP_NC_CALENDAR_IS_EVENT_EDIT_OPERATION_DISABLED,
	//      XTP_NC_CALENDAR_BEFORE_EVENT_EDIT_OPERATION, XTPCalendarEditOperation.
	...
	//      operation.
	// Parameters:
	//      pEvent                        - A pointer to an event prepared for paste.
	//      bPasteWillChangeExistingEvent - If this parameter is TRUE, the new
	//                                      event will not be added. Instead, just
	...
	//                           char).
	// Returns:
	//      TRUE if In-place create event editing operation is disabled or handled,
	//      otherwise FALSE.
	// See Also:
	//      XTP_NC_CALENDAR_IS_EVENT_EDIT_OPERATION_DISABLED,
	//      XTP_NC_CALENDAR_BEFORE_EVENT_EDIT_OPERATION, XTPCalendarEditOperation.
	...
	//=======================================================================
	// Summary:
	//      Class CSelectionChangedContext is used to avoid multiple sending of
	//      an XTP_NC_CALENDAR_SELECTION_CHANGED notification for one selection
	//      changing operation.
	//=======================================================================
	...
	public:
		...
		// See Also:
		//     XTP_NC_CALENDAR_SELECTION_CHANGED
		//-------------------------------------------------------------------
...
protected:
	//=======================================================================
	// Summary:
	//     This class defines an internal structure used as a counter on
...
protected:
	...
	// See Also:
	//     FormatEventTime, _CalculateEventTimeFormat.
	//===========================================================================
...
//     It is used as a part of the calendar control framework to build the
...
public:
	...
	// See Also:
	//     XTPCalendarViewType, ~CXTPCalendarEventT()
	//-----------------------------------------------------------------------
