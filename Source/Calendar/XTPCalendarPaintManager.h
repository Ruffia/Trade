...
// </code>
// See Also:
//     END_VIEW_PART, CXTPCalendarPaintManager
//===========================================================================
...
//
// See Also:
//     BEGIN_VIEW_PART, CXTPCalendarPaintManager
//===========================================================================
...
public:
	...
	//     pDC       - Pointer to a valid device context.
	//     pView     - A CXTPCalendarDayView pointer to the Day View object.
	//     pScale    - A CXTPCalendarDayViewTimeScale pointer to the Day View object.
	//     rc        - A CRect that contains the Time scale bounding rectangle.
	//     y         - An int that contains the 'Now' line position.
	//     bDrawBk   - If FALSE, then draw only the line. If TRUE,
	//                 then draw the line and the gradient fill.
	//-------------------------------------------------------------------
	virtual void DrawNowLine(CDC* pDC, CXTPCalendarDayView* pView,
							 CXTPCalendarDayViewTimeScale* pScale, CRect rc, int y,
							 BOOL bDrawBk = FALSE);
	...
	CXTPPaintManagerColor m_clrEventBorderLine; // Event border line color.
	...
	CXTPPaintManagerColor m_clrWeekendBackground; // Time scale weekend background color.
...
protected:
	...
	virtual void PartDrawNowLine(CDayViewTimeScaleHeaderPart* pViewPart, CDC* pDC,
								 CXTPCalendarDayView* pView, CXTPCalendarDayViewTimeScale* pScale,
								 CRect rc, int y, BOOL bDrawBk);
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to obtain the current paint theme.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to set the current paint theme.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get the background color for
	//     the specified event.
	// Parameters:
	//     pEvent    : Points to the Calendar event.
	//     crDefault : RGB value representing the default color to be
	//                         returned if one could not be found.
	// Returns:
	//     An RGB value representing the event background color if
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to draw the time as a clock.
	// Parameters:
	//     pDC           - Pointer to a valid device context.
	...
	// See Also:
	//      enum XTPCalendarClockAlignFlags determines alignment flags.
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     enum XTPCalendarEventBusyStatus determines Event Busy Status, CRgn.
	//-----------------------------------------------------------------------
...
public:
	...
	CXTPPaintManagerColor m_clrTLVEventBorderLine;
	...
	CXTPPaintManagerColor m_clrTLVWeekendBack;
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function returns a set of flags which define calendar items
	//     to send an XTP_NC_CALENDAR_GETITEMTEXT notification.
	// Returns:
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Enumerates types of expand signs drawn on a day view.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Returns drawing brush value for a specific busy status.
	// Parameters:
