...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Use this method to update the dialog reminders list from the reminders
	//      manager.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//      Use this method to update the dialog reminders list from the calendar
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is used to determine if the dialog window is displayed in
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is used to set if the dialog window is displayed in
	//     the Microsoft Windows taskbar.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is used to determine if the dialog window pops up automatically
	//     when new reminders arrive.
	// Returns:
	//     TRUE if the dialog window pops up automatically, FALSE otherwise.
	//-----------------------------------------------------------------------
	BOOL IsAutoPopup() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is used to set if the dialog window pops up automatically
	//     when new reminders arrive.
	// Parameters:
