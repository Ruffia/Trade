...
//===========================================================================
// Summary:
//     This class defines Calendar Event label properties.
// See Also:
//     CXTPCalendarEvent
//===========================================================================
...
public:
	...
	CXTPCalendarEventLabel(
		CXTPCalendarEventLabel*
			pSrc); // <combine CXTPCalendarEventLabel::CXTPCalendarEventLabel@int@COLORREF@LPCTSTR>
...
//     objects.
// See Also:
//     CXTPCalendarEventLabel, CXTPCalendarEvent
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function updates the default colors of labels when
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set a flag indicating that custom
	//     labels are defined.
	// Parameters:
	//     bDefault : Set to FALSE when using custom values.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     This class defines Calendar Event Category properties.
//     Visual effects for Event Categories (event and day's cells background
//     colors) are implemented in Office 2007 theme only. If one or more categories
//     are set for an event, then the the category's colors are used. Otherwise
//     the label's colors are used (is label defined). For Office 2003 theme, the
//     label's colors are used in any case.
// See Also:
//     CXTPCalendarEvent, CXTPCalendarEventCategories
//===========================================================================
...
public:
	...
	CXTPCalendarEventCategory(
		CXTPCalendarEventCategory*
			pCategory); // <combine
						// CXTPCalendarEventCategory::CXTPCalendarEventCategory@UINT@LPCTSTR@COLORREF@COLORREF>
...
//     objects.
// See Also:
//     CXTPCalendarEventCategory, CXTPCalendarEvent
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function updates the default colors of a category list
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set a flag indicating custom
	//     labels are defined.
	// Parameters:
	//     bDefault : Set to FALSE when using custom values.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Finds an event category index in the collection by its ID.
	// Parameters:
	//     nID - An UINT that contains the category ID.
	// Returns:
...
// Remarks:
//     It also implements some useful operations on elements.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to find an ID in the collection.
	// Parameters:
	//     uID - ID to find.
	// Returns:
	//     Zero-based index in the collection, or -1 if the element is not found.
	//-----------------------------------------------------------------------
	int Find(UINT uID) const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to remove an ID from the collection.
	// Parameters:
	//     uID - ID to remove.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to store collection data as a comma separated
	//     string.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to read collection data from a comma separated
	//     string.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to Store/Load collection data using the
...
// Remarks:
//     It also implements some useful operations on custom icons
//     IDs collection.
//===========================================================================
...
// Remarks:
//     It also implements some useful operations.
//===========================================================================
