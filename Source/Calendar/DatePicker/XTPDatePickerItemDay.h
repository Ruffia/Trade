...
// See Also:
//     CXTPDatePickerControl, CXTPDatePickerItemMonth
//===========================================================================
...
public:
	...
	// ----------------------------------------------------
	CXTPDatePickerItemDay(CXTPDatePickerControl* pControl, CXTPDatePickerItemMonth* pMonth,
						  COleDateTime dtDay);
	...
	// Returns:
	//     A pointer to a CXTPDatePickerItemMonth object which is an owner of this
	//     day object.
	// -----------------------------------------------------------------------
	...
	// Returns:
	//     A pointer to a CXTPDatePickerControl parent object.
	// -----------------------------------------------------------------------
...
protected:
	CXTPDatePickerControl* m_pControl; // -----------------------------------------------------------
									   // This member variable is a pointer to the parent date
									   // picker control.
									   // -----------------------------------------------------------
	...
	BOOL m_bVisible; // -----------------------------------------------------------------
					 ...
					 // is visible.The flag values are TRUE if the day item is drawn, otherwise
					 // FALSE.
					 // -----------------------------------------------------------------
