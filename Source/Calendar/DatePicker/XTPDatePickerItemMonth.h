...
public:
	...
	// ------------------------------------------------------------------------
	CXTPDatePickerItemMonth(CXTPDatePickerControl* pControl, COleDateTime dtMonth, int nRow,
							int nCol);
	...
	// See Also:
	//     AdjustLayout(CRect rcClient, BOOL bIsAuto = FALSE)
	//-----------------------------------------------------------------------
	...
	//              displayed. TRUE if the days before this month are shown. FALSE
	...
	//              displayed. TRUE if the days after this month are visible. FALSE
	...
	// See Also:
	//     GetShowRightScroll, SetShowScrolling
	//-----------------------------------------------------------------------
	...
	//                     visible. TRUE Left scrolling triangle is visible. Right
	//                     scrolling triangle is visible. FALSE Left scrolling
...
AFX_INLINE void AFX_CDECL CXTPDatePickerItemMonth::Swap(COleDateTime& dtFirst,
														COleDateTime& dtSecond)
{
