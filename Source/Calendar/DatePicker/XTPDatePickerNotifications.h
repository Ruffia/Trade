...
// ----------------------------------------------------------------------
// Summary:
//     This is a notification ID that indicates that the Date Picker
//     is about to enter modal mode (pop-up window).
// Remarks:
//     There are two DWORD parameters that are reserved for user-defined purposes.
// Example:
// <code>
...
// ----------------------------------------------------------------------
// Summary:
//     This is a notification ID that is used to indicate that the mouse moved under
//     a control.
// Remarks:
//     There are two DWORD parameters that are reserved for user-defined purposes.
...
//
// See Also:
//     CXTPDatePickerControl::GetDayMetrics, CXTPDatePickerControl::SetCallbackDayMetrics.
//---------------------------------------------------------------------------
