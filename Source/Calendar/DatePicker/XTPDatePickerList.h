...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPDatePickerList object, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
...
protected:
	...
	COleDateTime m_dtStartMonth;  // The month to start selection from (will be placed in the middle
								  // of the list for the beginning).
