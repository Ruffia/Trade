...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to obtain the control's background color.
	// Returns:
	//     The color used to fill the control's client rectangle.
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetButtonFont(CFont*), GetButtonFont()
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetButtonFontIndirect(LOGFONT* lFont),
	//     SetButtonFont(CFont* fontButton)
	//-----------------------------------------------------------------------
	CFont* GetButtonFont();
	...
	// Remarks:
	//     It is called from the CXTPDatePickerItemDay implementation.
	...
	// Remarks:
	//     It is called from the CXTPDatePickerItemMonth implementation.
	//     You can override it to customize drawing.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     bEnableTheme - A BOOL that is used as a flag to indicate if themes are enabled.
