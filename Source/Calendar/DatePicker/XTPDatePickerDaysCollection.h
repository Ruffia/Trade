...
protected:
	...
	CArray<SELECTED_BLOCK, SELECTED_BLOCK&> m_arrSelectedBlocks; // Contains an array of the
																 // selected dates blocks.
...
AFX_INLINE CXTPDatePickerDaysCollection::SELECTED_BLOCK
	CXTPDatePickerDaysCollection::GetSelectedBlock(int nIndex) const
{
