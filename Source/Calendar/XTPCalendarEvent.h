...
//
// See Also:
//     CXTPCalendarRecurrencePattern overview,
...
public:
	...
	// See Also:
	//     CXTPCalendarEvent, SetScheduleID
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pcszSubject - A LPCTSTR object that contains the string of text.
	//-----------------------------------------------------------------------
	...
	//     the event label.
	// See Also:
	//     CXTPCalendarEventLabel, SetLocation
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CXTPCalendarEventLabel, SetLabelID
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetDurationMinutes(), GetDuration()
	//-----------------------------------------------------------------------
	...
	//     an event.
	// See Also:
	//     SetReminderMinutesBeforeStart(int nMinutes)
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A CString object with a full path to the sound file for the
	//     event reminder.
	// See Also:
	//     SetReminderSoundFile(LPCTSTR pcszFile)
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetBusyStatus, XTPCalendarEventBusyStatus enum
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetBusyStatus, XTPCalendarEventBusyStatus enum
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     An importance level for an event as an XTPCalendarEventImportance enum.
	// See Also:
	//     SetImportance, XTPCalendarEventImportance enum
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetImportance, XTPCalendarEventImportance enum
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     MakeEventAsRecurrence, XTPCalendarEventRecurrenceState enum
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetRecurrenceState, XTPCalendarEventRecurrenceState enum
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CXTPCalendarRecurrencePattern, RemoveRecurrence
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     UpdateRecurrence(CXTPCalendarRecurrencePattern* pRPattern)
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     SetRExceptionDeleted(BOOL bDeleted = TRUE)
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     Pointer to a CXTPCalendarEventCategoryIDs object.
	// See also;
	...
	//     IDs associated with an event object.
	// Returns:
	//     An int that contains the count of CXTPCalendarEventCategoryIDs.
	// See also;
	//     CXTPCalendarEventCategories overview,
	//     CXTPCalendarData::GetEventCategories
	//-----------------------------------------------------------------------
	...
	// Returns:
	//      A pointer to a CXTPCalendarCustomProperties object.
	// See Also:
	...
	// See Also:
	//     SetRException_StartTimeOrig, GetRException_EndTimeOrig
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetRException_StartTimeOrig, SetRException_EndTimeOrig
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     GetRException_EndTimeOrig, SetRException_StartTimeOrig
	//-----------------------------------------------------------------------
