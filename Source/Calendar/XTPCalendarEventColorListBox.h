...
//===========================================================================
// Summary:
//     This class is used by CXTPCalendarEventColorListBox to create an
...
public:
	// ------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPCalendarEventColorEdit object used to
	//     edit calendar event categories and labels names.
	// Parameters:
	//     nIndex : Index of the list box item to edit.
	// ------------------------------------------------------------------
	CXTPCalendarEventColorEdit(int nIndex);

	// ------------------------------------------------------------------
	// Summary:
	//     Returns the index of the listbox item associated with this
	//     edit control.
	// ------------------------------------------------------------------
	int GetIndex() const;
...
//===========================================================================
// Summary:
//     This class is used to display a list of Calendar Event Categories or
//     Labels that can be edited.
//===========================================================================
...
public:
	// ------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPCalendarEventColorListBox object used
	...
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to initialize the listbox
	//     with calendar event category or list data.
	// Parameters:
	//     pData       : Points to a valid CXTPCalendarData object.
	...
	// ------------------------------------------------------------------
	// Summary:
	//     Called to begin the editing of a listbox event category
	//     or label item.
	// ------------------------------------------------------------------
	...
	// ------------------------------------------------------------------
	// Summary:
	//     Called to end the editing of a listbox event category
	//     or label item.
	// Parameters:
	//     bUpdate : TRUE to save edit changes, FALSE to discard.
	// ------------------------------------------------------------------
	virtual void EndEdit(BOOL bUpdate = TRUE);

	// ------------------------------------------------------------------
	// Summary:
	//     Called to delete a list box category or label item.
	// Parameters:
	...
	// ------------------------------------------------------------------
	// Summary:
	//     Called to add a new event category or label to the listbox.
	// Returns:
	//     An index of the newly added item if successful, otherwise
	//     returns LB_ERR.
	// ------------------------------------------------------------------
	virtual int AddItem();
	...
	// ------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the color for a
	//     calendar event category or label.
	// Parameters:
	//     crItem : RGB value representing new item color.
	...
	// ------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the label object
	//     for the specified index.
	// Parameters:
	//     nIndex : Index of the item to get the label pointer for.
	// Returns:
	//     A CXTPCalendarEventLabel object pointer if successful,
	...
	// ------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the category object
	//     for the specified index.
	// Parameters:
	//     nIndex : Index of the item to get the category pointer for.
	// Returns:
	//     A CXTPCalendarEventLabel object pointer if successful,
	//     otherwise returns NULL.
	// ------------------------------------------------------------------
	...
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to get a pointer to the
	//     edit control used for renaming calendar event categories
	//     and labels.
	// Returns:
	//     A pointer to a valid CXTPCalendarEventColorEdit if active,
	//     otherwise returns NULL.
	// ------------------------------------------------------------------
	...
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to update the calendar
	...
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to toggle the checked
	//     state for the specified calendar event category.
	// Parameters:
	//     nItem : Index of the item to toggle check state for.
	// ------------------------------------------------------------------
	void ToggleCheck(int nItem);

	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to set the modified
	//     state for the listbox control.
	// Parameters:
	//     bModified : TRUE if the state of the list box has changed
	...
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to check the modified
	//     state of the listbox control.
	// Returns:
	//     TRUE if the listox state has been changed, otherwise
	//     returns FALSE.
	// ------------------------------------------------------------------
	BOOL IsModified();
...
protected:
	...
	// ------------------------------------------------------------------
	// Summary:
	//     This member function is called to determine the size and
	//     location of a color rectangle for the specified item.
	// Parameters:
	//     rItem : Size and location of the listbox item used to
	//             calculate the color rectangle.
	// Returns:
	//     A CRect object representing the size and location of
