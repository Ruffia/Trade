...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Default object constructor. Constructs a CXTPCalendarViewGroup object.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Obtain a pointer to a collection of Calendar Resources.
	// Remarks:
	...
	virtual void AdjustLayout2(
		CDC* pDC, const CRect& rcGroup); //<COMBINE
										 // CXTPCalendarViewGroup::AdjustLayout@CDC*@const
										 // CRect&>
	...
	//     hitInfo - An XTP_CALENDAR_HITTESTINFO object.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to get an event view object at the
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to obtain a pointer to a CXTPCalendarViewEvent
	...
	//     A pointer to a CXTPCalendarViewEvent object.
	// See Also:
	//     CXTPCalendarEvent, CXTPCalendarViewEvent
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CXTPCalendarViewEvent::ChangeEventPlace,
...
protected:
	...
	// Remarks:
	//     Default implementation sends an XTP_NC_CALENDAR_PREPOPULATE notification.
	// See Also:
	//     XTP_NC_CALENDAR_PREPOPULATE
	//-----------------------------------------------------------------------
...
//
// See Also:
//     CXTPCalendarViewDayT, CXTPCalendarDayViewDay,
...
public:
	...
	//     in the day view collection.
	// Remarks:
	//     This function is left for compatibility with previous versions
	...
	// See Also:
	//     SetDayDate(COleDateTime dtDayDate)
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if there are any invisible event views.
	// Remarks:
	//     This function is used for determining if the expanding signs are
	//     drawn.
	// Returns:
	//     A BOOL. TRUE if there is at least one event that is completely
	//     invisible. FALSE otherwise.
	//-----------------------------------------------------------------------
	virtual BOOL ContainsInvisibleEvents() const;

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(ContainsInvisibleEvents)
	virtual BOOL _NoAllEventsAreVisible() const
	{
		return ContainsInvisibleEvents();
	}
	//}}AFX_CODEJOCK_PRIVATE
	...
	// Summary:
	//     Call this member function to determine if there are any invisible event views
	//     and to calculate the rectangle for the ExpandSign.
	// Returns:
	//     TRUE if there are invisible event views. FALSE otherwise.
	// See Also:
	//     CXTPCalendarViewDay::ContainsInvisibleEvents
	//-----------------------------------------------------------------------
	virtual BOOL ContainsInvisibleEventsUpdate();

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(ContainsInvisibleEventsUpdate)
	virtual BOOL NoAllEventsAreVisible()
	{
		return ContainsInvisibleEventsUpdate();
	}
	//}}AFX_CODEJOCK_PRIVATE
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if there are invisible event
	//     views because the boundaries of the day view are hidden and
	//     if the day view should display the expand sign.
	// Returns:
	//     A BOOL. TRUE if there are invisible event views. FALSE otherwise.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A CRect object that contains the expand sign rectangle's coordinates.
	//-----------------------------------------------------------------------
	...
	//      xtpCalendarUserAction_OnExpandDay.
	// Parameters:
	...
	//
	// Returns:
	//      TRUE if action was handled by the user and default processing must be
...
protected:
	...
	//     show events.
	// Remarks:
	//     Default implementation sends an XTP_NC_CALENDAR_PREPOPULATE_DAY notification.
	// See Also:
	//     XTP_NC_CALENDAR_PREPOPULATE
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to create a new instance of a group.
	//-----------------------------------------------------------------------
