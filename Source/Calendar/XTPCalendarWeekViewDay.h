...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is used to fill an XTP_CALENDAR_HITTESTINFO structure.
	// Parameters:
	//     pHitTest - A pointer to an XTP_CALENDAR_HITTESTINFO struct.
	// Remarks:
...
//          CXTPCalendarViewDayT class. Furthermore, class CXTPCalendarWeekViewDay
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Default object constructor. Constructs a CXTPCalendarWeekViewDay
	//     object.
	// Parameters:
	...
	//     This member function is used to fill an XTP_CALENDAR_HITTESTINFO structure.
	// Parameters:
	//     pInfo - A pointer to an XTP_CALENDAR_HITTESTINFO struct.
	// Remarks:
	//     Call this member function to gather hit test information from
	//     the week view.
	// See Also:
	...
	virtual void AdjustLayout2(
		CDC* pDC, const CRect& rcDay); //<COMBINE
									   // CXTPCalendarWeekViewDay::AdjustLayout@CDC*@const
									   // CRect&>
