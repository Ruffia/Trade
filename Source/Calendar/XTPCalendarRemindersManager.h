...
//===========================================================================
// Summary:
//     This class describes a reminder for a calendar event and implements base
//     properties for and operations on the reminder.
//===========================================================================
...
public:
	...
	// Parameters:
	//     pOwnerMan - A pointer to the reminders manager which owns this object.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieve the calendar event for which this reminder is related.
	// Returns:
	//     A pointer to a calendar event object.
	//-----------------------------------------------------------------------
	virtual CXTPCalendarEventPtr GetEvent() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the date and time when a reminder
	...
	// See Also:
	//     GetMinutesBeforeStart, Snooze, GetEvent.
	//-----------------------------------------------------------------------
	...
	//     an event.
	// See Also:
	//     CXTPCalendarEvent::GetReminderMinutesBeforeStart, GetEvent.
	//-----------------------------------------------------------------------
	virtual int GetMinutesBeforeStart() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to Snooze an active reminder.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to Dismiss an active reminder.
	// Remarks:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if reminders objects have
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Set a calendar event for which this reminder is related.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This union contains data members to unambiguously define a related
	//     event.
	// See Also:
	//     RecurrenceEventInfo, m_eEventType
	//-----------------------------------------------------------------------
	union {
...
public:
	...
	// Parameters:
	//     pReminder - A pointer to the reminder object to find.
	// Returns:
	//     Index of the equal reminder object in the collection or -1 if such
	//     object is not present.
	// See Also:
	//     Find@CXTPCalendarEvent
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     dwEventID - Event ID of a normal event or Master event.
	//     pDP       - A pointer to the event data provider.
	// Returns:
	//     Index of the related reminder object in the collection or
	//     -1 if such object is not present.
	// See Also:
	//     Find@CXTPCalendarReminder, Find@CXTPCalendarEvent
	//-----------------------------------------------------------------------
...
protected:
	...
	// Parameters:
	//     pEvent - A pointer to the master event.
	// Returns:
...
//     It will send notifications when the active reminders list
//     is changed - new reminder(s) come or some reminder(s) goes away.
// Remarks:
//     When Reminder manager starts, it checks all events which have a Reminder
//     flag set.
...
//
//     Some Reminder manager data is stored in CalendarEvent custom properties
//     (or RecurrencePattern custom properties). This means if your own events
...
public:
	...
	// Remarks:
	//     Can be useful to quickly determine if the active reminders collection
	//     is empty without copy collection.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to retrieve the active reminders collection.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to Snooze a specified reminder.
	// Parameters:
	//     pReminder        - A pointer to a reminder object.
	//     nMinutesAfterNow - A value in minutes to activate the reminder again.
	// Returns:
	//     TRUE if operation is successful, FALSE otherwise.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to Dismiss a specified reminder.
	// Remarks:
	//     Reminder flag for the corresponding event object is set to FALSE.
	// Parameters:
	//     pReminder    - A pointer to a reminder object.
	// Returns:
	...
	// Parameters:
	//     pResources     - A pointer to a calendar resources collection.
	//     spPeriod2Cache - A time period for which reminder manager will read
	//                      reminders from calendar resources (data provider).
	//  Remarks:
	//     To retrieve reminders, the CXTPCalendarData::GetUpcomingEvents() method
	//     is used. This can be a slow operation and by using the spPeriod2Cache
	...
	//     and and to clear all reminders in reminders manager.
	// Returns:
	//     TRUE if operation is successful, FALSE otherwise.
	// See Also:
	//     StartMonitoring
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to determine if StartMonitoring was successfully
	//     called and if the reminders manager is monitoring reminders.
	// Returns:
	//     TRUE if reminders manager is active (started/running), FALSE otherwise.
	// See Also:
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is used to send an XTP_NC_CALENDAR_ON_REMINDERS notification
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method clears all reminders in reminders manager collections.
	// See Also:
	//     StopMonitoring
	//-----------------------------------------------------------------------
