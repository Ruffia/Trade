...
public:
	...
	//     ulBitmapHeight - ULONG.
	//-----------------------------------------------------------------------
	void ApplyShadow2007Bottom(UINT* pBitmap, const ULONG ulBitmapWidth,
	...
	//     ulBitmapHeight - ULONG.
	//-----------------------------------------------------------------------
	void ApplyShadow2007Center(UINT* pBitmap, const ULONG ulBitmapWidth,
							   const ULONG ulBitmapHeight);
