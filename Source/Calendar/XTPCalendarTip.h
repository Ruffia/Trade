...
public:
	...
	// </code>
	// See Also:
	//     CWnd, Create, Activate
	//-----------------------------------------------------------------------
	CXTPCalendarTip();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPCalendarTip object and handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     CXTPCalendarTip::CXTPCalendarTip, Activate
	//-----------------------------------------------------------------------
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This function is used to set the advanced mode flag.
	// Parameters:
	//     bMode - a BOOL flag to set the mode as advanced or standard
	//-----------------------------------------------------------------------
...
public:
	...
	// Example:
	//     See Create method example.
	// See Also:
	//     Create, CXTPCalendarTip::CXTPCalendarTip, SetTooltipText
	//-----------------------------------------------------------------------
	void Activate(BOOL bActive, BOOL bAdvanced = FALSE);

	//-----------------------------------------------------------------------
	// Summary:
	//      This function is used to calculate the tooltip rectangle.
	// Parameters:
	//     bFull - A BOOL flag of the way of calculation.
	// Remarks:
	//      Standard window DC, stored font and tooltip text are used.
	// Returns:
	//     Size of the tooltip rectangle.
	// See Also:
	//     SetTooltipText, SetFont.
	//-----------------------------------------------------------------------
