...
public:
	...
	// Parameters:
	//     pSrc - Pointer to the object to copy options from.
	//-----------------------------------------------------------------------
...
//     the Calendar control as a view class. Use the GetCalendarCtrl() method
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to access a Calendar control object.
	// Returns:
	//     Reference to a child CXTPCalendarControl window.
	//-----------------------------------------------------------------------
	virtual CXTPCalendarControl& GetCalendarCtrl();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to access a CaptionBar control object.
	// Returns:
	//     Reference to a child GetCalendarCaptionBarCtrl window.
	//-----------------------------------------------------------------------
	virtual CXTPCalendarCaptionBarControl& GetCalendarCaptionBarCtrl();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set a custom Calendar control object.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to retrieve a Caption Bar control's visible state.
	// Returns:
	//     TRUE if the Caption Bar is visible, FALSE otherwise.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to show or hide a Caption Bar control.
	// Parameters:
...
protected:
	...
	// Returns:
	//     A number of months between the bottom and top boundaries, including them.
	//-----------------------------------------------------------------------
	...
	// ---------------------------------------------------------------------
	// Summary:
	//     Adjusts a calendar printing rectangle by adding space for a header,
	...
	// Returns:
	//     An adjusted calendar printing rectangle.
	// ---------------------------------------------------------------------
	...
	// Returns:
	//     A converted rectangle in logical units.
	// See also:
	//     CDC::HIMETRICtoLP()
	//-----------------------------------------------------------------------
...
protected:
	...
	CXTPCalendarControl::CUpdateContext* m_pUpdateContext;
	CBitmap m_bmpGrayDC;
	//}}AFX_CODEJOCK_PRIVATE
