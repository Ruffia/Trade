...
//===========================================================================
// Summary:
//     This class is a wrapper for CXTPCalendarResource class.
...
//===========================================================================
// Summary:
//     This class is used as a helper to manage calendar resources (and schedules)
//     data configurations.
//===========================================================================
...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     This enum specifies data provider flags.
	//-------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Adds a new data provider to the data providers collection using a
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to find a data provider by a connection string.
	// Parameters:
	//     pcszConnectionString - A text Calendar connection string.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Adds a new data resource to the calendar resources collection.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieve the calendar data resources count for the collection.
	// Returns:
	//     Calendar data resources count for the collection.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method reads data providers and resources configuration from or
	//     writes data providers and resources configuration to storage.
	// Parameters:
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method saves data providers and resources configuration to
	//     storage.
	// Parameters:
	//     pPX - A CXTPPropExchange object to serialize to.
	// See Also:
	//     _Load, LoadCfg, SaveCfg, DoExchangeCfg.
	//-----------------------------------------------------------------------
	...
	// See Also:
	//     _Save, LoadCfg, SaveCfg, DoExchangeCfg.
	//-----------------------------------------------------------------------
