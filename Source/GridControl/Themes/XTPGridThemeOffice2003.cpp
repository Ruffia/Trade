// XTPGridThemeOffice2003.cpp : implementation of the CXTPGridPaintManager class.
//
...
/////////////////////////////////////////////////////////////////////////////
// class: CXTPGridThemeOffice2003
/////////////////////////////////////////////////////////////////////////////

CXTPGridThemeOffice2003::CXTPGridThemeOffice2003()
{
	m_columnStyle = xtpGridColumnShaded;
}

void CXTPGridThemeOffice2003::DrawColumnBackground(CDC* pDC, CXTPGridColumn* pColumn,
...
void CXTPGridThemeOffice2003::DrawColumn(CDC* pDC, CXTPGridColumn* pColumn, CXTPGridHeader* pHeader,
										 CRect rcColumn, BOOL bDrawExternal,
										 int /*nShadowWidth*/ /*= 0*/)
{
	...
	CXTPGridPaintManager::DrawColumn(pDC, pColumn, pHeader, rcColumn, bDrawExternal,
									 !bPlainColumn ? XTP_DPI_X(4) : 0);
}

void CXTPGridThemeOffice2003::DrawSectionDivider(CDC* pDC, const CRect& rc,
