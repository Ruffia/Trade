// XTPGridThemeExplorer.cpp : implementation of the CXTPGridPaintManager class.
//
...
/////////////////////////////////////////////////////////////////////////////
// class: CXTPGridThemeExplorer
/////////////////////////////////////////////////////////////////////////////

CXTPGridThemeExplorer::CXTPGridThemeExplorer()
{
	m_columnStyle = xtpGridColumnExplorer;
}

void CXTPGridThemeExplorer::DrawTriangle(CDC* pDC, CRect rcTriangle, BOOL bToDown, int nShadowWidth)
{
	CRect rcTRect;
...
CSize CXTPGridThemeExplorer::DrawGlyph(CDC* pDC, CRect rcColumn, int iGlyph)
{
	CSize size(0, 0);
...
BOOL CXTPGridThemeExplorer::IsColumHotTrackingEnabled() const
{
	return m_bHotTracking && m_themeHeader->IsAppThemeActive();
}

void CXTPGridThemeExplorer::DrawColumnBackground(CDC* pDC, CXTPGridColumn* pColumn, CRect rcColumn,
												 BOOL& bColumnPressed,
...
void CXTPGridThemeExplorer::DrawSectionDivider(CDC* pDC, const CRect& rc,
