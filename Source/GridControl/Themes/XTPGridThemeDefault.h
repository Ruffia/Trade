// XTPGridThemeDefault.h: interface for the CXTPGridPaintManager class.
//
...
#if !defined(__XTPGRIDTHEMEDEFAULT_H__)
#	define __XTPGRIDTHEMEDEFAULT_H__
//}}AFX_CODEJOCK_PRIVATE
...
//===========================================================================
// Summary:
//     CXTPGridThemeDefault is a CXTPGridPaintManager derived class
//     that represents an Office 97 style theme.
//===========================================================================
class _XTP_EXT_CLASS CXTPGridThemeDefault : public CXTPGridPaintManager
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
#endif //#if !defined(__XTPGRIDTHEMEDEFAULT_H__)
