...
//===========================================================================
class _XTP_EXT_CLASS CXTPTrackPaintManager : public CXTPGridPaintManager
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     CXTPTrackPaintManager destructor, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	~CXTPTrackPaintManager();
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to format the time and tick marker
	//     relative to a time line position.
	// Parameters:
	//     nPosition   - Point in the time line.
	//     clrTick     - Tick mark color.
	//     nTickLength - Tick mark length.
	// Returns:
	//     A CString containing the formatted time.
	// Remarks:
	//     This is a virtual function so derived classes can provide their
	//     specific implementations.
	//-----------------------------------------------------------------------
	virtual CString FormatTimeLineTick(int nPosition, COLORREF& clrTick, int& nTickLength);
	virtual CString FormatTime(
		int nPosition); // <combine CXTPTrackPaintManager::FormatTimeLineTick@int@COLORREF&@int&>
...
public:
	...
	COLORREF m_clrScrollBarLight;		// The scrollbar light color.
	COLORREF m_clrScrollBarDark;		// The scrollbar dark color.
	COLORREF m_clrSelectedArea;			// The color of the selected area.
	COLORREF m_clrMarker;				// The color of the marker.

	COLORREF m_clrTimeLineTick;			   // The color of a time line tick.
	COLORREF m_clrMarkerBorder;			   // The color of a time line marker's border.
	COLORREF m_clrMarkerBack;			   // The color of a time line marker's back.
	COLORREF m_clrTrackMarkerBorder;	   // The color of a track marker's border.
	COLORREF m_clrTrackMarkerText;		   // The color of a track marker's text.
	COLORREF m_clrTrackMarkerTextBack;	 // The color of a track marker's text back.
	COLORREF m_clrTrackMarkerTextBorder;   // The color of a track marker's text border.
	COLORREF m_clrTimeLinePosition;		   // The color of a marked position on a time line.
	COLORREF m_clrTimeHeaderBorder;		   // The color of a time line header's border.
