...
void CXTPTrackThemeDefault::DrawColumnBackground(CDC* pDC, CXTPGridColumn* pColumn, CRect rcColumn,
												 BOOL& /*bColumnPressed*/,
												 ...
												 CXTPGridHeader* pHeader)
{
	...
	if (pPrevColumn && !pPrevColumn->GetDrawHeaderDivider())
		DrawVerticalLine(pDC, rcColumn.left, rcColumn.top + XTP_DPI_X(1),
						 rcColumn.Height() - XTP_DPI_Y(2), m_clrHeaderControl);
}
