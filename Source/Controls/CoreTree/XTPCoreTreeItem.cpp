...
CXTPImageManagerIcon* CXTPCoreTreeItem::GetImage() const
{
	...
	return m_pControl->GetImageManager()->GetImage(XTPToUInt(m_nIconId));
}
...
CXTPCoreTreeItem* CXTPCoreTreeItems::AddItemAfter(CXTPCoreTreeItem* pItem,
												  CXTPCoreTreeItem* pPrevItem)
{
	if (!pItem)
		return NULL;
...
CXTPCoreTreeItem* CXTPCoreTreeItems::AddItemBefore(CXTPCoreTreeItem* pItem,
												   CXTPCoreTreeItem* pNextItem)
{
	if (!pItem)
		return NULL;
