...
public:
	...
	void EnableDpiBitmapScaling(
		BOOL bEnable = TRUE); // <combine CXTPCoreTreeControl::IsDpiBitmapScalingEnabled@const>

public:
	void SetDragOverItem(CXTPCoreTreeItem* pDragOveritem,
						 XTPCoreTreeDropPosition nDropPosition = xtpCoreTreeDropAfter);
...
protected:
	BOOL DragItem(CXTPCoreTreeItem* pItem,
