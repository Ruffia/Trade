...
public:
	void AddTask(LPCTSTR lpszPath, LPCTSTR lpszArgument, LPCTSTR lpszTitle, LPCTSTR lpszIconPath,
				 int nIconIndex = -1);
	void Clear();
	void CommitList();
...
private:
	...
	HRESULT CreateShellLink(LPCWSTR lpszApp, LPCWSTR lpszCommandLine, LPCWSTR lpszTitle,
							LPCWSTR lpszIconPath, int nIconIndex, IShellLinkW** ppSL);
