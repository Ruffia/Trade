...
public:
	...
	//     Known File Types option is enabled.
	// Returns:
	//     true if enabled, otherwise false.
	//-----------------------------------------------------------------------
	bool ShowExtensions();
	...
	COLORREF m_crCompColor; // An RGB color value that represents the system alternate compressed
							// color.
	COLORREF m_crEncrColor; // An RGB color value that represents the system alternate encrypted
							// color.
};
