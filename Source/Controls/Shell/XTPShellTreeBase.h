...
protected:
	...
	//     the shell folder, it enumerates the sub-items of this folder and adds
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member to set the root CSIDL folder.
	// Parameters:
	...
	//     order to fill up sub-directories.
	// Parameters:
	...
	// Returns:
	//     TRUE if the folder path was found, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//     at 'hItem' to find the item specified by 'lplvid'. This is typically
	//     used when the user double clicks an item in the list view.
	// Parameters:
	//     hItem  - Handle to the tree item to search from.
	//     lplvid - Pointer to the list view item data.
	//     bRecursively - TRUE to recursively search.
	// Returns:
	//     TRUE if successful, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pWnd - Pointer to the combobox that is associated with the tree.
	//-----------------------------------------------------------------------
	virtual void AssociateCombo(CWnd* pWnd);

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to initialize a branch of the shell tree.
	// Parameters:
	...
	// Parameters:
	//     pNMTreeView - Pointer to a NM_TREEVIEW structure.
	//-----------------------------------------------------------------------
	...
	//     comboboxes associated with the tree. You can override this member
	//     to provide additional functionality.
	// Parameters:
	//     hItem         - Handle to the newly selected tree item.
	//     strFolderPath - A NULL-terminated string representing the fully
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to enable auto-hidden triangles for Windows Vista
	//     and Windows 7.
	//-----------------------------------------------------------------------
...
protected:
	...
	//     tree item.
	// Parameters:
	//     hItem        - Handle to a HTREEITEM node.
	...
	//                delimited by backslashes or by the NULL at the end of the path.
	// Remarks:
	...
	// Example:
	//     The following example demonstrates using the XTFuncPathFindNextComponent
	//     function:
	// <code>
...
//     Tree      -  Existing class that this object will be derived from.
//     Base      -  Existing shared class that this object will be derived from.
// Remarks:
//     <i>Tree</i> must be an existing class that is derived from either
//     <i>CTreeCtrl</i> or <i>CTreeView</i>.
// Example:
