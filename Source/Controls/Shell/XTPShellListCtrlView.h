...
public:
	...
	// Parameters:
	//     pWnd - Pointer to the tree control that is associated with the list.
	//-----------------------------------------------------------------------
...
//     a standalone shell list control that is not dependent on a CXTPShellTreeCtrl
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will associate a CWnd object with the shell list
	//     control. This window is usually a CEdit control, but can be any CWnd
	//     object. This window will have its window text updated whenever the
	//     selected folder is changed.
	// Parameters:
	//     pSyncWnd - Pointer to a valid CWnd object.
	//-----------------------------------------------------------------------
...
protected:
	CWnd* m_pSyncWnd;	  // Pointer to the window to synchronize with the shell list control.
