...
//     that displays an explorer style tree, and can be associated with a combobox
//     and list control.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable auto-initialization
	//     of the shell tree control.
	// Parameters:
	//     bEnable - TRUE to enable auto-initialization of the shell tree control.
	//-----------------------------------------------------------------------
	void EnableAutoInit(BOOL bEnable);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to associate a list control with the tree.
	// Parameters:
	//     pWnd - Pointer to the list control to be associated with the tree.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pWnd - Pointer to the combobox to be associated with the tree.
	//-----------------------------------------------------------------------
...
protected:
	BOOL m_bAutoInit;  // TRUE if the tree control is to automatically initialize when created.
