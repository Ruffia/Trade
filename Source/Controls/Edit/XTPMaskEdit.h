...
public:
	...
	// Remarks:
	//     Call this member function to initialize the edit control. You can
	//     call this after you have created or subclassed your edit control.
	// Parameters:
...
public:
	...
	//     convert it to a COleDateTime object, and return this COleDateTime object.
	// Parameters:
...
public:
	...
	// Parameters:
	//     nHours - The new hours to be displayed.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     bMilitary - true to use military time.
	//-----------------------------------------------------------------------
