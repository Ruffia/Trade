...
//===========================================================================
// Summary:
//     CXTPBrowseButton is a CXTPButton derived class. It is used by
//     CXTPBrowseEdit to create the browse button used for
//     displaying file dialogs and pop-up menus.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPBrowseButton object, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
...
public:
	...
	//     nMenu -         [in] Pop-up menu ID.
	//     nSubMenuIndx -  [in] Index of pop-up submenu.
	// Returns:
...
protected:
	...
	UINT m_nSubMenuIndx;		// Index of pop-up sub-menu.
...
//     search for directories and files or activate a pop-up menu.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPBrowseEdit object, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
...
public:
	...
	// Returns:
	//     true if the control is displaying a File Open dialog or pop-up menu.
	//-----------------------------------------------------------------------
	bool IsBrowsing();
	...
	// Parameters:
	//     pFileDialog -  [in] Pointer to the CFileDialog object that will replace the
	...
	// Parameters:
	//     bOpenFileDialog -  [in] TRUE to construct a File Open dialog box, or
	...
	// Parameters:
	//     lpszDefExt - [in] Pointer to a NULL-terminated string that represents the
	...
	// Parameters:
	//     lpszFileName - [in] Pointer to a NULL-terminated string that represents the
	...
	// Parameters:
	//     lpszFilter - [in] Pointer to a NULL-terminated string that represents the
	...
	// Parameters:
	//     lpszTitle - [in] Pointer to a NULL-terminated string that represents the
	...
	// Parameters:
	//     lpszInitialDir - [in] Pointer to a NULL-terminated string that represents the
	...
	//                     then <i>nMenu</i> represents the resource ID of a pop-up
	//                     menu. Otherwise this value is ignored.
	//     nSubMenuIndx -  [in] Index of the submenu to display.
	// Remarks:
