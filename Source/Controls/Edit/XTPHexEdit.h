...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to return the current background color of
	//     the hex edit control. The current background color depends on the
	//     enabled, disabled, or read-only state of the control.
	// Returns:
	//     An RGB value that represents the current background color of the control.
	//-----------------------------------------------------------------------
	COLORREF GetActualBackColor();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to return the current text color of the hex
	//     edit control. The current text color depends on the enabled, disabled,
	//     or read-only state of the control.
	// Returns:
	//     An RGB value that represents the current text color of the control.
	//-----------------------------------------------------------------------
	...
	//     color of the hex edit control. The current highlight background color
	//     depends on the enabled, disabled, or read-only state of the control.
	// Returns:
	//     An RGB value that represents the current highlight background color
	//     of the control.
	//-----------------------------------------------------------------------
	...
	//     of the hex edit control. The current highlight text color depends
	//     on the enabled, disabled, or read-only state of the control.
	// Returns:
	//     An RGB value that represents the current highlight text color
	//     of the control.
	//-----------------------------------------------------------------------
	...
	//     control.
	// Parameters:
	//     crBack - An RGB value that represents the background color for
	...
	// Returns:
	//     An RGB value that represents the current background color of
	//     the hex edit control.
	//-----------------------------------------------------------------------
	...
	//     edit control.
	// Parameters:
	//     crText - An RGB value that represents the text color for the
	//              hex edit control.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the current text color of the
	//     hex edit control.
	// Returns:
	//     An RGB value that represents the current text color of
	//     the hex edit control.
	//-----------------------------------------------------------------------
	...
	//                               highlight text color for the hex edit control.
	//-----------------------------------------------------------------------
	...
	//                           highlight background color for the hex edit
	//                           control.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pFont - Pointer to a valid CFont object.
	//     pLogFont - Pointer to a valid LOGFONT structure.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function enables/disables a flashing screen caret.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function enables/disables a vertical and horizontal
	//     scrollbar display.
	// Parameters:
	//     bVertical   - true to display vertical scrollbar.
	//     bHorizontal - true to display horizontal scrollbar.
	//-----------------------------------------------------------------------
	...
	//     control.
	// Parameters:
	//     dwBase - A DWORD value that represents the base address.
	// Returns:
	//     A DWORD value.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to allow/disallow the deletion of characters
	//     within the control. For instance, calling SetAllowDeletes(false) will
	//     disable the delete, backspace, and other such keys.
	// Parameters:
	//     bVal - true to allow the deletion of characters within the control,
	//            false to disallow.
	// Returns:
	//     The previous value of the Allow Deletes setting.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     nSelStart - Reference to an integer that will receive the position of the first
	//                 character in the current selection.
	//     nSelEnd   - Reference to an integer that will receive the position of the first
	//                 non-selected character past the end of the current selection.
	// Returns:
	//     A CSize object.
	//-----------------------------------------------------------------------
	CSize GetSel();
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if the control is in a read-only state.
	// Returns:
	//     TRUE if the control is in a read-only state, otherwise FALSE.
	//-----------------------------------------------------------------------
	BOOL IsReadOnly() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called when the user changes text.
	//-----------------------------------------------------------------------
