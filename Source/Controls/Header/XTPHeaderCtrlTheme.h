...
//------------------------------------------------------------------------
// Summary:
//     CXTPHeaderCtrlTheme is a theme class used to draw a Windows classic style
//     theme for the header control.<p/>
// Remarks:
//     The CXTPHeaderCtrlTheme class provides theme capability to the CXTPHeaderCtrl
//     class. You can derive a class from CXTPHeaderCtrlTheme to create custom user
//     defined themes.<p/>
//
...
public:
	...
	// Remarks:
	//     Called by the CXTPHeaderCtrlTheme class to render the header for
	//     the CXTPHeaderCtrl object.
	//--------------------------------------------------------------------
	...
	// Parameters:
	//     pHeader - Pointer to the CXTPHeaderCtrl object.
	//--------------------------------------------------------------------
	...
	//
	//     * <b>HDR_XTP_WINDEF</b>: Allows the header control to display Windows XP
	//                              themes when they are available.
	//     * <b>HDR_XTP_HOTTRACKING</b>: Allows the header control to display mouse over
	//                                   effects for the header control.
	//     * <b>HDR_XTP_SORTARROW</b>: Allows the header control to display a sort arrow
...
protected:
	...
	//--------------------------------------------------------------------
	// Summary:
	//     This member function is called by the theme to draw the sort used to
	//     display the sort order for a header item specified by lpDIS->itemID.
	// Parameters:
	//     lpDIS      - A long pointer to a DRAWITEMSTRUCT structure. The
	//                  structure contains information about the item to be
	//                  drawn and the type of drawing required.
	...
	//     bAscending - TRUE if the arrow is to be drawn ascending.
	//--------------------------------------------------------------------
...
// Remarks:
//     The CXTPHeaderCtrlThemeOfficeXP class provides theme capability to the
//     CXTPHeaderCtrl class. You can derive a class from CXTPHeaderCtrlThemeOfficeXP
//     to create custom user-defined themes.<p/>
//
//     To use this class, first subclass your header control using the
//     Windows API SubclassWindow and a CXTPHeaderCtrl base class. Once
//     you have done this, you can call SetTheme and pass in a pointer to
...
//     CXTPHeaderCtrlThemeOffice2003 to create custom user-defined themes.<p/>
//
//     To use this class, first subclass your header control using the
//     Windows API SubclassWindow and a CXTPHeaderCtrl base class. Once
//     you have done this, you can call SetTheme and pass in a pointer to
...
//     control.<p/>
// Remarks:
//     The CXTPHeaderCtrlThemeExplorer class provides theme capability to the
//     CXTPHeaderCtrl class. You can derive a class from CXTPHeaderCtrlThemeExplorer
//     to create custom user-defined themes.<p/>
//
//     To use this class, first subclass your header control using the
//     Windows API SubclassWindow and a CXTPHeaderCtrl base class. Once
...
//     class used to draw a resource .dll style theme for the header
//     control.<p/>
// Remarks:
//     The CXTPHeaderCtrlThemeResource class provides theme capability to the
//     CXTPHeaderCtrl class. You can derive a class from CXTPHeaderCtrlThemeResource
//     to create custom user-defined themes.<p/>
//
//     To use this class, first subclass your header control using the
//     Windows API SubclassWindow and a CXTPHeaderCtrl base class. Once
