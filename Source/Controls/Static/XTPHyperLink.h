...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable ShellExecute to be called
	...
	// Returns:
	//     true if the URL has been visited, otherwise false.
	//-----------------------------------------------------------------------
	virtual bool GetVisited() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will set the cursor associated with the hyperlink
	//     control. The associated cursor will be displayed when the mouse hovers
	//     over the hyperlink control.
	// Parameters:
	...
	//     as underlined.
	// Parameters:
	//     bUnderline - A boolean flag that, when set to true, causes the control
	//                  to display the text as underlined. By default, this
	//                  parameter is 'true'.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     true if the hyperlink text is underlined, otherwise false.
	//-----------------------------------------------------------------------
	virtual bool GetUnderline() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will set the background fill color for the
	//     hyperlink control. By default, the hyperlink control uses the system
	//     color for COLOR_3DFACE.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will retrieve the current background fill color for
	//     the hyperlink control.
	// Returns:
	//     A COLORREF value representing the background fill color for the hyperlink
	//     control.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     lpszLink   - Pointer to a NULL-terminated string that represents the URL to
	//                  jump to. If NULL, then the default URL is activated.
	//     nShowCmd   - Display state for the shell command associated with the URL.
	//                  The default is SW_SHOW.
	//     lpszParams - Pointer to a NULL-terminated string that represents additional
	//                  parameters that are to be passed to the ShellExecute command.
	//     lpszDir    - Pointer to a NULL-terminated string that represents the default
	//                  directory.
	// Returns:
	...
	//     text control.
	// Returns:
	//     true if the hyperlink control is a text control, otherwise false.
	//-----------------------------------------------------------------------
	virtual bool IsTextControl();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable tooltips for the hyperlink
	//     control.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the tooltip text for the tooltip
	//     associated with the hyperlink control.
	// Parameters:
	//     lpszTipText - A NULL-terminated string that represents the new tooltip
	//                   text to display.
	//-----------------------------------------------------------------------
	...
	// Remarks:
	//     The hyperlink is hot when the mouse pointer is positioned over it.
	// Returns:
	//     true if the hyperlink is currently hot, otherwise false.
	//-----------------------------------------------------------------------
	virtual bool IsLinkHot();

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called by the CXTPHyperLink object to display
	//     a message box whenever an error occurs.
	// Parameters:
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called by the CXTPHyperLink class to perform
	...
	//     initialize the font to be used by the hyperlink control.
	// Returns:
	//     true if the font was successfully initialized, otherwise false.
	//-----------------------------------------------------------------------
	...
	// Summary:
	//     This member function is called by the CXTPHyperLink class to
	//     initialize a font to be used by the hyperlink control.
	// Parameters:
	//     font       - Reference to the font to be created.
	//     bUnderline - TRUE to create underlined font.
	// Returns:
...
protected:
	...
	CXTPFont m_xtpFont; // Font used by the hyperlink control.
