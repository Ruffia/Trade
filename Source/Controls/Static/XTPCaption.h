...
//---------------------------------------------------------------------------
// Summary:
//     CXTPCaptionButton is a CXTPButton derived class. It is used by the
//     CXTPCaption class to activate a CXTPCaptionPopupWnd window.
//---------------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPCaptionButton object.
	//-----------------------------------------------------------------------
	CXTPCaptionButton();

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to retrieve a pointer to the parent
	//     caption.
	// Returns:
	//     A pointer to a CXTPCaption object.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to set the pointer to the parent
	//     caption.
	// Parameters:
...
//---------------------------------------------------------------------------
// Summary:
//     CXTPCaption is a CStatic derived class. It is used to create captions
//     or info bars similar to those in Microsoft(r) Outlook.
//---------------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPCaption object, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPCaption();
...
public:
	...
	BOOL SetTheme(CXTPCaptionTheme* pTheme); // <combine CXTPCaption::SetTheme@XTPControlTheme>
	...
	//     theme.
	// Returns:
	//     A pointer to a CXTPCaptionTheme object representing the currently
	//     selected theme.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to determine if the caption is
	//     configured to be used as the application's primary caption.
	// Returns:
	//     true if the caption is configured to be used as the application's
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to set the flag that indicates
	//     if the caption is the application's primary caption.
	// Parameters:
	//     bAppCaption - true to set the flag to indicate that the caption
	//                   is the application's primary caption.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get a reference to the caption's
	//     close/pop-up button.
	// Returns:
	...
	// Parameters:
	//     b2003Colors - true to enable Office 2003 visualizations,
	//                   false to disable.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the current style settings
	//     for the caption.
	// Returns:
	...
	//     lpszWindText -  A NULL-terminated string specifying the new caption
	//                     text.
	...
	//     use, the caption text, and the icon to be displayed.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to destroy the pop-up window and
	//     associated children.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to display the pop-up window and
	//     associated children.
	// Returns:
	//     TRUE if the pop-up window is successfully displayed, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//     caption bar.
	// Parameters:
	//     lpszWindowText - A NULL-terminated string to display in the caption bar.
	//     hIcon          - Handle of the icon to display in the caption bar.
	//                      It can be NULL.
	//-----------------------------------------------------------------------
	...
	//     lpszWindowName -  Pointer to a NULL-terminated character string that contains
	...
	//     * <b>CPWS_EX_GROOVE_EDGE</b>: Show the caption with a sunken border.
	//     * <b>CPWS_EX_RAISED_EDGE</b>: Show the caption with a raised 3D border.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to refresh the caption button style.
	//-----------------------------------------------------------------------
	void RefreshButton();
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to see if the caption contains a close button.
	// Returns:
	...
	// Returns:
	//     The size and location of the caption text, or an empty rect if
	//     no text is defined.
	//-----------------------------------------------------------------------
...
protected:
	...
	CWnd* m_pChildWnd;	// A CWnd pointer that represents the child window displayed in the pop-up
						  // window.
	...
	CRect m_rcChild;	  // Size of the child window displayed in the pop-up.
	...
	CXTPCaptionButton m_btnCaption;   // Button used to 'tack' the pop-up window back in place.
	CXTPCaptionPopupWnd* m_pPopupWnd; // Pointer to the pop-up window.
