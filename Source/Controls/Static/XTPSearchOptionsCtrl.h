...
//
//     Use with the CXTPSearchOptionsView form view class to create a pane
//     similar to the Windows Explorer search pane. To use the control, define
//     a set of controls that are to be hidden and moved depending on the
...
public:
	...
	// Parameters:
	//     pWndCtrl - Pointer to a valid CWnd object.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     lpszExpand   - A NULL-terminated string that represents the text displayed
	//                    when the control is expanded.
	//     lpszContract - A NULL-terminated string that represents the text displayed
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     When you create an object of a type derived from CXTPSearchOptionsView,
	//     invoke one of the constructors to create the view object and identify the
	//     dialog resource on which the view is based. You can identify the resource
	//     either by name (pass a string as the argument to the constructor) or by
	//     its ID (pass an unsigned integer as the argument).
	// Parameters:
	...
	CXTPSearchOptionsView(
		LPCTSTR lpszTemplateName); // <combine CXTPSearchOptionsView::CXTPSearchOptionsView@UINT>
...
protected:
	...
	//     then the left and top sides should not move, and the right and
	//     bottom sides should move by the same amount of pixels as the dialog.
	// Parameters:
	//     nID        - Specifies the control's ID.
	//     ptTopLeft  - How much the top and left sides will move when the dialog
	//                  is resized.
	//     ptTopRight - How much the bottom and right sides will move when the dialog
	//                  is resized.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pSOCtrl - Pointer to the CXTPSearchOpetionsCtrl object to adjust the scroll
	//               sizes for.
	//     bAdd    - true to add the size, false to subtract the size.
	//-----------------------------------------------------------------------
...
protected:
	...
	XTP_SUBSTITUTE_GDI_MEMBER_WITH_CACHED_(HBRUSH, HBRUSH, HBRUSH, m_hBrush, m_xtpBrush,
										   GetBrushHandle);
