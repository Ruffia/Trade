...
// --------------------------------------------------------------------------
// Summary:
//     Represents a STATIC control with the ability to render markup content.
// --------------------------------------------------------------------------
...
public:
	// ----------------------------------------------------------------------
	// Summary:
	//     Sets the Markup content to draw.
	// Parameters:
	//     lpszMarkup - Markup content to draw.
	// ----------------------------------------------------------------------
	...
	// ----------------------------------------------------------------------
	// Summary:
	//     Special version used by the Ribbon Customize dialog and will
	//     handle % to load a string from a resouce.
	// Parameters:
	//     lpszMarkup - Markup text.
	//     nCodePage - Optional code page. Default value is CP_UTF8. Ignored if
	//                 the markup charset is the same as the building charset.
	// ----------------------------------------------------------------------
	...
	// ----------------------------------------------------------------------
	// Summary:
	//     Obtains the control's markup context.
	// Returns:
	//     A pointer to the control's markup context.
	// ----------------------------------------------------------------------
	CXTPMarkupContext* GetMarkupContext() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Obtains the UI element of the control.
	// Returns:
	//     A pointer to the UI element of the control.
	//-----------------------------------------------------------------------
	CXTPMarkupUIElement* GetUIElement() const;

	void SetIgnoreRTL(BOOL value);
...
AFX_INLINE CXTPMarkupUIElement* CXTPMarkupStatic::GetUIElement() const
{
	return m_pUIElement;
}
AFX_INLINE void CXTPMarkupStatic::SetIgnoreRTL(BOOL value)
{
	m_bIgnoreRTL = value;
}
