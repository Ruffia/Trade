...
//===========================================================================
// Summary:
//     Class CXTPCaptionButtonThemeOfficeXP is a CXTPButtonOfficeXPTheme
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Default class constructor. Call this member function to
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to draw the background of the button caption.
	// Parameters:
	//     pDC - A pointer to the target device context.
	//     pButton - A pointer to a valid CXTPButton object.
	// Returns:
	//     TRUE if the background was successfully drawn, otherwise FALSE.
	//-----------------------------------------------------------------------
