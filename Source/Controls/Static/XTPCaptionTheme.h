...
//===========================================================================
// Summary:
//     CXTPCaptionTheme is a CXTPControlTheme derived class used to control
//     caption themes. Custom themes may be derived from this class.
//===========================================================================
...
public:
	...
	// Remarks:
	//     pCaption - Pointer to the CXTPCaption object.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPCaptionThemeOfficeXP is derived from CXTPCaptionTheme.
//     It is used to set the caption to an Office XP theme.
//===========================================================================
...
protected:
	...
	//                context.
	//     pCaption - A pointer to a CXTPCaption object.
	//     rcItem   - CRect object with the size and location where the
	//                caption is drawn.
	//-----------------------------------------------------------------------
	virtual void DrawCaptionBack(CDC* pDC, CXTPCaption* pCaption, CRect& rcItem);
};
...
//     It is used to set the caption to an Office 2003 theme.
//===========================================================================
...
//===========================================================================
// Summary:
//     CXTPCaptionButtonTheme is derived from CXTPButtonTheme.
//     This class is used to set the caption for buttons.
//===========================================================================
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to draw the button caption text.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get the text color of the button caption.
	// Parameters:
	//     pButton - A pointer to a valid CXTPButton object.
	// Returns:
	...
	// Parameters:
	//     pDC - A pointer to the target device context.
	//     pButton - A pointer to a CXTPButton object.
	// Returns:
