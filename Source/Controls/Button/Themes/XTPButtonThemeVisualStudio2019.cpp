// XTPButtonThemeVisualStudio2019.cpp: implementation of the CXTPButtonThemeVisualStudio2019 class.
//
...
CXTPButtonThemeVisualStudio2019::CXTPButtonThemeVisualStudio2019()
{
	m_nTheme = xtpControlThemeVisualStudio2019;
}

void CXTPButtonThemeVisualStudio2019::RefreshMetrics(CXTPButton* pButton)
{
	UNREFERENCED_PARAMETER(pButton);

	m_themeButton->OpenThemeData(NULL, m_bToolbarStyle ? L"TOOLBAR" : L"BUTTON");

	// Defaults are set to VISUALSTUDIO2019LIGHT_INI colors.
