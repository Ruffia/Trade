...
//===========================================================================
// Summary:
//     CXTPButtonThemeVisualStudio2012 is a class used to perform
//     Visual Studio 2012 theme drawing tasks.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the color used to draw
	//     the button text.
	// Parameters:
	//     pButton - Pointer to a CXTPButton object.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to draw the background for
	//     the button control.
	// Parameters:
	//     pDC     - Pointer to a valid device context.
	//     pButton - Pointer to the CXTPButton to draw the background for.
	//-----------------------------------------------------------------------
