// XTPButtonThemeVisualStudio2017.cpp: implementation of the CXTPButtonThemeVisualStudio2017 class.
//
...
CXTPButtonThemeVisualStudio2017::CXTPButtonThemeVisualStudio2017()
{
	m_nTheme = xtpControlThemeVisualStudio2017;
}

void CXTPButtonThemeVisualStudio2017::RefreshMetrics(CXTPButton* pButton)
{
	UNREFERENCED_PARAMETER(pButton);

	m_themeButton->OpenThemeData(NULL, m_bToolbarStyle ? L"TOOLBAR" : L"BUTTON");

	// Defaults are set to VISUALSTUDIO2017LIGHT_INI colors.
