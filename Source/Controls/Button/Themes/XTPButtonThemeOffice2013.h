...
//===========================================================================
// Summary:
//     CXTPButtonThemeOffice2013 is a class used to perform
//     Office 2013 theme drawing tasks.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the color used to draw the button text.
	// Parameters:
	//     pButton - Pointer to a CXTPButton object.
	// Returns:
	...
	virtual void DrawPushButtonDropDown(
		CDC* pDC,
		CXTPButton* pButton); // <combine
							  // CXTPButtonThemeOffice2013::DrawPushButtonIcon@CDC*@CXTPButton*>
