// XTPButtonThemeVisualStudio2022.cpp: implementation of the CXTPButtonThemeVisualStudio2022 class.
//
...
CXTPButtonThemeVisualStudio2022::CXTPButtonThemeVisualStudio2022()
{
	m_nTheme = xtpControlThemeVisualStudio2022;
}

void CXTPButtonThemeVisualStudio2022::RefreshMetrics(CXTPButton* pButton)
{
	UNREFERENCED_PARAMETER(pButton);

	m_themeButton->OpenThemeData(NULL, m_bToolbarStyle ? L"TOOLBAR" : L"BUTTON");

	// Defaults are set to VISUALSTUDIO2022LIGHT_INI colors.
