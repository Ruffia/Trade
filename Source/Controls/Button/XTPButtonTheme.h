...
//===========================================================================
// Summary:
//     CXTPButtonTheme is a class used to perform Button Theme drawing tasks.
//     This is the base class for all button themes.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPButtonTheme object, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to draw the focus rectangle for the button.
	// Parameters:
	//     pDC     - A CDC pointer that represents the current device context.
	//     pButton - Pointer to a CXTPButton object.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function draws the icon/dropdown for the button, if one has been defined.
	// Parameters:
	//     pDC     - A CDC pointer that represents the current device context.
	//     pButton - Pointer to a CXTPButton object.
	//-----------------------------------------------------------------------
	virtual void DrawPushButtonIcon(CDC* pDC, CXTPButton* pButton);
	virtual void DrawPushButtonDropDown(
		CDC* pDC,
		CXTPButton* pButton); // <combine CXTPButtonTheme::DrawPushButtonIcon@CDC*@CXTPButton*>

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to return the color used to draw the button text.
	// Parameters:
	//     pButton - Pointer to a CXTPButton object.
	// Returns:
	...
	void CalcRects(CDC* pDC, CXTPButton* pButton, CRect* pButtonText, UINT* pDrawFlags,
				   CRect* pButtonIcon);
	...
	void EnableToolbarStyle(BOOL bEnable)
	{
		m_bToolbarStyle = bEnable;
	}
