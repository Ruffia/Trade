...
//     used for storing single-precision floating point
...
// Example:
//     The following example demonstrates alternate ways to initialize
//     an XTP_RESIZERECT structure:
// <code>
// XTP_RESIZERECT rc1;
// rc1.left = 20;
// rc1.top = 30;
...
public:
	...
	//     CXTPResizeRect.
	// Parameters:
	//     rrc - Pointer to an XTP_RESIZERECT structure or a CXTPResizeRect object that
	...
	// Parameters:
	//     rrc - Refers to a source rectangle. It can be an XTP_RESIZERECT or a
	//           CXTPResizeRect.
	// Returns:
