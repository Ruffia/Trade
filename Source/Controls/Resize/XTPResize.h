...
//===========================================================================
// Summary:
//     CXTPResizeItem is a standalone helper class. It is used by CXTPResize to
...
public:
	...
	//     transparent.
	// Parameters:
	//     pXTPResize - Pointer to the resize manager.
	// Returns:
...
//     sheets, and form views. It acts as a manager to maintain the size and location
...
public:
	...
	// Parameters:
	//     pWnd   - Pointer to the parent or owner window object, of type CWnd,
	//              to which the resizing object belongs.
	//     nFlags - Flags that are to be passed to CXTPResize that specify the
	//              attributes of the resizing property page. See the Remarks
...
public:
	...
	// Parameters:
	//     nID           - Specifies the control's ID.
	//     rrcSizing     - How much the left, top, right, and bottom sides will move
	...
	//     sides should move by the same amount of pixels as the dialog.
	// Parameters:
	//     nID           - Specifies the control's ID, or 0 to use control's handle
	//                     value only.
	...
	//                     value only.
	//     hWnd          - HWND of the dialog item to be sized.
	//     rpTopLeft     - How much the top and left sides will move when the dialog
	//                     is resized.
	//     rpBottomRight - How much the bottom and right sides will move when the dialog
	//                     is resized.
	//-----------------------------------------------------------------------
...
protected:
	...
	//     sides should move by the same amount of pixels as the dialog.
	// Parameters:
	//     pWnd          - Pointer to the dialog item to be resized.
	//     hWnd          - HWND of the dialog item to be sized.
	//     rrcSizing     - How much the left, top, right, and bottom sides will move
	//                     when the dialog is resized.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to purge the list that contains the dialog
	//     items to be sized.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     ptOffset - CPoint determines the amount, in pixels, to offset
	//                dialog items.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to reset m_rrcWindow for an item.
	// Parameters:
	...
	// Parameters:
	//     pMMI - Pointer to a MINMAXINFO structure that contains information about a
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called in the Size method to adjust a window rectangle to
	//     fit real client size.
	// Parameters:
...
protected: // helper methods
	...
	// Parameters:
	//     hdwp     - [in] Handle to a multiple-window position structure that contains
	//                size and position information for one or more windows. This
	//                structure is returned by BeginDeferWindowPos or by the most recent
	//                call to DeferWindowPos.
	//     pItem    - [in] Pointer to a CXTPResizeItem object that contains additional
	//                information about the window being sized.
...
protected:
	...
	UINT m_nFlagsXX;			 // Flags passed from the constructor.
