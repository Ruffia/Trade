...
public:
	...
	//     pszCaption  - Pointer to a string containing the caption to be used
	//                   for the property sheet. It cannot be NULL.
	//     pParent     - Pointer to the parent window of the property sheet. If
	//                   NULL, then the parent window will be the main window of
	//                   the application.
	...
	//                   or more of the values in the Remarks section.
	// Remarks:
...
protected:
	...
	// Returns:
	//     TRUE if the property sheet is in wizard mode, otherwise FALSE.
	//----------------------------------------------------------------------
	BOOL IsWizard();
