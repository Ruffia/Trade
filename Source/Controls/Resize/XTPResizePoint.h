...
//---------------------------------------------------------------------------
// Summary:
//     The XTP_RESIZEPOINT structure is used by the CXTPResizePoint
//     class for defining single-precision floating point
...
//     XTP_RESIZEPOINT structures. A CXTPResizePoint object can be used
//     wherever an XTP_RESIZEPOINT structure is used.
//===========================================================================
