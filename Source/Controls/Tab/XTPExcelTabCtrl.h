...
public:
	...
	// Returns:
	//     A pointer to a CXTPExcelTabCtrlTheme object representing the currently
	//     selected theme.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a reference to the tab item array.
	// Returns:
	//     A reference to a CTabItemArray object used for maintaining the list
	//     of tabs for the tab control.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will set the text for a particular tab.
	// Parameters:
	...
	// Returns:
	//     A pointer to the window that is associated with a tab, or NULL
	...
	//     lpszItem -     A NULL-terminated string that represents the tab label.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will remove all tabs from the tab control.
	// Returns:
	//     TRUE if successful, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//     lpRect - Pointer to a RECT structure to receive the size of the tab.
	// Returns:
	//     TRUE if successful, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     The zero-based index of the tab, or -1 if no tab is at the
	//     specified position.
	//-----------------------------------------------------------------------
	...
	//     tab control.
	// Returns:
	//     The zero-based index of the selected tab if successful, or
	...
	// Returns:
	//     The zero-based index of the previously selected tab if successful,
	//     otherwise -1.
	//-----------------------------------------------------------------------
	...
	//     by 'nItem'.
	// Parameters:
	//     nItem      - The zero-based index of the tab to receive the tooltip text.
	...
	//     The function has no effect if FTS_XTP_HSCROLL is not used.
	// Parameters:
	//     nPos     - The position for the gripper, relative to the left-hand
	//                side of the control.
	//     bPercent - Indicates that the position is a percent of the control
	//                width, as opposed to an absolute location in pixels.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Synchronizes the scrollbar with the horizontal scroll position.
	// Remarks:
	//     Call this function to synchronize the tab control's horizontal
	//     scrollbar with the horizontal scrollbar of the current view.
	//
	//     This function should be called if anything happens in the view
	//     that affects the horizontal scroll bar (e.g., a user typing text
	//     into an edit control could make the text wider, thus requiring
	...
	// Parameters:
	//     crShadow - An RGB value that represents the tab shadow color.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     crHighlight - An RGB value that represents the tab highlight color.
	//-----------------------------------------------------------------------
	void SetTabHighlightColor(COLORREF crHighlight);

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(SetTabHighlightColor)
	void SetTabHilightColor(COLORREF crHighlight)
	{
		SetTabHighlightColor(crHighlight);
	}
	//}}AFX_CODEJOCK_PRIVATE
	...
	//-----------------------------------------------------------------------
	COLORREF GetTabHighlightColor() const;

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(GetTabHighlightColor)
	COLORREF GetTabHilightColor() const
	{
		return GetTabHighlightColor();
	}
	//}}AFX_CODEJOCK_PRIVATE
	...
	//     for all tabs. If nIndex is specified, then the color is only set for
	//     the tab located at 'nIndex'.
	// Parameters:
	//     crBack - An RGB value that represents the tab background color.
	//     nIndex - The index of the tab to set the background color for.
	//-----------------------------------------------------------------------
	...
	//     color of the tab.
	// Parameters:
	//     nIndex - The index of the tab to get the background color for.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to set the default text color for
	//     all tabs. If nIndex is specified, then the color is only set for
	//     the tab located at 'nIndex'.
	// Parameters:
	//     crText - An RGB value that represents the tab text color.
	//     nIndex - The index of the tab to set the text color for.
	//-----------------------------------------------------------------------
	...
	//     the tab located at 'nIndex'.
	// Parameters:
	//     crBack - An RGB value that represents the selected tab background color.
	//     nIndex - The index of the tab to set the selected background color for.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     nIndex - The index of the tab to get the selected background color for.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to set the selected text color for
	//     all tabs. If nIndex is specified, then the color is only set for
	//     the tab located at 'nIndex'.
	// Parameters:
	//     crText - An RGB value that represents the selected tab text color.
	//     nIndex - The index of the tab to set the selected text color for.
	//-----------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// Summary:
	//     This method obtains a pointer to the specified sibling scrollbar for
	//     the flat tab control.
	// Parameters:
	//     nBar -  Specifies the type of scrollbar. The parameter can take one
	//             of the values specified in the Remarks section.
	// Remarks:
	//     The scrollbar type can be one of the following values:
	//     * SB_HORZ: Retrieves the position of the horizontal scrollbar.
	//     * SB_VERT: Retrieves the position of the vertical scrollbar.
	// -------------------------------------------------------------------------
	...
	// Parameters:
	//     bBold - TRUE to retrieve the bold font.
	// Remarks:
	...
	// Parameters:
	//     dwStyle -  Value specifying a combination of flat tab control
	//                FTS_XTP_ styles.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Creates a flat tab control and attaches it to an instance of a
	//     CXTPExcelTabCtrl object.
	// Parameters:
	...
	//     * <b>FTS_XTP_HSCROLL</b>:    Show a horizontal scrollbar.
	...
	//
	//     * <b>WS_CHILD</b>:    Creates a child window that represents the tab
	//                           control. Cannot be used with the WS_POPUP style.
	//     * <b>WS_VISIBLE</b>:  Creates a tab control that is initially visible.
	//     * <b>WS_DISABLED</b>: Creates a window that is initially disabled.
	//     * <b>WS_GROUP</b>:    Specifies the first control of a group of controls
	//                           in which the user can move from one control to the
	//                           next with the arrow keys. All controls defined with
	//                           the WS_GROUP style after the first control belong
	//                           to the same group. The next control with the WS_GROUP
	//                           style ends the style group and starts the next group
	//                           (that is, one group ends where the next begins).
	//     * <b>WS_TABSTOP</b>:  Specifies one of any number of controls through which
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will calculate the total width of all the tabs
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will calculate the total width of all the arrow
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will calculate the total area width of all the
	...
	// Parameters:
	//     bTracking - true to enable tracking, false to disable.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to remove the highlight from all of the
	//     buttons.
	//-----------------------------------------------------------------------
	void ResetMouseOver();
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get the dimensions of the rectangle
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to refresh theme colors and redraw the
	//     control.
	//-----------------------------------------------------------------------
...
protected:
	...
	CRect m_rectSB_H;	  // Area occupied by the horizontal scrollbar.
	...
	CXTPScrollBar m_wndHScrollBar; // The horizontal scrollbar (used with FTS_XTP_HSCROLL).
