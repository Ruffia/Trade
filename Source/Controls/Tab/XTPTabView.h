...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a reference pointer to the
	//     CTabCtrl object associated with this view.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to assign an image list to the tab control
	//     associated with this view.
	// Parameters:
	//     pImageList - A pointer to the image list to be assigned to the
	//                  tab control.
	// Returns:
	//     A pointer to the previous image list, or NULL if there is no
	//     previous image list.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     pWndTip - A pointer to a tooltip control.
	//-----------------------------------------------------------------------
	virtual void SetToolTips(CToolTipCtrl* pWndTip);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to update the document name with the tab label.
	//-----------------------------------------------------------------------
	void UpdateDocTitle();
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called by the CXTPTabView class to perform
