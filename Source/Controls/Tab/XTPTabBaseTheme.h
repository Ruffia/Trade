...
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTabBaseTheme object.
	//-------------------------------------------------------------------------
	CXTPTabBaseTheme();
...
public:
	...
	// Parameters:
	//     pTab - Pointer to a CTabCtrl object.
	//-------------------------------------------------------------------------
	...
	//                context.
	//     pTabCtrl - A pointer to a CXTPTabBase object.
	//-----------------------------------------------------------------------
	virtual void DrawTabCtrl(CDC* pDC, CXTPTabBase* pTabCtrl);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get the current background color
	//     for the theme.
	// Returns:
	//     A CXTPPaintManagerColor object that contains the value for the
	...
	// Parameters:
	//     pTabCtrl - A pointer to a CXTPTabBase object.
	//     pMember  - A pointer to a CXTPTcbItem struct that contains information
	//                about the tab.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw navigate buttons.
	// Parameters:
	//     pDC      - A CDC pointer that represents the current device
	//                context.
	//     pButtons - A pointer to a collection of buttons to draw.
	// Returns:
	//     An RGB value that represents the background of the buttons.
	//-----------------------------------------------------------------------
...
protected:
	...
	//     rcClient - A CRect object that contains the location and dimensions
	//                of the tab control.
	// See Also:
	...
	// Parameters:
	//     pDC          - A pointer to a valid device context.
	//     pTabCtrlBase - A pointer to a CXTPTabBase object.
	//     rcHeader     - A CRect object that contains the location and dimensions
	//                    of the header.
	// See Also:
	...
	// Parameters:
	//     pDC       - A pointer to a valid device context.
	//     pTabCtrl  - A pointer to a CTabCtrl object. This is the associated
	//                 TabControl object.
	//     rcItem    - A CRect object that contains the location and dimensions
	//                 of the tab.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to draw the tab face.
	// Parameters:
	//     pDC       - A pointer to a valid device context.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to draw a tab on the tab control.
	// Parameters:
	//     pDC          - A pointer to a valid device context.
	...
	// See Also:
	//     CXTPTabBaseThemeOfficeXP::FillTabFace, CXTPTabBaseThemeOffice2003::FillTabFace,
	//     DrawTab, DrawTabText, FillTabFace, FillTabFaceNativeWinXP,
	...
	// Parameters:
	//     pDC - A pointer to a valid device context.
	//     r   - A CRect object that contains the location and dimensions
	//           of the child window.
	// See Also:
	...
	//     on the left side of the tab control.
	// Parameters:
	//     dwStyle - A DWORD value that represents the current tab style.
	// Returns:
	//     A BOOL. TRUE if the tabs are drawn on the left side of the tab
	...
	// Summary:
	//     This member function is called to determine if the tabs are drawn
	//     on the right side of the tab control.
	// Parameters:
	//     dwStyle - A DWORD value that represents the current tab style.
	// Returns:
	//     A BOOL. TRUE if the tabs are drawn on the right side of the tab
	//     control, otherwise FALSE.
	// See Also:
	...
	// Summary:
	//     This member function is called to determine if the tabs are drawn
	//     on the top of the tab control.
	// Parameters:
	//     dwStyle - A DWORD value that represents the current tab style.
	// Returns:
	//     A BOOL. TRUE if the tabs are drawn on the top of the tab control,
	//     otherwise FALSE.
	// See Also:
	...
	// Summary:
	//     This member function is called to determine if the tabs are drawn
	//     on the bottom of the tab control.
	// Parameters:
	//     dwStyle - A DWORD value that represents the current tab style.
	// Returns:
	//     A BOOL. TRUE if the tabs are drawn on the bottom of the tab control,
	//     otherwise FALSE.
	// See Also:
	...
	// Summary:
	//     This member function is called to determine if the tabs are drawn
	//     vertically on the tab control.
	// Parameters:
	//     dwStyle - A DWORD value that represents the current tab style.
	// Returns:
	//     A BOOL. TRUE if the tabs are drawn vertically on the tab control,
	//     otherwise FALSE.
	// See Also:
	...
	// Summary:
	//     This member function is called to determine if the tabs are drawn
	//     horizontally on the tab control.
	// Parameters:
	//     dwStyle - A DWORD value that represents the current tab style.
	// Returns:
	//     A BOOL. TRUE if the tabs are drawn horizontally on the tab control,
	//     otherwise FALSE.
	// See Also:
...
//     This class is used to implement an Office XP theme for the tab controls.
//===========================================================================
...
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTabBaseThemeOfficeXP object.
	//-------------------------------------------------------------------------
...
public:
	...
	//     COLOR_3DHIGHLIGHT, COLOR_3DFACE, and COLOR_3DSHADOW. Finally, the
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member is called to draw a single button of a tab control.
	// Parameters:
	//     pDC       - A CDC pointer that represents the current device
	//                 context.
	//     pButton   - A pointer to a CXTPTabCtrlButton object.
...
public:
	//-------------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTabBaseThemeOffice2003 object.
	//-------------------------------------------------------------------------
