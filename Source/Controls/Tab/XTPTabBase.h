...
public:
	...
	// Parameters:
	//     dwFlags - The value can be one or more of the values listed in the
	//               Remarks section.
	// Remarks:
...
protected:
	...
	// Parameters:
	//     pTabCtrl - Pointer to a valid tab control object.
	//-----------------------------------------------------------------------
...
public:
	...
	//     iIconIndex - Icon index for the tab. If -1, then 'iIndex' is used to
	//                  determine the index.
	...
	//     iIndex     - Tab index of where to insert the new view. By default,
	...
	//     pView - Pointer to the CWnd object associated with the tab.
	//     pViewClass - CView runtime class associated with the tab.
	...
	// Parameters:
	//     bEnable - TRUE to enable auto-condense mode, FALSE to disable.
	//-----------------------------------------------------------------------
...
protected:
	...
	//     lpszLabel - A NULL-terminated string that represents the new tab label.
	// Returns:
	//     TRUE if successful, otherwise FALSE.
	//-----------------------------------------------------------------------
