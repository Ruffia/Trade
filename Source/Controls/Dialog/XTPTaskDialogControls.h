...
public:
	//===========================================================================
	// Summary:
	//     LINKITEM is used to set and retrieve information about a link item.
	// See Also:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPTaskDialogLinkCtrl object, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
...
#	endif
	...
	// ---------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the focus to a specified link.
	// Parameters:
	//     iFocusItem - The index of the focused item or -1 to indicate no focus.
	// ---------------------------------------------------------------------
	...
	// Returns:
	//     A LINKITEM pointer if successful, otherwise NULL.
	//-----------------------------------------------------------------------
	LINKITEM* HitTest(CPoint pt) const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to retrieve the character index of
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the background color for the link control.
	// Parameters:
	//     crBack - An RGB value representing the link control's background color.
	//-----------------------------------------------------------------------
	void SetBackColor(COLORREF crBack);
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the link control's background color.
	// Returns:
	//     An RGB value representing the link control's background color.
	//-----------------------------------------------------------------------
	COLORREF GetBackColor() const;
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the text color for the link control.
	// Parameters:
	//     crText - An RGB value representing the link control's text color.
	//-----------------------------------------------------------------------
	void SetTextColor(COLORREF crText);
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the link control's text color.
	// Returns:
	//     An RGB value representing the link control's text color.
	//-----------------------------------------------------------------------
	COLORREF GetTextColor() const;
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the text link color for the link control.
	// Parameters:
	//     crTextLink - An RGB value representing the link control's text link color.
	//-----------------------------------------------------------------------
	void SetTextLinkColor(COLORREF crTextLink);
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the link control's text link color.
	// Returns:
	//     An RGB value representing the link control's text link color.
	//-----------------------------------------------------------------------
