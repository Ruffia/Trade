...
public:
	...
	// Parameters:
	//     bSetClipboard - TRUE to enable setting the RGB color value
	...
	// Parameters:
	//     bShowPreview - TRUE to enable the display for the color preview window.
	//-----------------------------------------------------------------------
...
protected:
	...
	// Parameters:
	//     pDC - Pointer to a valid device context for the eye dropper window.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     lpszClipText - A NULL-terminated string representing the current
	//                    RGB color value.
	// Returns:
	//     TRUE if successful, otherwise FALSE.
	//-----------------------------------------------------------------------
...
public:
	...
	//     dwFlags    - Style for color dialog.
