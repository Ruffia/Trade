...
public:
	...
	//                   is set to "tips.txt".
	//     pParent     - Pointer to the parent window for the Tip Of The Day Dialog.
	//-----------------------------------------------------------------------
...
public:
	...
	// Parameters:
	//     pFontTitle - Pointer to a CFont object that represents the new
	//                  font to be used for the "Did you know..." text.
	//     pFontTip   - Pointer to a CFont object that represents the new
	...
	// Parameters:
	//     lpszText - A NULL-terminated string that represents the new tip text
	//                to display.
	// -----------------------------------------------------------------------
