...
//===========================================================================
// Summary:
//     CXTPPropertyPage is a CPropertyPage derived class. Objects of class
//     CPropertyPage represent individual pages of a property sheet.
// See Also:
//     CXTPPropertySheet, CXTPPropertySheet::DoModal, CXTPPropertyPageNavigator
//===========================================================================
class _XTP_EXT_CLASS CXTPPropertyPage
...
public:
	...
	//     lpszTemplateName - Pointer to a string containing the name of the
	//                        template for this page. Cannot be NULL.
	//     nIDCaption - ID of the name to be placed in the tab for this page.
	//                  If 0, then the name will be taken from the dialog
	...
	//     The string contained in the first parameter will be placed in the
	//     caption bar for the property sheet.
	//-----------------------------------------------------------------------
	CXTPPropertyPage();
	CXTPPropertyPage(UINT nIDTemplate,
					 UINT nIDCaption = 0); // <combine CXTPPropertyPage::CXTPPropertyPage>
	CXTPPropertyPage(LPCTSTR lpszTemplateName,
					 UINT nIDCaption = 0); // <combine CXTPPropertyPage::CXTPPropertyPage>
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the caption text used for property sheet tabs.
	// Returns:
	//     The caption text used for property sheet tabs.
	//-----------------------------------------------------------------------
	CString GetCaption() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the caption text used to draw property sheet tabs.
	// Parameters:
	//     lpszCaption - New caption text to be set.
	//-----------------------------------------------------------------------
	void SetCaption(LPCTSTR lpszCaption);

	//-----------------------------------------------------------------------
	// Summary:
	//     Forces a page to update its internal data as this data is
	//     supposed to be changed from outside the page.
	//-----------------------------------------------------------------------
...
protected:
	...
	virtual BOOL LoadTemplate();
	virtual BOOL LoadTemplate(HGLOBAL& hTemplate, HINSTANCE& hInst);
