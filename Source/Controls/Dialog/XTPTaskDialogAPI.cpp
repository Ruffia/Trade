...
_XTP_EXT_CLASS BOOL AFXAPI XTPCalcTextSize(const CString& strText, CSize& sizeText, CFont& font,
										   BOOL* pbWordWrap /*=NULL*/)
{
	...
	if (dc.DrawText(strText, &rectText, DT_CALCRECT | DT_LEFT | DT_NOPREFIX | DT_TOP | DT_WORDBREAK)
		!= 0)
	{
...
_XTP_EXT_CLASS BOOL AFXAPI XTPCalcIdealTextSize(const CString& strText, CSize& sizeText,
												CFont& font, int dluMax /*=xtpDluMax*/,
												int dluGrow /*=xtpDluAdd*/)
{
	if (strText.IsEmpty() || font.m_hObject == NULL)
		return FALSE;
...
_XTP_EXT_CLASS BOOL AFXAPI XTPCalcIdealTextSize(CXTPMarkupContext* pMarkupContext,
												CXTPMarkupUIElement* pUIElement, CSize& sizeText,
												CFont& font, int dluMax /*=xtpDluMax*/,
												int dluGrow /*=xtpDluAdd*/)
{
...
_XTP_EXT_CLASS CString AFXAPI XTPExtractSubString(CString strFullString, int iSubString)
{
	...
	return ((iSubString == 0) ? strFullString : CString());
}
