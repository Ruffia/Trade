...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will enable/disable editing.
	// Parameters:
	//     bEnable - true to enable editing, false to disable editing.
	//-----------------------------------------------------------------------
	...
	//     render a text display for the control.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sends a notification to the owner window.
	// Parameters:
...
protected:
	bool m_bShowUpDownButtons;	// Controls whether or not the up/down buttons are shown.
	bool m_bShowNewDeleteButtons; // Controls whether or not the new/delete buttons are shown.
...
public:
	...
	//                  if you do not wish for the caption edit navigation control
	//                  bar to be displayed.
	// Remarks:
	...
	// --------------------------------------------------------------------
	// Summary:
	//     This method is called to set in-place edit text.
	// Parameters:
	...
	// --------------------------------------------------------------------
	// Summary:
	//     Retrieves a pointer to the CXTPEditListBoxToolBar toolbar.
	// Returns:
	//     A reference to a CXTPEditListBoxToolBar object.
	// Remarks:
	//     Call this member function to return a reference to the
	//     CXTPEditListBoxToolBar control associated with the edit list box.
	// --------------------------------------------------------------------
	...
	//     file dialog.
	// Parameters:
	//     lpszFilter - Pointwe to a NULL-terminated string that represents
	...
	// Parameters:
	//     lpszInitialDir -  [in] Pointer to a NULL-terminated string that represents
	//                       the initial directory of the file open dialog.
	// --------------------------------------------------------------------------
	...
	// Returns:
	//     true if the toolbar is turned on, otherwise false.
	//-----------------------------------------------------------------------
	bool HasToolbar();
	...
	//     box toolbar. This will readjust the layout correctly and
	...
	// Parameters:
	//     lpszItemDefaultText - A NULL-terminated string.
	// Remarks:
...
protected:
	...
	//     selected list box item. If 'bNewItem' is TRUE, then a new
	//     item is added to the end of the list box.
	// ----------------------------------------------------------------------
...
#	endif
	...
	// ----------------------------------------------------------------------
	// Summary:
	//     This method is called to create an in-place edit control.
	// Parameters:
...
protected:
	...
	CXTPItemEdit* m_pItemEdit;			// Pointer to the in-place edit item.
