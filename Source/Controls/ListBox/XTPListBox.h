...
//===========================================================================
// Summary:
//     Constants used by the CXTPListBox control to determine the current
...
enum XTPListBoxStyle
{
	...
	xtpListBoxVisualStudio2017,					 // Visual Studio 2017 style theme.
	xtpListBoxVisualStudio2019,					 // Visual Studio 2019 style theme.
	xtpListBoxVisualStudio2022,					 // Visual Studio 2022 style theme.
	xtpListBoxNativeWindows10					 // Native Windows 10 style theme.
};
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw text for the CXTPListBox object.
	// Parameters:
	//     pDC      - Pointer to a valid device context.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to retrieve the background color for the list box.
	// Returns:
	//     An RGB value representing the background color.
	//-----------------------------------------------------------------------
	virtual COLORREF GetBackColor();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to draw the list control borders.
	// Parameters:
	//     pDC - Pointer to a valid device context.
	//     rc  - Size of the area to draw.
	// Returns:
	//     TRUE if non-client border drawing is handled, otherwise FALSE.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPListBox is a CListBox derived class. CXTPListBox extends the
//     standard list box control to enable flicker free drawing.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set the style of the list box.
	// Parameters:
	//     style - An XTPListBoxStyle constant used to specify which theme to be
	//             used by the control. This method is here only for backward
	//             compatibilty with older versions and may be removed with a
	//             future release. Plese use the SetTheme() method instead.
	// See Also:
	//     XTPListBoxStyle, GetListStyle, SetTheme
	//-----------------------------------------------------------------------
	void SetListStyle(XTPListBoxStyle style);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to retrieve the style of the list box.
	// Returns:
	//     An XTPListBoxStyle value that contains the style of the list box.
	// See Also:
	//     XTPListBoxStyle, SetListStyle
	//-----------------------------------------------------------------------
	XTPListBoxStyle GetListStyle() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function sets the drawing theme for the control.
	// Parameters:
	//     nTheme - A XTPControlTheme constant used to specify which theme
	//              is to be used for the control.
	// See Also:
	//     XTPControlTheme
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if the list box control
	//     has input focus.
	// Returns:
	//     TRUE if the list box has focus, otherwise FALSE.
	//-----------------------------------------------------------------------
	BOOL HasFocus() const;
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This method determines the list box item nearest to the point
	//     specified in pt when there is at least one item in the list box.
	// Parameters:
	//     pt - Specifies the point for which to find the nearest item,
	...
	//                of the list box.
	//     nIndex - Receives the index of the item that was nearest to the
	//              point specified in pt if successful, otherwise -1.
	// Returns:
	//     TRUE if an item is detected at the specified point, otherwise FALSE.
	//-----------------------------------------------------------------------
...
//=======================================================================
// Summary:
//     An adaptor for any CListBox derived control that overrides standard
//     scrollbars with custom scrollbars.
// Parameters:
...
public:
	...
	using CXTPScrollable<ListBoxBase>::GetRuntimeClass;
...
//-----------------------------------------------------------------------
// Summary:
//     Type alias for a CXTPListBox derived scrollable control.
//-----------------------------------------------------------------------
