...
//     provides the functionality of an Office style checklist box. A
...
protected:
	...
	public:
		...
		//-------------------------------------------------------------------
		// Summary:
		//     Draws the state icon.
		// Parameters:
		//     pDC - A CDC pointer.
		//     nCheck - Checkbox state.
		//     pt - A CPoint object that specifies the x- and y- coordinates of the drawing.
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPCheckListBox object, handles cleanup and deallocation.
	//-----------------------------------------------------------------------
...
public:
	...
	//     checklist box.
	// Parameters:
	//     nStyle -  Determines the style of check boxes in the checklist box.
	//               See the Remarks section for available styles.
	// Remarks:
	//     Styles to be added or removed can be combined by using the bitwise
	//     OR (|) operator. It can be one of the following:
	//     * <b>BS_3STATE</b>: Same as a check box, except that the box can be
	//                         dimmed as well as checked. The dimmed state
	//                         typically is used to show that a check box has
	//                         been disabled.
	//     * <b>BS_AUTO3STATE</b>: Same as a three-state check box, except that
	//                             the box changes its state when the user
	//                             selects it.
	//     * <b>BS_AUTOCHECKBOX</b>: Same as a check box, except that a check
	//                               mark appears in the check box when the user
	//                               selects the box. The check mark disappears
	//                               the next time that the user selects the box.
	//     * <b>BS_CHECKBOX</b>: Creates a small square that has text displayed
	//                           to its right (unless this style is combined with
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to enable/disable a checklist box item.
	// Parameters:
	//     nIndex - Index of the checklist box item to be enabled.
	//     bEnabled - TRUE to enable the checklist box item, FALSE to disable.
	//-----------------------------------------------------------------------
...
protected:
	...
	//     themed application.
	// Parameters:
	//     lpDrawItemStruct - Contains information about the item to draw.
	...
	// Parameters:
	//     lpMeasureItemStruct - A LPMEASUREITEMSTRUCT struct. The MEASUREITEMSTRUCT
	...
	// Parameters:
	//     lpDeleteItemStruct - A LPDELETEITEMSTRUCT struct that contains information
