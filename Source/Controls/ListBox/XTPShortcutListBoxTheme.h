...
//===========================================================================
// Summary:
//     CXTPShortcutListBoxTheme is used to draw the CXTPShortcutListBox object.
//     All themes used for CXTPButton should inherit from this base class.
// Note:
//     A Menu List box is similar in appearance to an Outlook bar.
//===========================================================================
...
public:
	...
	//     default dimensions of a 3D border. Lastly, this function sets the
	...
	//     bottom right color.
	// Parameters:
	//     pList - Pointer to the CXTPShortcutListBox object.
	//-----------------------------------------------------------------------
...
public:
	int m_cyEdge; // Height in pixels of the space between the icon and text.
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw an image of the item
	// Parameters:
	//     pDC - Pointer to a valid device context.
	//     rcIcon - Bounding rectangle.
	//     pImage - Pointer to the image to draw.
	//     bEnabled - TRUE to draw the enabled state of the image.
	//     bSelected - TRUE to draw the selected state of the image.
	//     bPressed - TRUE to draw the pressed state of the image.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to draw the text of the item.
	// Parameters:
	//     pDC - Pointer to a valid device context.
	//     rcText - Bounding rectangle.
	//     pCI - Pointer to the CONTENT_ITEM to draw.
	//-----------------------------------------------------------------------
