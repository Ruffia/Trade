...
public:
	...
	// Parameters:
	//     nTheme - New visual theme. Can be any of the values listed in
	//              the Remarks section.
	// Remarks:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to get a pointer to the currently
	//     selected theme.
	// Returns:
	//     A pointer to a CXTPShortcutListBoxTheme object representing
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the text and background colors
	//     for the Outlook bar.
	// Parameters:
	//     clrText     - An RGB value representing the text color.
	//     clrBack     - An RGB value representing the background color.
	//     clrBackDark - An RGB value representing the dark background color.
	//                   If defined, then the background will be drawn
	//                   with a gradient effect from crBack to crBackDark.
	//-----------------------------------------------------------------------
	...
	//     the AddMenuItem member function, InsertMenuItem does not cause an
	//     Outlook bar with the LBS_SORT style to be sorted.
	// Parameters:
	//     iIndex - Specifies the zero-based index of the position to insert the
	//              menu item. If this parameter is -1, the menu item is added
	//              to the end of the list.
	//     nIconID - Resource ID of the icon associated with this menu item.
	//     lpszText - Pointer to the NULL-terminated string for the menu item.
	...
	//     the Outlook bar was not created with the LBS_SORT style, then the
	//     menu item is added to the end of the Outlook bar. Otherwise, the
	//     menu item is inserted into the Outlook bar, and the Outlook bar is
	//     sorted. If the Outlook bar was created with the LBS_SORT style but
	//     not the LBS_HASSTRINGS style, then the framework sorts the Outlook
	//     bar by one or more calls to the CompareItem member function. Use
	//     InsertMenuItem to insert a menu item into a specific location within
	//     the Outlook bar.
	// Parameters:
	//     nIconID - Resource ID of the icon associated with this menu item.
	//     lpszText - Pointer to the NULL-terminated string for the menu item.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable the menu item
	...
	// Returns:
	//     TRUE if the menu item's enabled state was successfully updated,
	//     otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a CONTENT_ITEM object that
	//     represents the menu item specified by 'iItem'.
	// Parameters:
	//     iItem - Specifies the zero-based index of the menu item to retrieve.
	// Returns:
	//     A CONTENT_ITEM pointer.
	//-----------------------------------------------------------------------
	CONTENT_ITEM* GetMenuItem(int iItem);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the cursor, text, and border
	//     attributes for a highlighted item.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	void SetHighlightCursor(UINT nIDCursor, bool bNoBorder = false, bool bNoUnderline = false);

	//{{AFX_CODEJOCK_PRIVATE
	_XTP_DEPRECATED_IN_FAVOR(SetHighlightCursor)
	void SetHilightCursor(UINT nIDCursor, bool bNoBorder = false, bool bNoUnderline = false)
	{
		SetHighlightCursor(nIDCursor, bNoBorder, bNoUnderline);
	}
	//}}AFX_CODEJOCK_PRIVATE
	...
	// Parameters:
	//     lspzItem - A NULL-terminated string.
	// Returns:
...
protected:
	...
	CContentItemList m_arContentItems;  // Array of CONTENT_ITEM structs that represent each item in
										// the Outlook bar.
	HCURSOR m_hCursor;					// Cursor display when item is hovered over.
