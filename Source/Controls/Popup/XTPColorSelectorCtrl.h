...
{
	COLORREF clrButton; // An RGB value representing the button color.
...
//===========================================================================
// Summary:
//     CXTPPickBtnArray is used to manage a collection of XTP_PICK_BUTTON
//     objects.
//===========================================================================
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrl is a CWnd derived class. It is used to create a
//     CXTPColorSelectorCtrl control that will allow a user to select colors.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to initialize the recently used
	//     color list for the color selector.
	// Parameters:
	//     arRecentColors - Reference to a CUIntArray object that
	//                      contains an array of COLORREF values.
	//     lpszTitle - Title used for the recent colors caption.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a reference to the recently
	//     used color array.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will add a color to the user-defined
	//     color list.
	// Parameters:
	//     clrColor - An RGB value that represents the recently used
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to create a tooltip for a theme color using the specified string
	//     resource ID and shading that were originally passed into SetThemeColors.
	// Parameters:
	//     lpszColor - Name of the color.
	//     lpszDesc  - Description of the color.
	//     nShade    - Percentage that the color has been lightened or darkened.
	// Returns:
	//     A string representing the tooltip for the theme color.
	//-----------------------------------------------------------------------
	CString GetThemeTip(LPCTSTR lpszColor, LPCTSTR lpszDesc, int nShade);

	//-----------------------------------------------------------------------
	// Summary:
	//     Called to initialize the theme colors for the color selector.
	//     The colors passed in must be an array of 10 colors. Additional
	//     values can be passed in such as an array of 10 string resource
	//     IDs and a 6 x 10 shading matrix used to adjust each of the 10
	//     theme colors passed in.
	// Parameters:
	//     pColors       - Array of colors and tooltips.
	...
	//                     description. If NULL, then default values are
	//                     used. Array size must match nCount.
	...
	//                     shading by 10 colums. If NULL, then default
	//                     values are used.
	...
	// Example:
	//     Here is an example of how to use SetThemeColors:
	// <code>
	...
	BOOL SetThemeColors(
		XTP_PICK_BUTTON* pColors, int nCount, LPCTSTR lpszTitle, LPCTSTR* ppszStrings,
		int ppShadeMatrix
			[6]
			[10]); // <combine
				   // CXTPColorSelectorCtrl::SetThemeColors@XTP_PICK_BUTTON*@int@LPCTSTR@UINT*@int[][]>
	BOOL SetThemeColors(
		CXTPPickBtnArray& arColors, int nCols = 10,
		LPCTSTR lpszTitle =
			NULL); // <combine
				   // CXTPColorSelectorCtrl::SetThemeColors@XTP_PICK_BUTTON*@int@LPCTSTR@UINT*@int[][]>
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to initialize the standard colors for the color selector.
	// Parameters:
	//     pColors   - Array of colors and tooltips.
	//     nCount    - Number of colors in the array.
	//     lpszTitle - Title used for theme colors caption.
	...
	BOOL SetStandardColors(XTP_PICK_BUTTON* pColors = NULL, int nCount = 10, int nCols = 10,
						   LPCTSTR lpszTitle = NULL);
	BOOL SetStandardColors(
		CXTPPickBtnArray& arColors, int nCols = 10,
		LPCTSTR lpszTitle =
			NULL); // <combine
				   // CXTPColorSelectorCtrl::SetStandardColors@XTP_PICK_BUTTON*@int@int@LPCTSTR>

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this method to set custom colors for the color picker.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to retrieve a reference to the theme color button array.
	// Returns:
	//     Reference to a CXTPPickBtnArray object representing the theme
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to retrieve a reference to the standard color button array.
	// Returns:
	//     Reference to a CXTPPickBtnArray object representing the standard
	//     color array for the color selector control.
	//-----------------------------------------------------------------------
	...
	//     dwPopup    - Style for the pop-up window. See the Remarks section for a
	...
	//     clrDefault - Specifies the default color for the color pop-up. If the
	//                  current style includes CPS_NOFILL, then this parameter
	//                  is ignored.
	// Remarks:
	//     Styles to be added or removed can be combined by using the bitwise
	//     OR (|) operator. It can be one or more of the following:
	//     * <b>CPS_XTP_NOFILL</b>: Displays a "No Fill" button rather than the
	//                              default Automatic Color button.
	//     * <b>CPS_XTP_EXTENDED</b>: Displays 40 extended colors rather than the
	//                                default 16 colors.
	//     * <b>CPS_XTP_MORECOLORS</b>: Displays a "More Colors" button which will
	//                                  display a CXTPColorDialog.
	//     * <b>CPS_XTP_NOAUTOMATIC</b>: Do not display an "Automatic Color" button.
	//     * <b>CPS_XTP_RECENTCOLORS</b>: Displays a recently used color list for
	//                                    the control.
	//     * <b>CPS_XTP_RIGHTALIGN</b>: The pop-up window is displayed right aligned.
	//     * <b>CPS_XTP_COLORBORDERS</b>: The pop-up window displays color boxes
	//                                    with color borders.
	// Returns:
	//     TRUE if successful, otherwise FALSE.
	// See Also:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function removes a window from the notification list.
	// Parameters:
	...
	// Parameters:
	//     pColorCell - Pointer to a COLOR_CELL object.
	//-----------------------------------------------------------------------
	...
	//     This member function is called to select a color cell.
	// Parameters:
	//     clr - Color of the selected cell.
	//-----------------------------------------------------------------------
	void SelectColor(COLORREF clr);

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to retrieve a COLOR_CELL struct
	//     from the color cell array.
	// Parameters:
	//     iIndex - Index into the color cell array.
	// Returns:
	//     A pointer to a COLOR_CELL object.
	//-----------------------------------------------------------------------
	...
	//     for the control.
	// Parameters:
	//     l - Specifies the left position.
	//     t - Specifies the top position.
	//     r - Specifies the right position.
	//     b - Specifies the bottom position.
	//-----------------------------------------------------------------------
	...
	//     is visible.
	// Returns:
	//     true if the color selection dialog is visible, otherwise false.
	//-----------------------------------------------------------------------
	...
	//     used in a dialog or used in a toolbar.
	// Parameters:
	//     pDC - Device context of the control.
	// Returns:
	//     TRUE if the ColorSelector control is used in a dialog, or
	//     FALSE if the ColorSelector control is used in a toolbar.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     eTheme - New window theme. Can be any of the values listed in the
	//              Remarks section.
	...
	BOOL SetTheme(
		CXTPColorSelectorCtrlTheme* pTheme); // <combine
											 // CXTPColorSelectorCtrl::SetTheme@XTPControlTheme>

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a pointer to the currently
	//     selected theme.
	// Returns:
	//     A pointer to a CXTPColorSelectorCtrlTheme object representing
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the size of a single
	//     color button.
	// Returns:
	//     A CSize object representing the size of a single color button.
	//-----------------------------------------------------------------------
	CSize GetButtonSize() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the number of columns
	//     displayed.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the size of the control
	//     border.
	// Returns:
	//     A CRect representing the size of the control border.
	//-----------------------------------------------------------------------
	CRect GetBorderRect() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the pop-up style for the
	//     color selector control.
	// Returns:
	//     A DWORD value representing the pop-up style set for the control.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to modify the color selector style. Styles
	//     to be added or removed can be combined by using the bitwise OR (|)
	//     operator. Can be one or more of the following values:
	//     * <b>CPS_XTP_NOFILL</b>: Displays a "No Fill" button rather than the
	//                              default Automatic Color button.
	//     * <b>CPS_XTP_EXTENDED</b>: Displays 40 extended colors rather than the
	//                                default 16 colors.
	...
	//                                    with color borders.
	// Parameters:
	//     dwRemove - Specifies styles to be removed during style modification.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the array of custom colors
	//     defined for the color selector control.
	// Returns:
	//     A pointer to an XTP_PICK_BUTTON* array representing custom
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the number of items in the
	//     custom color array.
	// Returns:
	//     An integer representing the number of items in the color array.
	//-----------------------------------------------------------------------
	int GetExtendedCount() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the index of the currently
	//     selected color.
	// Returns:
	//     An integer representing the currently selected color.
	//-----------------------------------------------------------------------
	int GetCurSel() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the the index of the currently
	//     pressed color.
	// Returns:
	//     An integer representing the currently pressed color.
	//-----------------------------------------------------------------------
	int GetPressed() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the default color defined
	//     for the control.
	// Returns:
	//     An RGB value representing the default color.
	//-----------------------------------------------------------------------
	COLORREF GetDefColor() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the currently selected color
	//     for the control.
	// Returns:
	//     An RGB value representing the currently selected color.
	//-----------------------------------------------------------------------
	COLORREF GetCurColor() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a reference to the tooltip
	//     for the control.
	// Returns:
	//     A reference to a CToolTipCtl obbject.
	//-----------------------------------------------------------------------
	CToolTipCtrl& GetToolTipCtrl();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a reference to the cell
	//     list array for the control.
	// Returns:
	//     A reference to a CColorCellList object.
	//-----------------------------------------------------------------------
	CColorCellList& GetColorCellList();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the string set for the
	//     theme caption.
	// Returns:
	//     A string representing the theme caption.
	//-----------------------------------------------------------------------
	...
	//     standard caption.
	// Returns:
	//     A string representing the standard caption.
	//-----------------------------------------------------------------------
	...
	//     custom caption.
	// Returns:
	//     A string representing the custom caption.
	//-----------------------------------------------------------------------
	CString GetCustomTitle();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if captions are used
	//     for the color selector.
	// Returns:
	//     TRUE if themes are used, otherwise FALSE.
	//-----------------------------------------------------------------------
	BOOL HasCaptions() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to show/hide captions for the
	//     color selector.
	// Parameters:
	//     bShow - TRUE to show captions, FALSE to hide.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to initialize the object specified by arColors using
	//     the data contained in the array specified by pColors.
	// Parameters:
	//     arColors - Reference to an array to be initalized.
	//     pColors  - Array of XTP_PICK_BUTTON structures.
	//     nCount   - Number of items contained in pColors.
	// Returns:
	//     TRUE if the array specified by arColors has been successfully
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function will finish the selection process for the
	//     color box or button in the color pop-up window.
	// Parameters:
	...
	//     color is already in the ColorDialog's MRU list or in the
	//     standard colors list.
	// Parameters:
	//     crFind -  A const COLORREF value.
	// Return:
	//     TRUE if the color is found, otherwise FALSE.
	// ----------------------------------------------------------------------
	...
	//     the color box or button in the color pop-up window.
	// Parameters:
	//     nCurSel     - Current index of the selected color box or button in
	//                   the color pop-up window.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to calculate the size of the Selector
	//     to fit all buttons.
	// Returns:
	//     Size of the Selector to fit all buttons.
	//-----------------------------------------------------------------------
	virtual CSize CalcSize();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to refresh theme colors and redraw
	//     the control.
	// Parameters:
	//     pHeader - Pointer to the CXTPColorSelectorCtrl object.
	//-----------------------------------------------------------------------
...
public:
	...
	static CString m_strTitleRecent;	// Represents the title for the recent colors caption.

protected:
	int m_nCols;				// Number of columns in the color pop-up window.
	int m_nCurSel;				// Currently selected index.
	int m_nPressed;				// Pressed button.
	BOOL m_bCaptions;			// TRUE to display color captions.
	CWnd* m_pParentWnd;			// Pointer to the parent window for the pop-up window.
	CRect m_rcWnd;				// Rect for the pop-up window.
	CRect m_rcBorders;			// Control borders.
	DWORD m_dwPopup;			// Color pop-up window style.
	CPoint m_point;				// Last known cursor position.
	CString m_strTitleTheme;	// Represents the title for the theme colors caption.
	CString m_strTitleStandard; // Represents the title for the standard colors caption.
	...
	COLORREF m_clrDefault;  // An RGB value that represents the default color for the pop-up window.
	...
	CXTPColorDialog* m_pColorDlg;		  // Pointer to the color selection dialog when visible.
...
//     handle theme specific visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to draw the background of the
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to draw the cell specified
	//     by 'pColorCell'.
	// Parameters:
	//     pDC           - A CDC pointer that represents the current device context.
	//     pOwner        - A pointer to the parent CXTPColorSelectorCtrl object.
	//     pColorCell    - A COLOR_CELL object.
	//     bHighlight    - TRUE if the mouse is over the cell.
	//     bPressed      - TRUE if the cell is pressed.
	//-----------------------------------------------------------------------
	virtual void DrawColorCell(CDC* pDC, CXTPColorSelectorCtrl* pOwner,
							   CXTPColorSelectorCtrl::COLOR_CELL* pColorCell, BOOL bHighlight,
							   BOOL bPressed);
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to determine the size of the color selector window.
	// Parameters:
	//     pOwner - A pointer to the parent CXTPColorSelectorCtrl object.
	// Returns:
	//     A CSize object containing the width and height for the control.
	//-----------------------------------------------------------------------
	virtual CSize CalcSize(CXTPColorSelectorCtrl* pOwner);

	//-----------------------------------------------------------------------
	// Summary:
	//     Called to add the 'Automatic Color' button to the color selector
	//     control.
	// Parameters:
	//     pOwner   - A pointer to the parent CXTPColorSelectorCtrl object.
	//     nIndex   - Reference to an integer representing the next available
	//                index in the color cell array.
	//     x        - Specifies the starting coordinates for the left edge.
	//     y        - Specifies the starting coordinates for the top edge.
	//     cx       - Specifies the width of the client area.
	//     bChecked - TRUE when a color button has been checked.
	// Returns:
	//     TRUE if the 'Automatic Color' button was successfully created,
	//     otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to add default color buttons to the color selector control.
	// Parameters:
	//     pOwner   - A pointer to the parent CXTPColorSelectorCtrl object.
	//     nIndex   - Reference to an integer representing the next available
	//                index in the color cell array.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to add theme and standard buttons to the color selector control.
	// Parameters:
	//     pOwner   - A pointer to the parent CXTPColorSelectorCtrl object.
	//     nIndex   - Reference to an integer representing the next available
	//                index in the color cell array.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to determine if theme or default color buttons should be added.
	// Parameters:
	//     pOwner   - A pointer to the parent CXTPColorSelectorCtrl object.
	//     nIndex   - Reference to an integer representing the next available
	//                index in the color cell array.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to add recent colors to the color selector control.
	// Parameters:
	//     pOwner   - A pointer to the parent CXTPColorSelectorCtrl object.
	//     nIndex   - Reference to an integer representing the next available
	//                index in the color cell array.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to add a 'More Colors' button to the color selector control.
	// Parameters:
	//     pOwner   - A pointer to the parent CXTPColorSelectorCtrl object.
	//     nIndex   - Reference to an integer representing the next available
	//                index in the color cell array.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call to retrieve the size of a single color button.
	// Returns:
	//     A CSize object representing the size of a single color button.
	//-----------------------------------------------------------------------
...
public:
	...
	COLORREF m_crBorder;		// An RGB value representing the border color.
	COLORREF m_crBorderHilight; // An RGB value for border highlight color.
	COLORREF m_crBorderPressed; // An RGB value for border pressed color.
	COLORREF m_crBack;			// An RGB value for background color.
	COLORREF m_crBackPressed;   // An RGB value for pressed background color.
	COLORREF m_crBackHilight;   // An RGB value for background highlight color.
	COLORREF m_crBackChecked;   // An RGB value for checked background color.
	COLORREF m_crText;			// An RGB value for text color.
	COLORREF m_crTextPressed;   // An RGB value for text pressed color.
	COLORREF m_crPopupBorder;   // An RGB value for the pop-up border.
};

//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeOfficeXP is derived from CXTPColorSelectorCtrlTheme
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeOffice2003 is derived from
//     CXTPColorSelectorCtrlThemeOfficeXP to handle theme specific
//     visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeResource is derived from
//     CXTPColorSelectorCtrlThemeOfficeXP to handle theme specific
//     visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeOffice2013 is derived from CXTPColorSelectorCtrlTheme
//     to handle theme specific visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
...
public:
	...
	//     rcBorder - Specifies left, top, right and bottom borders.
	//                1 = draw border, 0 = do not draw border.
	//     crBorder - An RGB value specifying the border color to draw.
	//-----------------------------------------------------------------------
	virtual void DrawBorder(CDC* pDC, CRect rcItem, CRect rcBorder, COLORREF crBorder);

	//-----------------------------------------------------------------------
	// Summary:
	//     Called to draw a color cell for the color selector control.
	// Parameters:
	//     pDC        - A CDC pointer that represents the current device context.
	//     pOwner     - A pointer to the parent CXTPColorSelectorCtrl object.
	//     pColorCell - A COLOR_CELL object.
	//     rcItem     - Size and location of the color cell to draw.
	//     bHighlight - TRUE if the color should be drawn highlighted.
	...
	virtual void DrawColor(CDC* pDC, CXTPColorSelectorCtrl* pOwner,
						   ...
						   BOOL bChecked, BOOL bHighlight, BOOL bPressed);
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to add the 'Automatic Color' button to the color selector control.
	// Parameters:
	//     pOwner   - A pointer to the parent CXTPColorSelectorCtrl object.
	//     nIndex   - Reference to an integer representing the next available
	//                index in the color cell array.
...
protected:
	COLORREF m_crTitleText;	// An RGB value representing the title text color.
	COLORREF m_crTitleBack;	// An RGB value representing the title background color.
	COLORREF m_crBorderInside; // An RGB value representing the inside border highlight color.
};

//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeVisualStudio2015 is derived from
//     CXTPColorSelectorCtrlThemeOffice2013 to handle theme specific
//     visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the theme manager to refresh the visual styles
	//     used by each component's theme.
	// Parameters:
	//     pOwner - A pointer to the parent CXTPColorSelectorCtrl object.
	//-----------------------------------------------------------------------
	virtual void RefreshMetrics(CXTPColorSelectorCtrl* pOwner);
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeVisualStudio2017 is derived from
//     CXTPColorSelectorCtrlThemeVisualStudio2015 to handle theme specific
//     visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
class _XTP_EXT_CLASS CXTPColorSelectorCtrlThemeVisualStudio2017
	: public CXTPColorSelectorCtrlThemeVisualStudio2015
{
public:
	//-----------------------------------------------------------------------
	// Summary:
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeVisualStudio2019 is derived from
//     CXTPColorSelectorCtrlThemeVisualStudio2015 to handle theme specific
//     visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
class _XTP_EXT_CLASS CXTPColorSelectorCtrlThemeVisualStudio2019
	: public CXTPColorSelectorCtrlThemeVisualStudio2015
{
public:
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeVisualStudio2022 is derived from
//     CXTPColorSelectorCtrlThemeVisualStudio2015 to handle theme specific
//     visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
class _XTP_EXT_CLASS CXTPColorSelectorCtrlThemeVisualStudio2022
	: public CXTPColorSelectorCtrlThemeVisualStudio2015
{
public:
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPColorSelectorCtrlThemeNativeWindows10 is derived from
//     CXTPColorSelectorCtrlThemeVisualStudio2015 to handle theme specific
//     visualizations for the CXTPColorSelectorCtrl class.
//===========================================================================
class _XTP_EXT_CLASS CXTPColorSelectorCtrlThemeNativeWindows10
	: public CXTPColorSelectorCtrlThemeVisualStudio2015
{
public:
	//-----------------------------------------------------------------------
