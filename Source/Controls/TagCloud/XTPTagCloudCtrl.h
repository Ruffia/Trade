...
//===========================================================================
// Summary:
//     CXTPTagCloudStyle is a helper class used by CXTPTagCloudStyleManager
...
public:
	...
	//     Default constructor.
	// Parameters:
	//     nScore       - Unique ID for the style.
	//     clrText      - An RGB value representing the style text color.
	//     clrTextHover - An RGB value representing the style text hover color.
	//     clrBorder    - An RGB value representing the style border color.
	//                    Setting to COLORREF_NULL (-1) indicates no border.
	//     lf           - Reference to a LOGFONT struct used to create
	//                    the font used by the style.
	//-----------------------------------------------------------------------
	CXTPTagCloudStyle();
	CXTPTagCloudStyle(const CXTPTagCloudStyle& style); // <combine
	...
	CXTPTagCloudStyle(int nScore, COLORREF clrText, COLORREF clrTextHover, COLORREF clrBorder,
					  LOGFONT& lf); // <combine CXTPTagCloudStyle::CXTPTagCloudStyle>

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the font for the style using the LOGFONT struct specified by lf.
	// Parameters:
	//     lf - Reference to a LOGFONT struct used to create the font used
	//          by the style.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Overloaded operator initializes a CXTPTagCloudStyle class using
	//     the object specified by style.
	// Parameters:
	//     style - Reference to a CXTPTagCloudStyle object used to initialize
	//             this class.
	// Returns:
	//     A reference to the CXTPTagCloudStyle object.
	//-----------------------------------------------------------------------
	CXTPTagCloudStyle& operator=(const CXTPTagCloudStyle& style);

	//-----------------------------------------------------------------------
	// Summary:
	//     Copies the contents from one CXTPTagCloudStyle object to another.
	// Parameters:
	//     pSource - Pointer to the source CXTPTagCloudStyle object.
	//     pDest   - Pointer to the destination CXTPTagCloudStyle object.
	//-----------------------------------------------------------------------
	...
	COLORREF m_clrText;		 // An RGB value representing the style text color.
	COLORREF m_clrTextHover; // An RGB value representing the style text hover color.
	COLORREF m_clrBorder;	// An RGB value representing the style border color.
};

//===========================================================================
// Summary:
//     CArray based object used for storing CXTPTagCloudStyle structs.
//===========================================================================
typedef CArray<CXTPTagCloudStyle*, CXTPTagCloudStyle*> CXTPTagCloudStyleArray;

//===========================================================================
// Summary:
//     CXTPTagCloudStyleManager is a singleton class used to manage
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Destructor used to handle cleanup and deallocation.
	//-----------------------------------------------------------------------
	~CXTPTagCloudStyleManager();

	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the CXTPTagCloudCtrl to initialize a default array
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to add a new style to the style array.
	// Parameters:
	//     nScore       - Unique ID for the style.
	//     clrText      - An RGB value representing the style text color.
	//     clrTextHover - An RGB value representing the style text hover color.
	...
	INT_PTR AddStyle(
		CXTPTagCloudStyle*
			pStyle); // <combine
					 // CXTPTagCloudStyleManager::AddStyle@int@COLORREF@COLORREF@COLORREF@LOGFONT&>

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to remove an existing style from the
	//     style array.
	// Parameters:
	//     nScore - Identifier of the style to remove.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to remove all tag styles from the
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the style associated
	//     with the identifier specified by nScore.
	// Parameters:
	//     nScore - Unique identifier for the style to find.
	// Returns:
	//     A pointer to a CXTPTagCloudStyle object if successful, otherwise NULL.
	//-----------------------------------------------------------------------
	CXTPTagCloudStyle* GetStyle(int nScore);

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the color values for the style specified by nScore.
	// Parameters:
	//     nScore       - ID of the style to update.
	//     clrText      - An RGB value representing the style text color.
	//                    If COLORREF_NULL, then this value is ignored.
	//     clrTextHover - An RGB value representing the style text highlight color
	//                    If COLORREF_NULL, then this value is ignored.
	//     clrBorder    - An RGB value representing the style border color.
	//                    If COLORREF_NULL, then no border will be drawn.
	// Returns:
	//     TRUE if the style was found and updated, otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the font for the style specified by nScore.
	// Parameters:
	//     nScore - ID of the style to update.
	//     lf     - Reference to a LOGFONT struct used to create
	//              the font used by the style.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a reference to the
	//     CXTPTagCloudStyleArray managed by CXTPTagCloudStyleManager.
	// Returns:
	//     A reference to a CXTPTagCloudStyleArray object.
	//-----------------------------------------------------------------------
	CXTPTagCloudStyleArray& GetCloudStyleArray();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if the score
	//     specified by nScore already exists in the array.
	// Parameters:
	//     nScore - Score index to check.
	// Returns:
	//     TRUE if the score already exists, otherwise FALSE.
	//-----------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     Use the XTPTabCloudStyleManager() function for access to the
...
//===========================================================================
// Summary:
//     Manages the attributes for each tag element such as weight, font,
...
struct XTP_TAGCLOUDTAG
{
	...
	// Parameters:
	//     lpszItem - Name of the tag cloud item.
...
//===========================================================================
// Summary:
//     XTPTagCloudSort is an enumeration used by the CXTPTagCloudTagArray
...
//===========================================================================
// Summary:
//     CXTPTagCloudTagArray is a CArray derived class used to manage
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to sort the tag item array by the
	//     style specified by nSort.
	// Parameters:
	//     nSort - Specifies the sorting style; can be one of the
...
//===========================================================================
// Summary:
//     The CXTPTagCloudCtrl class is used to create a tag cloud control
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to create the CXTPTagCloudCtrl window.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Adds a new tag to the tag cloud control.
	// Parameters:
	//     pTag - A pointer to a valid XTP_TAGCLOUDTAG object to add.
	//-----------------------------------------------------------------------
	void AddTag(XTP_TAGCLOUDTAG* pTag);

	//-----------------------------------------------------------------------
	// Summary:
	//     Removes a tag from the tag cloud control.
	// Parameters:
	//     pTag - A pointer to a valid XTP_TAGCLOUDTAG object to remove.
	//-----------------------------------------------------------------------
	void RemoveTag(XTP_TAGCLOUDTAG* pTag);

	//-----------------------------------------------------------------------
	// Summary:
	//     Removes all tags from the XTP_TAGCLOUDTAG window.
	//-----------------------------------------------------------------------
	void RemoveAll();

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the tag from the cursor position specified by point.
	// Parameters:
	//     point - Cursor position in client coordinates.
	// Returns:
	//     A pointer to an XTP_TAGCLOUDTAG if successful, otherwise NULL.
	//-----------------------------------------------------------------------
	XTP_TAGCLOUDTAG* HitTest(const CPoint& point);

	//-----------------------------------------------------------------------
	// Summary:
	//     Recalculates the size and position for all tags associated
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the margin for the client area of the tag cloud control.
	// Parameters:
	//     nMargin - Size, in pixels, of the margin to set.
	//-----------------------------------------------------------------------
	void SetMargin(int nMargin);

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the client area margin for the tag cloud control.
	// Returns:
	//     An integer representing the client area margin in pixels.
	//-----------------------------------------------------------------------
	int GetMargin() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the padding for each tag associated with the tag cloud control.
	// Parameters:
	//     nPadding - Size, in pixels, of the padding to set.
	//-----------------------------------------------------------------------
	void SetPadding(int nPadding);

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the padding for each tag associated with the tag cloud control.
	// Returns:
	//     An integer representing the padding for each tag in pixels.
	//-----------------------------------------------------------------------
	int GetPadding() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Enables/disables tooltips for the tag cloud control.
	// Parameters:
	//     bTipEnabled - TRUE to enable tooltips, FALSE to disable.
	//-----------------------------------------------------------------------
	void EnableTooltip(BOOL bTipEnabled);

	//-----------------------------------------------------------------------
	// Summary:
	//     Called to determine if tooltips are enabled for the tab cloud control.
	// Returns:
	//     TRUE if tooltips are enabled for the tag cloud control.
	//-----------------------------------------------------------------------
	BOOL IsTipEnabled() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Enables/disables tag item focus rectangle display.
	// Parameters:
	//     bFocusRect - TRUE to enable tag item focus display.
	//-----------------------------------------------------------------------
	void EnableFocusRect(BOOL bFocusRect);

	//-----------------------------------------------------------------------
	// Summary:
	//     Called to determine if tag item focus display is enabled for
	//     the tag cloud control.
	// Returns:
	//     TRUE if tag item focus has been enabled, otherwise FALSE.
	//-----------------------------------------------------------------------
	BOOL IsFocusEnabled() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the sort order for all tags associated with the tag
	//     cloud control.
	// Parameters:
	//     nSortOrder - Specifies the sort order for the tag items;
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called to determine the sort order for the tag cloud control;
	//     can be one of the following values: xtpTagCloudNone,
	//     xtpTagCloudAlpha or xtpTagCloudNumeric.
	// Returns:
	//     A XTPTagCloudSort enumeration value representing the tag cloud
	//     control sort order.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves a pointer to the currently selected tag if any.
	// Returns:
	//     A pointer to the currently selected XTP_TAGCLOUDTAG object
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the current selection for the tag cloud control
	//     and sends an event notification to the owner window.
	// Parameters:
	//     pCurSel - A pointer to a valid XTP_TAGCLOUDTAG tag.
	//-----------------------------------------------------------------------
	void SetCurSel(XTP_TAGCLOUDTAG* pCurSel);

	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the background color for the tag cloud control.
	// Parameters:
	//     clrBack - A CXTPPaintManagerColorGradient representing the
	//               background color for the tag cloud control. If
	//               dark and light colors are specified, then the background
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the background color for the tag cloud control.
	// Returns:
	//     A CXTPPaintManagerColorGradient representing the background
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Sets the border color for the tag cloud control.
	// Parameters:
	//     clrBorder - Specifies the new border color.
	//-----------------------------------------------------------------------
	void SetBorderColor(CXTPPaintManagerColor clrBorder);

	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the border color for the tag cloud control.
	// Returns:
	//     A CXTPPaintManagerColor object representing the border color
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Determines if the background gradient fill style is horizontal
	//     or vertical.
	// Returns:
	//     TRUE if the fill style is horizontal, FALSE if vertical.
	//-----------------------------------------------------------------------
	BOOL IsFillHorz() const;

	//-----------------------------------------------------------------------
	// Summary:
	//     Called to restore all default values for the tag cloud control.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves a reference to the CXTPTagCloudTagArray that contains
	//     all of the tags associated with the tag cloud control.
	// Returns:
	//     A reference to a CXTPTagCloudTagArray object.
	//-----------------------------------------------------------------------
	virtual CXTPTagCloudTagArray& GetTagArray();

	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the tag cloud control to register the window
	//     class used to create the control.
	// Parameters:
	//     hInstance - Handle to the instance that contains the window
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the tag cloud control to draw the client area of
	//     the control.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the OnDraw function to calculate the size and
	//     position for a tag in the row specified by arrRow.
	// Parameters:
	//     rcClient - Specifies the client area of the tag cloud
	//                excluding margins.
	//     arrRow   - Array of tags representing a single row in the
	//                tag cloud control.
	// Returns:
	//     A CSize object representing the max width and height for
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Retrieves the cursor position in window coordinates and
	//     determines if the cursor is hovering over the tag cloud window.
	// Returns:
	//     TRUE if the cursor is hovering over the tag cloud control,
	//     otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called during mouse move events to set the active/inactive
	//     state for the tag cloud control.
	// Parameters:
	//     bActive - TRUE if the tag cloud control is active,
	//               FALSE if inactive.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by tag cloud control to send notification messages
	//     to the owner window when an event specified by nEventCode
	//     occurs.
	// Parameters:
	//     pTag - Pointer to an XTP_TAGCLOUDTAG struct.
	// Returns:
	//     TRUE if notification was sent to the owner window,
	//     otherwise FALSE.
	//-----------------------------------------------------------------------
	...
	XTP_TAGCLOUDTAG* m_pHover;		// Pointer to the tag item that the mouse cursor is currently
									// hovering over.
	XTP_TAGCLOUDTAG* m_pCurSel;		// Pointer to the tag item that is currently selected.
