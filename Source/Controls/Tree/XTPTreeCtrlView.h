...
//===========================================================================
// Summary:
//     An adaptor for any CTreeCtrl derived control that overrides standard
...
public:
	...
	using CXTPScrollable<TreeBase>::GetRuntimeClass;
	using CXTPScrollable<TreeBase>::ModifyStyle;
	using CXTPScrollable<TreeBase>::ModifyStyleEx;
...
//---------------------------------------------------------------------------
// Summary:
//     Type alias for a CXTPTreeCtrl derived scrollable control.
//---------------------------------------------------------------------------
