...
public:
	...
	// -------------------------------------------------------------------
	// Summary:
	//     Destroys a CXTPTreeTheme object, handles cleanup and deallocation.
	// -------------------------------------------------------------------
	virtual ~CXTPTreeTheme();

	// -------------------------------------------------------------------
	// Summary:
	//     This member function performs initialization for the tree theme.
	// Parameters:
	//     pTreeBase - Pointer to a valid CXTPTreeBase object.
	// Remarks:
	//     Initializes all drawing defaults such as colors.
	// -------------------------------------------------------------------
	virtual void RefreshMetrics(CXTPTreeBase* pTreeBase);

	// -------------------------------------------------------------------
	// Summary:
	//     This member function is used to retrieve the tree background color.
	// Returns:
	//     An RGB value representing the tree background color.
	// -------------------------------------------------------------------
	virtual COLORREF GetTreeBackColor() const;

	// -------------------------------------------------------------------
	// Summary:
	//     This member function is used to retrieve the tree text color.
	// Returns:
	//     An RGB value representing the tree text color.
	// -------------------------------------------------------------------
	...
	// Summary:
	//     This member function is used to retrieve the tree text color
	//     depending on the tree item state.
	// Parameters:
	...
	//     pTreeBase     - Pointer to a valid CXTPTreeBase object.
	// Returns:
	//     An RGB value representing the tree item state text color.
	// -------------------------------------------------------------------
	...
	// -------------------------------------------------------------------
	// Summary:
	//     This member function is used to retrieve the tree back color
	//     depending on the tree item state.
	// Parameters:
	//     uState        - TVIS state flags.
	//     bTreeHasFocus - TRUE if the tree has input focus.
	...
	//     pTreeBase     - Pointer to a valid CXTPTreeBase object.
	// Returns:
	//     An RGB value representing the tree item state back color.
	// -------------------------------------------------------------------
	...
	// -------------------------------------------------------------------
	// Summary:
	//     This member function is used to determine if a focus rectangle
	//     should be drawn around tree items that have input focus.
	// Returns:
	//     TRUE if a focus rectangle should be drawn, otherwise FALSE.
	// -------------------------------------------------------------------
	...
	// -------------------------------------------------------------------
	// Summary:
	//     This member function is used to determine if a dark theme is used.
	// Returns:
	//     TRUE when using a darker background theme,
	//     FALSE when using a lighter background theme.
	// -------------------------------------------------------------------
...
public:
	// -------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTreeVisualStudio2012Theme object.
	// Parameters:
...
public:
	// -------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTreeOffice2013Theme object.
	// -------------------------------------------------------------------
...
public:
	// -------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTreeVisualStudio2015Theme object.
	// -------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPTreeVisualStudio2017Theme is a CXTPTreeTheme derived class used to
//     render a Visual Studio 2017 style tree.
//===========================================================================
class _XTP_EXT_CLASS CXTPTreeVisualStudio2017Theme : public CXTPTreeOffice2013Theme
{
public:
	// -------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTreeVisualStudio2017Theme object.
	// -------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPTreeVisualStudio2019Theme is a CXTPTreeTheme derived class used to
//     render a Visual Studio 2019 style tree.
//===========================================================================
class _XTP_EXT_CLASS CXTPTreeVisualStudio2019Theme : public CXTPTreeOffice2013Theme
{
public:
	// -------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTreeVisualStudio2019Theme object.
	// -------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPTreeVisualStudio2022Theme is a CXTPTreeTheme derived class used to
//     render a Visual Studio 2022 style tree.
//===========================================================================
class _XTP_EXT_CLASS CXTPTreeVisualStudio2022Theme : public CXTPTreeOffice2013Theme
{
public:
	// -------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTreeVisualStudio2022Theme object.
	// -------------------------------------------------------------------
...
//===========================================================================
// Summary:
//     CXTPTreeNativeWindows10Theme is a CXTPTreeTheme derived class used to
//     render a Native Windows 10 style tree.
//===========================================================================
class _XTP_EXT_CLASS CXTPTreeNativeWindows10Theme : public CXTPTreeOffice2013Theme
{
public:
	// -------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPTreeNativeWindows10Theme object.
	// -------------------------------------------------------------------
