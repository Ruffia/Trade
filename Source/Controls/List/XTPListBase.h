...
public:
	...
	// Returns:
	//     A pointer to a CXTPHeaderCtrl object if subclassed, otherwise NULL.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     lpszSection -  Registry section name. If NULL, then the
	//                    default is "Settings".
	//     lpszEntry   -  Registry entry name. If NULL, then the
	//                    default is "Column Info".
	//     lpszDefault -  Registry default value. If NULL, then the
	//                    default ID.
	// Remarks:
	...
	// Parameters:
	//     dwExStyle  - DWORD value that specifies the extended list-view control
	//                  style. This parameter can be a combination of Extended
	//                  List-View Styles.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to disable/enable column sizing.
	// Parameters:
	...
	//                       then the column width is the same as the previous column.
	...
	//     widths specified by <i>nWidth</i>, and an array of column labels
	...
	//     the list control.
	// Parameters:
	//     clrText   - An RGB value representing the row text color.
	//     clrTextBk - An RGB value representing the row background color.
	// Remarks:
	...
	//     the specified row in the list control.
	// Parameters:
	//     lpRowColor - Pointer to a ROWCOLOR that contains the RGB row
	//                  color information.
	//     bRedraw    - TRUE to invalidate the control.
	//-----------------------------------------------------------------------
	...
	//     iRow    -  Index of the row to set the colors for.
	//     crText  -  An RGB value representing the row text color.
	//     crBack  -  An RGB value representing the row background color.
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     A pointer to a ROWCOLOR structure if successful, otherwise NULL.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the RGB color value used
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable sorted column colors.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to determine if sorted column colors
	//     are enabled.
	// Returns:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable user-defined colors.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to enable/disable user-defined row colors.
	// Parameters:
...
protected:
	...
	// Parameters:
	//     pListCtrl - Pointer to the CListCtrl object to attach.
	// Remarks:
	...
	// Remarks:
	//     The derived class calls this member function to process the message
	//     map for a control notification. The derived class should call
	//     this member function from the CWnd::OnNotify override.
	// Returns:
...
protected:
	...
	bool m_bAutoFont;			// If true, then the font will automatically be set for the control.
	...
	bool m_bNoColSizing;		// If true, then column sizing is disabled.
