...
//     CXTPListBase. This class implements a flat header and generic sorting routines.
// See Also:
//     CXTPListBase
//===========================================================================
...
//     CXTPListBase. This class implements a flat header and generic sorting
...
//===========================================================================
// Summary:
//     An adaptor for any CListCtrl derived control that overrides standard
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Initializes a scrollable control instance.
	//-----------------------------------------------------------------------
	CXTPScrollableListCtrlT();

	using CXTPScrollable<ListBase>::GetRuntimeClass;
...
//---------------------------------------------------------------------------
// Summary:
//     Type alias for a CXTPListCtrl derived scrollable control.
//---------------------------------------------------------------------------
...
{
	if (XTPOnScrollableListCtrlWndMsg(message, wParam, lParam, pResult,
									  CXTPScrollHost::GetEmbeddedControl()))
		return TRUE;
