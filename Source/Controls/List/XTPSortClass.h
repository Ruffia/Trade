...
//     to determine what type of sorting to perform.
// See Also:
//     CXTPSortClass::Sort
//
...
//===========================================================================
// Summary:
//     CXTPSortClass is a standalone class. This class will sort a list control
...
//
//     The following example demonstrates how to use the sortClass Sort member function:
// <code>
...
public:
	...
	//     sorting operations.
	// Parameters:
	//     lParam1    - Specifies the item data for the first of the two items
	//                  being compared.
	//     lParam2    - Specifies the item data for the second of the two items
	//                  being compared.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called by the application defined comparison
	...
	//                 being compared.
	//     sOrder    - Represents the sort order; set to 1 for ascending,
	//                 or -1 for descending.
	// Returns:
	...
	//     item data pointer that contains each list item's name (used for sorting)
