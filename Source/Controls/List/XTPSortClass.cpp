...
int CALLBACK CXTPSortClass::Compare(LPARAM lParam1, LPARAM lParam2, LPARAM lParamSort)
{
	...
	switch (eType)
	{
		case xtpSortInt: return SortInt(pData1->strItem, pData2->strItem, sOrder);

		case xtpSortString: return SortString(pData1->strItem, pData2->strItem, sOrder);

		case xtpSortDateTime: return SortDateTime(pData1->strItem, pData2->strItem, sOrder);

		case xtpSortDecimal: return SortDecimal(pData1->strItem, pData2->strItem, sOrder);
	}
...
// CXTPSortClass
//
CXTPSortClass::CXTPSortClass(CListCtrl* pListCtrl, const int nCol,
							 PFNLVCOMPARE pfnCompare /*=NULL*/)
...
#ifdef _UNICODE
	char szText1[256];
	::WideCharToMultiByte(CP_ACP, 0, lpszItem1, -1, szText1, 255, NULL, NULL);

	char szText2[256];
	::WideCharToMultiByte(CP_ACP, 0, lpszItem2, -1, szText2, 255, NULL, NULL);
