// XTPComboBoxThemeVisualStudio2022.h: interface for the CXTPComboBoxThemeVisualStudio2022 class.
//
...
#if !defined(__XTPCOMBOBOXTHEMEVISUALSTUDIO2022_H__)
#	define __XTPCOMBOBOXTHEMEVISUALSTUDIO2022_H__
//}}AFX_CODEJOCK_PRIVATE
...
//     Visual Studio 2022 appearance.
//===========================================================================
class _XTP_EXT_CLASS CXTPComboBoxThemeVisualStudio2022 : public CXTPComboBoxThemeOffice2013
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Default constructor.
	//-----------------------------------------------------------------------
	CXTPComboBoxThemeVisualStudio2022();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destructor handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPComboBoxThemeVisualStudio2022();
...
#endif // __XTPCOMBOBOXTHEMEVISUALSTUDIO2022_H__
