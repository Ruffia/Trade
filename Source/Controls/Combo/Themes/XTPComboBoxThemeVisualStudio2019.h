// XTPComboBoxThemeVisualStudio2019.h: interface for the CXTPComboBoxThemeVisualStudio2019 class.
//
...
#if !defined(__XTPCOMBOBOXTHEMEVISUALSTUDIO2019_H__)
#	define __XTPCOMBOBOXTHEMEVISUALSTUDIO2019_H__
//}}AFX_CODEJOCK_PRIVATE
...
//     Visual Studio 2019 appearance.
//===========================================================================
class _XTP_EXT_CLASS CXTPComboBoxThemeVisualStudio2019 : public CXTPComboBoxThemeOffice2013
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Default constructor.
	//-----------------------------------------------------------------------
	CXTPComboBoxThemeVisualStudio2019();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destructor handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPComboBoxThemeVisualStudio2019();
...
#endif // __XTPCOMBOBOXTHEMEVISUALSTUDIO2019_H__
