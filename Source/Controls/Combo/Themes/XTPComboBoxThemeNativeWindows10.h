// XTPComboBoxThemeNativeWindows10.h: interface for the CXTPComboBoxThemeNativeWindows10 class.
//
...
#if !defined(__XTPCOMBOBOXTHEMENATIVEWINDOWS10_H__)
#	define __XTPCOMBOBOXTHEMENATIVEWINDOWS10_H__
//}}AFX_CODEJOCK_PRIVATE
...
//     Native Windows 10 appearance.
//===========================================================================
class _XTP_EXT_CLASS CXTPComboBoxThemeNativeWindows10 : public CXTPComboBoxThemeOffice2013
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Default constructor.
	//-----------------------------------------------------------------------
	CXTPComboBoxThemeNativeWindows10();

	//-----------------------------------------------------------------------
	// Summary:
	//     Destructor handles cleanup and deallocation.
	//-----------------------------------------------------------------------
	virtual ~CXTPComboBoxThemeNativeWindows10();
...
#endif // __XTPCOMBOBOXTHEMENATIVEWINDOWS10_H__
