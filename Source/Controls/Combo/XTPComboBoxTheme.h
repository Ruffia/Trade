...
//===========================================================================
// Summary:
//     CXTPComboBoxTheme is a class used to perform ComboBox Theme
//     drawing tasks. This is the base class for all combobox themes.
//===========================================================================
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the combobox to fill a rectangle using the brush
	//     specifed by hBrush.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the combobox to draw a frame rectangle using the brush
	//     specified by hBrush.
	// Parameters:
	//     hdc    - Handle to a valid device context.
	//     lprc   - Pointer to a RECT structure representing the size of
	//              rectangle to draw.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the framework to draw the combobox control.
	// Parameters:
	//     pDC       - Pointer to a valid device context.
	//     pComboBox - Pointer to the CXTPComboBox object to be drawn.
	//-----------------------------------------------------------------------
	virtual BOOL DrawComboBox(CDC* pDC, CXTPComboBox* pComboBox);

	//-----------------------------------------------------------------------
	// Summary:
	//     This member function is called to draw the combobox background.
	// Parameters:
	//     pDC       - Pointer to a valid device context.
	//     pComboBox - Pointer to the combobox to be drawn.
	//-----------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the paint manager to draw the drop down arrow for
	//     the combobox drop button.
	// Parameters:
	//     pDC       - Pointer to the device context for the combobox.
	//     pComboBox - Pointer to a CXTPComboBox object.
	//     rcBtn     - Size of the button to draw.
	...
	//     of the CXTPComboBox control.
	// See Also:
	//     SetTextColor, ResetTextColor, SetBackColor, GetTextColor
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     clrBackground - An RGB color value representing the background color
	//                     for the CXTPComboBox control.
	// Returns:
	//     An RGB color value representing the previous background color
	//     for the CXTPComboBox control.
	// See Also:
	//     SetTextColor, ResetTextColor, GetBackColor, GetTextColor
	//-----------------------------------------------------------------------
	COLORREF SetBackColor(COLORREF clrBackground);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to reset the background color
	//     for the CXTPComboBox control.
	// See Also:
	//     GetTextColor, SetTextColor, GetBackColor, GetTextColor
	//-----------------------------------------------------------------------
	void ResetBackColor();
	...
	//     of the CXTPComboBox control.
	// See Also:
	//     SetTextColor, ResetTextColor, SetBackColor, GetBackColor
	//-----------------------------------------------------------------------
	...
	//     for the CXTPComboBox control.
	// Parameters:
	//     clrText - An RGB color value representing the text color
	//               for the CXTPComboBox control.
	// Returns:
	//     An RGB color value representing the previous text color
	//     for the CXTPComboBox control.
	// See Also:
	//     GetTextColor, ResetTextColor, SetBackColor, GetBackColor
	//-----------------------------------------------------------------------
	COLORREF SetTextColor(COLORREF clrText);

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to reset the text color
	//     for the CXTPComboBox control.
	// See Also:
	//     GetTextColor, SetTextColor, SetBackColor, GetBackColor
	//-----------------------------------------------------------------------
	void ResetTextColor();

	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve a reference to a CBrush
	//     object used to draw the combobox background.
	// Returns:
	//     A reference to a CBrush object used to draw the combobox
	//     background.
	//-----------------------------------------------------------------------
...
protected:
	//-----------------------------------------------------------------------
	// Summary:
	//     Called by the framework to update the color value used by
	//     the combobox background brush.
	//-----------------------------------------------------------------------
	void UpdateBackgroundBrush();

	int m_nThumbWidth;				// Size in pixels of the drop button width.
	CXTPBrush m_xtpBrushBackground; // Brush used by the combobox to fill the background color.
