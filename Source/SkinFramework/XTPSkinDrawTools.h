...
_XTP_EXT_CLASS BOOL WINAPI XTPSkinFrameworkDrawEdge(HDC hdc, LPRECT lprc, UINT edge, UINT flags);
_XTP_EXT_CLASS BOOL WINAPI XTPSkinFrameworkDrawFrameControl(HDC hdc, LPRECT lprc, UINT uType,
															UINT uState);
