...
IMPLEMENT_FACTORY(IDefaultRecordCreator,CDefaultRecordCreator_DailyTraceEvidence, string,"Future_DailyTraceEvidence")
void CDefaultRecordCreator_DailyTraceEvidence::CreateRecord()
{
	//默认插入3条数据
